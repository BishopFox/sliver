...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x2a, 0x4a, 0x0a, 0x10, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x64, 0x65, 0x45, 0x6e,
	...
	0x49, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x58, 0x4f, 0x52, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b,
	0x58, 0x4f, 0x52, 0x5f, 0x44, 0x59, 0x4e, 0x41, 0x4d, 0x49, 0x43, 0x10, 0x03, 0x2a, 0x35, 0x0a,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 143)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*ExportImplantBundle)(nil),      // 141: clientpb.ExportImplantBundle
	nil,                              // 142: clientpb.TrafficEncoderMap.EncodersEntry
	nil,                              // 143: clientpb.ExternalImplantConfig.EncodersEntry
	nil,                              // 144: clientpb.ImplantBuilds.ConfigsEntry
	nil,                              // 145: clientpb.ImplantBuilds.ResourceIDsEntry
	nil,                              // 146: clientpb.ImplantBuilds.StagedEntry
	nil,                              // 147: clientpb.WebsiteAddContent.ContentsEntry
	nil,                              // 148: clientpb.Website.ContentsEntry
	nil,                              // 149: clientpb.Host.ExtensionDataEntry
	nil,                              // 150: clientpb.ShellcodeEncoderArchMap.EncodersEntry
	nil,                              // 151: clientpb.ShellcodeEncoderArchMap.DescriptionsEntry
	nil,                              // 152: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                              // 153: clientpb.CrackSyncStatus.ProgressEntry
	nil,                              // 154: clientpb.CrackBenchmark.BenchmarksEntry
	nil,                              // 155: clientpb.Crackstation.BenchmarksEntry
	(*commonpb.File)(nil),            // 156: commonpb.File
	(*commonpb.Request)(nil),         // 157: commonpb.Request
	(*commonpb.Response)(nil),        // 158: commonpb.Response
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	156, // 7: clientpb.ImplantConfig.Assets:type_name -> commonpb.File
	156, // 8: clientpb.TrafficEncoder.Wasm:type_name -> commonpb.File
	142, // 9: clientpb.TrafficEncoderMap.Encoders:type_name -> clientpb.TrafficEncoderMap.EncodersEntry
	...
	143, // 15: clientpb.ExternalImplantConfig.encoders:type_name -> clientpb.ExternalImplantConfig.EncodersEntry
	156, // 16: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	144, // 17: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	145, // 18: clientpb.ImplantBuilds.ResourceIDs:type_name -> clientpb.ImplantBuilds.ResourceIDsEntry
	146, // 19: clientpb.ImplantBuilds.staged:type_name -> clientpb.ImplantBuilds.StagedEntry
	...
	157, // 34: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	158, // 35: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	157, // 36: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	158, // 37: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	156, // 40: clientpb.Generate.File:type_name -> commonpb.File
	157, // 41: clientpb.MSFReq.Request:type_name -> commonpb.Request
	157, // 42: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	157, // 45: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	157, // 48: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	157, // 49: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	157, // 50: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	147, // 59: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	148, // 60: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	83,  // 61: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 62: clientpb.Loot.FileType:type_name -> clientpb.FileType
	156, // 63: clientpb.Loot.File:type_name -> commonpb.File
	86,  // 64: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	88,  // 65: clientpb.Host.IOCs:type_name -> clientpb.IOC
	149, // 66: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	90,  // 67: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	157, // 68: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	158, // 69: clientpb.DllHijack.Response:type_name -> commonpb.Response
	157, // 70: clientpb.BackdoorReq.Request:type_name -> commonpb.Request
	158, // 71: clientpb.Backdoor.Response:type_name -> commonpb.Response
	3,   // 72: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	157, // 73: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	158, // 74: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	150, // 75: clientpb.ShellcodeEncoderArchMap.Encoders:type_name -> clientpb.ShellcodeEncoderArchMap.EncodersEntry
	151, // 76: clientpb.ShellcodeEncoderArchMap.Descriptions:type_name -> clientpb.ShellcodeEncoderArchMap.DescriptionsEntry
	152, // 77: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	...
	153, // 96: clientpb.CrackSyncStatus.Progress:type_name -> clientpb.CrackSyncStatus.ProgressEntry
	154, // 97: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	124, // 98: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	155, // 99: clientpb.Crackstation.Benchmarks:type_name -> clientpb.Crackstation.BenchmarksEntry
	...
	24,  // 124: clientpb.TrafficEncoderMap.EncodersEntry.value:type_name -> clientpb.TrafficEncoder
	23,  // 125: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	133, // 126: clientpb.ImplantBuilds.ResourceIDsEntry.value:type_name -> clientpb.ResourceID
	80,  // 127: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	80,  // 128: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	89,  // 129: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 130: clientpb.ShellcodeEncoderArchMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
	98,  // 131: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoderArchMap
