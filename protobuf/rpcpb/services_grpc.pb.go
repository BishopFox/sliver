...
func (c *sliverRPCClient) CrackJobs(ctx context.Context, in *commonpb.Empty, opts ...grpc.CallOption) (*clientpb.CrackJobs, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(clientpb.CrackJobs)
	err := c.cc.Invoke(ctx, SliverRPC_CrackJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) CrackJobByID(ctx context.Context, in *clientpb.CrackJob, opts ...grpc.CallOption) (*clientpb.CrackJob, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedSliverRPCServer) CrackJobs(context.Context, *commonpb.Empty) (*clientpb.CrackJobs, error) {
	return nil, status.Error(codes.Unimplemented, "method CrackJobs not implemented")
}
...
func _SliverRPC_CrackJobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(commonpb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).CrackJobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_CrackJobs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).CrackJobs(ctx, req.(*commonpb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_CrackJobByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.CrackJob)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).CrackJobByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_CrackJobByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CrackJobs",
			Handler:    _SliverRPC_CrackJobs_Handler,
		},
		{
