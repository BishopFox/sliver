...
const (
	...
	SliverRPC_StartTCPFwdListener_FullMethodName              = "/rpcpb.SliverRPC/StartTCPFwdListener"
...
type SliverRPCClient interface {
	...
	// *** TCP Forwarder ***
	StartTCPFwdListener(ctx context.Context, in *clientpb.TCPFwdListenerReq, opts ...grpc.CallOption) (*clientpb.ListenerJob, error)
	// *** Loot ***
...
func (c *sliverRPCClient) StartTCPFwdListener(ctx context.Context, in *clientpb.TCPFwdListenerReq, opts ...grpc.CallOption) (*clientpb.ListenerJob, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(clientpb.ListenerJob)
	err := c.cc.Invoke(ctx, SliverRPC_StartTCPFwdListener_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SliverRPCServer interface {
	...
	// *** TCP Forwarder ***
	StartTCPFwdListener(context.Context, *clientpb.TCPFwdListenerReq) (*clientpb.ListenerJob, error)
	// *** Loot ***
...
func (UnimplementedSliverRPCServer) StartTCPFwdListener(context.Context, *clientpb.TCPFwdListenerReq) (*clientpb.ListenerJob, error) {
	return nil, status.Error(codes.Unimplemented, "method StartTCPFwdListener not implemented")
}
...
func _SliverRPC_StartTCPFwdListener_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.TCPFwdListenerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).StartTCPFwdListener(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_StartTCPFwdListener_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).StartTCPFwdListener(ctx, req.(*clientpb.TCPFwdListenerReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StartTCPFwdListener",
			Handler:    _SliverRPC_StartTCPFwdListener_Handler,
		},
		{
			MethodName: "LootAdd",
