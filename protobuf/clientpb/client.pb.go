...
const (
	CrackFileType_WORDLIST       CrackFileType = 0
	CrackFileType_RULES          CrackFileType = 1
	CrackFileType_MARKOV_HCSTAT2 CrackFileType = 2
)
...
func (x *CrackStatus) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CrackStatus) GetHostUUID() string {
	if x != nil {
		return x.HostUUID
	}
	return ""
...
func (x *CrackStatus) GetStatus() Statuses {
	if x != nil {
		return x.Status
	}
...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xdd, 0x01, 0x0a, 0x09, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x54, 0x61,
	...
	0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a,
	0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x12, 0x30, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x18, 0x09, 0x20,
	...
	0x43, 0x52, 0x59, 0x50, 0x54, 0x5f, 0x55, 0x4e, 0x49, 0x58, 0x10, 0x88, 0x0e, 0x2a, 0x37, 0x0a,
	0x08, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x57, 0x41, 0x49,
	...
	0x4e, 0x49, 0x47, 0x48, 0x54, 0x4d, 0x41, 0x52, 0x45, 0x10, 0x04, 0x2a, 0x3c, 0x0a, 0x0d, 0x43,
	0x72, 0x61, 0x63, 0x6b, 0x46, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0c, 0x0a, 0x08,
	0x57, 0x4f, 0x52, 0x44, 0x4c, 0x49, 0x53, 0x54, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x52, 0x55,
	0x4c, 0x45, 0x53, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e, 0x4d, 0x41, 0x52, 0x4b, 0x4f, 0x56, 0x5f,
	0x48, 0x43, 0x53, 0x54, 0x41, 0x54, 0x32, 0x10, 0x02, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74,
...
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*CrackStatus)(nil),           // 94: clientpb.CrackStatus
	(*CrackBenchmark)(nil),        // 95: clientpb.CrackBenchmark
	(*CrackTask)(nil),             // 96: clientpb.CrackTask
	(*Crackstation)(nil),          // 97: clientpb.Crackstation
	(*CUDABackendInfo)(nil),       // 98: clientpb.CUDABackendInfo
	(*OpenCLBackendInfo)(nil),     // 99: clientpb.OpenCLBackendInfo
	(*MetalBackendInfo)(nil),      // 100: clientpb.MetalBackendInfo
	(*CrackCommand)(nil),          // 101: clientpb.CrackCommand
	(*CrackConfig)(nil),           // 102: clientpb.CrackConfig
	(*CrackFiles)(nil),            // 103: clientpb.CrackFiles
	(*CrackFile)(nil),             // 104: clientpb.CrackFile
	(*CrackFileChunk)(nil),        // 105: clientpb.CrackFileChunk
	nil,                           // 106: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 107: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 108: clientpb.Website.ContentsEntry
	nil,                           // 109: clientpb.Host.ExtensionDataEntry
	nil,                           // 110: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                           // 111: clientpb.CrackBenchmark.BenchmarksEntry
	nil,                           // 112: clientpb.Crackstation.BenchmarksEntry
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	113, // 5: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	106, // 6: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	114, // 15: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	115, // 16: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	114, // 17: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	115, // 18: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	113, // 21: clientpb.Generate.File:type_name -> commonpb.File
	114, // 22: clientpb.MSFReq.Request:type_name -> commonpb.Request
	114, // 23: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	113, // 26: clientpb.MsfStager.File:type_name -> commonpb.File
	18,  // 27: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	114, // 28: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	114, // 31: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	114, // 32: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	114, // 33: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	107, // 42: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	108, // 43: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	74,  // 44: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 45: clientpb.Loot.FileType:type_name -> clientpb.FileType
	113, // 46: clientpb.Loot.File:type_name -> commonpb.File
	77,  // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	79,  // 48: clientpb.Host.IOCs:type_name -> clientpb.IOC
	109, // 49: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	81,  // 50: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	114, // 51: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	115, // 52: clientpb.DllHijack.Response:type_name -> commonpb.Response
	3,   // 53: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	114, // 54: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	115, // 55: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	110, // 56: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	...
	97,  // 63: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	5,   // 64: clientpb.CrackStatus.Status:type_name -> clientpb.Statuses
	111, // 65: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	101, // 66: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	112, // 67: clientpb.Crackstation.Benchmarks:type_name -> clientpb.Crackstation.BenchmarksEntry
	98,  // 68: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	100, // 69: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	99,  // 70: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	6,   // 71: clientpb.CrackCommand.AttackMode:type_name -> clientpb.CrackAttackMode
	4,   // 72: clientpb.CrackCommand.HashType:type_name -> clientpb.HashType
	8,   // 73: clientpb.CrackCommand.OutfileFormat:type_name -> clientpb.CrackOutfileFormat
	7,   // 74: clientpb.CrackCommand.EncodingFrom:type_name -> clientpb.CrackEncoding
	7,   // 75: clientpb.CrackCommand.EncodingTo:type_name -> clientpb.CrackEncoding
	9,   // 76: clientpb.CrackCommand.WorkloadProfile:type_name -> clientpb.CrackWorkloadProfile
	104, // 77: clientpb.CrackFiles.Files:type_name -> clientpb.CrackFile
	10,  // 78: clientpb.CrackFile.Type:type_name -> clientpb.CrackFileType
	105, // 79: clientpb.CrackFile.Chunks:type_name -> clientpb.CrackFileChunk
	18,  // 80: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	71,  // 81: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	71,  // 82: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	80,  // 83: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 84: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
