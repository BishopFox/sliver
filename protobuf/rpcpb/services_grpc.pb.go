...
type SliverRPCClient interface {
	...
	// *** ScreenShare ***
	CreateScreenShare(ctx context.Context, in *sliverpb.ScreenShare, opts ...grpc.CallOption) (*sliverpb.ScreenShare, error)
	CloseScreenShare(ctx context.Context, in *sliverpb.ScreenShare, opts ...grpc.CallOption) (*commonpb.Empty, error)
	ScreenShare(ctx context.Context, in *sliverpb.ScreenShareData, opts ...grpc.CallOption) (SliverRPC_ScreenShareClient, error)
	// *** Realtime Commands ***
...
func (c *sliverRPCClient) CreateScreenShare(ctx context.Context, in *sliverpb.ScreenShare, opts ...grpc.CallOption) (*sliverpb.ScreenShare, error) {
	out := new(sliverpb.ScreenShare)
	err := c.cc.Invoke(ctx, "/rpcpb.SliverRPC/CreateScreenShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) CloseScreenShare(ctx context.Context, in *sliverpb.ScreenShare, opts ...grpc.CallOption) (*commonpb.Empty, error) {
	out := new(commonpb.Empty)
	err := c.cc.Invoke(ctx, "/rpcpb.SliverRPC/CloseScreenShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) ScreenShare(ctx context.Context, in *sliverpb.ScreenShareData, opts ...grpc.CallOption) (SliverRPC_ScreenShareClient, error) {
	stream, err := c.cc.NewStream(ctx, &SliverRPC_ServiceDesc.Streams[0], "/rpcpb.SliverRPC/ScreenShare", opts...)
	if err != nil {
		return nil, err
	}
	x := &sliverRPCScreenShareClient{stream}
...
type SliverRPC_ScreenShareClient interface {
	Recv() (*sliverpb.ScreenShareData, error)
	grpc.ClientStream
}

type sliverRPCScreenShareClient struct {
	grpc.ClientStream
}

func (x *sliverRPCScreenShareClient) Recv() (*sliverpb.ScreenShareData, error) {
	m := new(sliverpb.ScreenShareData)
...
type SliverRPCServer interface {
	...
	// *** ScreenShare ***
	CreateScreenShare(context.Context, *sliverpb.ScreenShare) (*sliverpb.ScreenShare, error)
	CloseScreenShare(context.Context, *sliverpb.ScreenShare) (*commonpb.Empty, error)
	ScreenShare(*sliverpb.ScreenShareData, SliverRPC_ScreenShareServer) error
	// *** Realtime Commands ***
...
func (UnimplementedSliverRPCServer) CreateScreenShare(context.Context, *sliverpb.ScreenShare) (*sliverpb.ScreenShare, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateScreenShare not implemented")
}
func (UnimplementedSliverRPCServer) CloseScreenShare(context.Context, *sliverpb.ScreenShare) (*commonpb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CloseScreenShare not implemented")
}
func (UnimplementedSliverRPCServer) ScreenShare(*sliverpb.ScreenShareData, SliverRPC_ScreenShareServer) error {
	return status.Errorf(codes.Unimplemented, "method ScreenShare not implemented")
}
...
func _SliverRPC_CreateScreenShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.ScreenShare)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).CreateScreenShare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/CreateScreenShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).CreateScreenShare(ctx, req.(*sliverpb.ScreenShare))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_CloseScreenShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.ScreenShare)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).CloseScreenShare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpb.SliverRPC/CloseScreenShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).CloseScreenShare(ctx, req.(*sliverpb.ScreenShare))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_ScreenShare_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(sliverpb.ScreenShareData)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SliverRPCServer).ScreenShare(m, &sliverRPCScreenShareServer{stream})
}

type SliverRPC_ScreenShareServer interface {
	Send(*sliverpb.ScreenShareData) error
	grpc.ServerStream
}

type sliverRPCScreenShareServer struct {
	grpc.ServerStream
}

func (x *sliverRPCScreenShareServer) Send(m *sliverpb.ScreenShareData) error {
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateScreenShare",
			Handler:    _SliverRPC_CreateScreenShare_Handler,
		},
		{
			MethodName: "CloseScreenShare",
			Handler:    _SliverRPC_CloseScreenShare_Handler,
		},
		{
			MethodName: "Shell",
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _SliverRPC_ScreenShare_Handler,
			ServerStreams: true,
		},
		{
