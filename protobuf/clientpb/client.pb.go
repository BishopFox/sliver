...
func (x *CrackBenchmark) GetBenchmarks() map[int32]int64 {
	if x != nil {
		return x.Benchmarks
	}
	return nil
...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x6e, 0x64, 0x22, 0xe6, 0x02, 0x0a, 0x0c, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74,
	...
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x04, 0x43, 0x55, 0x44, 0x41, 0x18,
	...
	0x5f, 0x55, 0x4e, 0x49, 0x58, 0x10, 0x88, 0x0e, 0x2a, 0x37, 0x0a, 0x08, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x65, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x57, 0x41, 0x49, 0x54, 0x49, 0x4e, 0x47, 0x10,
	...
	0x4d, 0x41, 0x52, 0x45, 0x10, 0x04, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 97)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*CrackStatus)(nil),           // 93: clientpb.CrackStatus
	(*CrackBenchmark)(nil),        // 94: clientpb.CrackBenchmark
	(*CrackTask)(nil),             // 95: clientpb.CrackTask
	(*Crackstation)(nil),          // 96: clientpb.Crackstation
	(*CUDABackendInfo)(nil),       // 97: clientpb.CUDABackendInfo
	(*OpenCLBackendInfo)(nil),     // 98: clientpb.OpenCLBackendInfo
	(*MetalBackendInfo)(nil),      // 99: clientpb.MetalBackendInfo
	(*CrackCommand)(nil),          // 100: clientpb.CrackCommand
	nil,                           // 101: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 102: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 103: clientpb.Website.ContentsEntry
	nil,                           // 104: clientpb.Host.ExtensionDataEntry
	nil,                           // 105: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                           // 106: clientpb.CrackBenchmark.BenchmarksEntry
	(*commonpb.File)(nil),         // 107: commonpb.File
	(*commonpb.Request)(nil),      // 108: commonpb.Request
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	107, // 5: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	101, // 6: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	108, // 15: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	109, // 16: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	108, // 17: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	109, // 18: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	107, // 21: clientpb.Generate.File:type_name -> commonpb.File
	108, // 22: clientpb.MSFReq.Request:type_name -> commonpb.Request
	108, // 23: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	107, // 26: clientpb.MsfStager.File:type_name -> commonpb.File
	17,  // 27: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	108, // 28: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	108, // 31: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	108, // 32: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	108, // 33: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	102, // 42: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	103, // 43: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	73,  // 44: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 45: clientpb.Loot.FileType:type_name -> clientpb.FileType
	107, // 46: clientpb.Loot.File:type_name -> commonpb.File
	76,  // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	78,  // 48: clientpb.Host.IOCs:type_name -> clientpb.IOC
	104, // 49: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	80,  // 50: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	108, // 51: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	109, // 52: clientpb.DllHijack.Response:type_name -> commonpb.Response
	3,   // 53: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	108, // 54: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	109, // 55: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	105, // 56: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	...
	96,  // 63: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	5,   // 64: clientpb.CrackStatus.Status:type_name -> clientpb.Statuses
	106, // 65: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	100, // 66: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	97,  // 67: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	99,  // 68: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	98,  // 69: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	6,   // 70: clientpb.CrackCommand.AttackMode:type_name -> clientpb.CrackAttackMode
	4,   // 71: clientpb.CrackCommand.HashType:type_name -> clientpb.HashType
	8,   // 72: clientpb.CrackCommand.OutfileFormat:type_name -> clientpb.CrackOutfileFormat
	7,   // 73: clientpb.CrackCommand.EncodingFrom:type_name -> clientpb.CrackEncoding
	7,   // 74: clientpb.CrackCommand.EncodingTo:type_name -> clientpb.CrackEncoding
	9,   // 75: clientpb.CrackCommand.WorkloadProfile:type_name -> clientpb.CrackWorkloadProfile
	17,  // 76: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	70,  // 77: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	70,  // 78: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	79,  // 79: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 80: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
