...
type ImplantConfig struct {
	...
	// [ Trigger / Wake / TTL ] --------------------------------------
	//
	// Optional implant features for the trigger-via-standalone Phase 2
	// integration. All disabled by default (zero-value semantics).
	//
	// IncludeTriggerWake gates the implant/sliver/transports/triggerwake/
	// package via Sliver's template directive system. When true at
	// build time, the implant starts a passive UDP listener that
	// accepts HMAC-signed "wake" and "self-destruct" tasks.
	IncludeTriggerWake bool `protobuf:"varint,201,opt,name=IncludeTriggerWake,proto3" json:"IncludeTriggerWake,omitempty"`
	// TriggerWakeBindAddr is the host:port the implant listens on.
	TriggerWakeBindAddr string `protobuf:"bytes,202,opt,name=TriggerWakeBindAddr,proto3" json:"TriggerWakeBindAddr,omitempty"`
	// TriggerWakeSecret is the HMAC-SHA256 key the implant uses to
	// verify incoming triggers. Generate one per implant; don't reuse
	// across deployments.
	TriggerWakeSecret []byte `protobuf:"bytes,203,opt,name=TriggerWakeSecret,proto3" json:"TriggerWakeSecret,omitempty"`
	// TriggerWakeAllowedClientIDs, if non-empty, restricts which
	// client_id values the implant accepts. Empty = any signed client.
	TriggerWakeAllowedClientIDs []string `protobuf:"bytes,204,rep,name=TriggerWakeAllowedClientIDs,proto3" json:"TriggerWakeAllowedClientIDs,omitempty"`
	// TTLEnabled activates the implant's built-in expiry timer. When
	// true, the implant runs a ticker that compares the current time
	// against TTLExpiresAtUnix and self-destructs (via implant/sliver/
	// burn) when the deadline passes. Independent of any operator-
	// fired self-destruct trigger.
	TTLEnabled bool `protobuf:"varint,205,opt,name=TTLEnabled,proto3" json:"TTLEnabled,omitempty"`
	// TTLExpiresAtUnix is the absolute deadline as a Unix timestamp
	// (seconds since epoch). Populated by server/generate at build
	// time as (build_time + TTLMinutes * 60). The implant treats this
	// as opaque — it just compares to time.Now().Unix().
	TTLExpiresAtUnix int64 `protobuf:"varint,206,opt,name=TTLExpiresAtUnix,proto3" json:"TTLExpiresAtUnix,omitempty"`
	// TTLMinutes is the build-time-configured lifetime in minutes.
	// 30 days default = 43200. Kept in proto for audit/operator
	// visibility — the implant only ever reads TTLExpiresAtUnix.
	TTLMinutes uint32 `protobuf:"varint,207,opt,name=TTLMinutes,proto3" json:"TTLMinutes,omitempty"`
	// TTLBurnExtraPaths is the operator-supplied list of filesystem
	// paths the implant will wipe on self-destruct (TTL expiry OR
	// operator-fired). Typically: scratch dirs, drop files, cached
	// audit logs the implant wrote during its lifetime.
	TTLBurnExtraPaths []string `protobuf:"bytes,208,rep,name=TTLBurnExtraPaths,proto3" json:"TTLBurnExtraPaths,omitempty"`
	// TTLBurnPersistence is the operator-supplied list of platform-
	// specific persistence artifact paths to scrub on self-destruct
	// (systemd unit paths, launchd plists, registry keys, etc.).
	TTLBurnPersistence []string `protobuf:"bytes,209,rep,name=TTLBurnPersistence,proto3" json:"TTLBurnPersistence,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ImplantConfig) GetIncludeTriggerWake() bool {
	if x != nil {
		return x.IncludeTriggerWake
	}
	return false
}

func (x *ImplantConfig) GetTriggerWakeBindAddr() string {
	if x != nil {
		return x.TriggerWakeBindAddr
	}
	return ""
}

func (x *ImplantConfig) GetTriggerWakeSecret() []byte {
	if x != nil {
		return x.TriggerWakeSecret
	}
	return nil
}

func (x *ImplantConfig) GetTriggerWakeAllowedClientIDs() []string {
	if x != nil {
		return x.TriggerWakeAllowedClientIDs
	}
	return nil
}

func (x *ImplantConfig) GetTTLEnabled() bool {
	if x != nil {
		return x.TTLEnabled
	}
	return false
...
func (x *ImplantConfig) GetTTLExpiresAtUnix() int64 {
	if x != nil {
		return x.TTLExpiresAtUnix
	}
	return 0
}

func (x *ImplantConfig) GetTTLMinutes() uint32 {
	if x != nil {
		return x.TTLMinutes
	}
	return 0
...
func (x *ImplantConfig) GetTTLBurnExtraPaths() []string {
	if x != nil {
		return x.TTLBurnExtraPaths
	}
	return nil
}

func (x *ImplantConfig) GetTTLBurnPersistence() []string {
	if x != nil {
		return x.TTLBurnPersistence
	}
	return nil
}
...
type ListenerJob struct {
	...
	TriggerConf   *TriggerListenerReq     `protobuf:"bytes,10,opt,name=TriggerConf,proto3" json:"TriggerConf,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListenerJob) GetTriggerConf() *TriggerListenerReq {
	if x != nil {
		return x.TriggerConf
	}
	return nil
}
...
type WakeBeaconConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// BeaconID (UUID string) of the beacon whose NextCheckin should be
	// updated when the trigger fires.
	BeaconID      string `protobuf:"bytes,1,opt,name=BeaconID,proto3" json:"BeaconID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WakeBeaconConfig) Reset() {
	*x = WakeBeaconConfig{}
...
func (x *WakeBeaconConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WakeBeaconConfig) ProtoMessage() {}

func (x *WakeBeaconConfig) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[144]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WakeBeaconConfig.ProtoReflect.Descriptor instead.
func (*WakeBeaconConfig) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{144}
}

func (x *WakeBeaconConfig) GetBeaconID() string {
	if x != nil {
		return x.BeaconID
	}
	return ""
...
type StopJobConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// JobName matches the Name field of an active core.Job. First match
	// wins; document collisions to operators.
	JobName       string `protobuf:"bytes,1,opt,name=JobName,proto3" json:"JobName,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StopJobConfig) Reset() {
	*x = StopJobConfig{}
...
func (x *StopJobConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StopJobConfig) ProtoMessage() {}

func (x *StopJobConfig) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[145]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StopJobConfig.ProtoReflect.Descriptor instead.
func (*StopJobConfig) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{145}
}

func (x *StopJobConfig) GetJobName() string {
	if x != nil {
		return x.JobName
	}
	return ""
...
type ExecConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Cmd is the absolute path of the executable. Pre-split argv only.
	...
	// TimeoutMs bounds the subprocess lifetime via context.WithTimeout.
	TimeoutMs uint32 `protobuf:"varint,5,opt,name=TimeoutMs,proto3" json:"TimeoutMs,omitempty"`
	// PathOverride / HomeOverride customize the sanitized subprocess env.
	PathOverride   string `protobuf:"bytes,6,opt,name=PathOverride,proto3" json:"PathOverride,omitempty"`
	HomeOverride   string `protobuf:"bytes,7,opt,name=HomeOverride,proto3" json:"HomeOverride,omitempty"`
	MaxOutputBytes uint32 `protobuf:"varint,8,opt,name=MaxOutputBytes,proto3" json:"MaxOutputBytes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ExecConfig) GetCmd() string {
	if x != nil {
		return x.Cmd
	}
	return ""
...
func (x *ExecConfig) GetWorkdir() string {
	if x != nil {
		return x.Workdir
	}
	return ""
...
func (x *ExecConfig) GetTimeoutMs() uint32 {
	if x != nil {
		return x.TimeoutMs
	}
	return 0
...
func (x *ExecConfig) GetPathOverride() string {
	if x != nil {
...
func (x *ExecConfig) GetHomeOverride() string {
	if x != nil {
		return x.HomeOverride
	}
	return ""
}

func (x *ExecConfig) GetMaxOutputBytes() uint32 {
	if x != nil {
...
type ReverseShellConfig struct {
	...
	// ShellPath absolute; empty => platform default (/bin/sh or cmd.exe).
	ShellPath            string   `protobuf:"bytes,2,opt,name=ShellPath,proto3" json:"ShellPath,omitempty"`
	ShellArgs            []string `protobuf:"bytes,3,rep,name=ShellArgs,proto3" json:"ShellArgs,omitempty"`
	DialTimeoutMs        uint32   `protobuf:"varint,4,opt,name=DialTimeoutMs,proto3" json:"DialTimeoutMs,omitempty"`
	MaxSessionDurationMs uint32   `protobuf:"varint,5,opt,name=MaxSessionDurationMs,proto3" json:"MaxSessionDurationMs,omitempty"`
	// UseTLS wraps the operator-side channel in TLS.
	UseTLS        bool `protobuf:"varint,6,opt,name=UseTLS,proto3" json:"UseTLS,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReverseShellConfig) Reset() {
	*x = ReverseShellConfig{}
	mi := &file_clientpb_client_proto_msgTypes[147]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReverseShellConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReverseShellConfig) ProtoMessage() {}

func (x *ReverseShellConfig) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[147]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReverseShellConfig.ProtoReflect.Descriptor instead.
func (*ReverseShellConfig) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{147}
}

func (x *ReverseShellConfig) GetOperatorAddr() string {
	if x != nil {
...
func (x *ReverseShellConfig) GetShellPath() string {
	if x != nil {
		return x.ShellPath
	}
	return ""
...
func (x *ReverseShellConfig) GetShellArgs() []string {
	if x != nil {
		return x.ShellArgs
	}
	return nil
...
func (x *ReverseShellConfig) GetDialTimeoutMs() uint32 {
	if x != nil {
...
func (x *ReverseShellConfig) GetMaxSessionDurationMs() uint32 {
	if x != nil {
...
func (x *ReverseShellConfig) GetUseTLS() bool {
	if x != nil {
		return x.UseTLS
	}
	return false
...
type TriggerIntentBinding struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Name is the task label on the wire (operator's --task flag).
	Name string `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`
	// Exactly one of the *Config fields below is set, selecting the
	// handler kind.
	//
	// Types that are valid to be assigned to Config:
	//
	//	*TriggerIntentBinding_WakeBeacon
	//	*TriggerIntentBinding_StopJob
	//	*TriggerIntentBinding_Exec
	//	*TriggerIntentBinding_ReverseShell
	Config        isTriggerIntentBinding_Config `protobuf_oneof:"Config"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TriggerIntentBinding) Reset() {
	*x = TriggerIntentBinding{}
	mi := &file_clientpb_client_proto_msgTypes[148]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TriggerIntentBinding) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerIntentBinding) ProtoMessage() {}

func (x *TriggerIntentBinding) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[148]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerIntentBinding.ProtoReflect.Descriptor instead.
func (*TriggerIntentBinding) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{148}
}

func (x *TriggerIntentBinding) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TriggerIntentBinding) GetConfig() isTriggerIntentBinding_Config {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *TriggerIntentBinding) GetWakeBeacon() *WakeBeaconConfig {
	if x != nil {
		if x, ok := x.Config.(*TriggerIntentBinding_WakeBeacon); ok {
			return x.WakeBeacon
		}
	}
	return nil
...
func (x *TriggerIntentBinding) GetStopJob() *StopJobConfig {
	if x != nil {
		if x, ok := x.Config.(*TriggerIntentBinding_StopJob); ok {
			return x.StopJob
		}
	}
	return nil
...
func (x *TriggerIntentBinding) GetExec() *ExecConfig {
	if x != nil {
		if x, ok := x.Config.(*TriggerIntentBinding_Exec); ok {
			return x.Exec
		}
	}
	return nil
...
func (x *TriggerIntentBinding) GetReverseShell() *ReverseShellConfig {
	if x != nil {
		if x, ok := x.Config.(*TriggerIntentBinding_ReverseShell); ok {
...
type isTriggerIntentBinding_Config interface {
	isTriggerIntentBinding_Config()
}

type TriggerIntentBinding_WakeBeacon struct {
	WakeBeacon *WakeBeaconConfig `protobuf:"bytes,10,opt,name=WakeBeacon,proto3,oneof"`
}

type TriggerIntentBinding_StopJob struct {
	StopJob *StopJobConfig `protobuf:"bytes,11,opt,name=StopJob,proto3,oneof"`
}

type TriggerIntentBinding_Exec struct {
	Exec *ExecConfig `protobuf:"bytes,12,opt,name=Exec,proto3,oneof"`
}

type TriggerIntentBinding_ReverseShell struct {
	ReverseShell *ReverseShellConfig `protobuf:"bytes,13,opt,name=ReverseShell,proto3,oneof"`
}

func (*TriggerIntentBinding_WakeBeacon) isTriggerIntentBinding_Config() {}

func (*TriggerIntentBinding_StopJob) isTriggerIntentBinding_Config() {}

func (*TriggerIntentBinding_Exec) isTriggerIntentBinding_Config() {}

func (*TriggerIntentBinding_ReverseShell) isTriggerIntentBinding_Config() {}

type TriggerListenerReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Host is the UDP bind IP, e.g. "0.0.0.0".
	Host string `protobuf:"bytes,1,opt,name=Host,proto3" json:"Host,omitempty"`
	// Port is the UDP bind port.
	Port uint32 `protobuf:"varint,2,opt,name=Port,proto3" json:"Port,omitempty"`
	// SharedSecret is the default HMAC key, used for any client_id not
	// in PerClientKeys. Required unless every accepted client has a
	// per-client key.
	SharedSecret []byte `protobuf:"bytes,3,opt,name=SharedSecret,proto3" json:"SharedSecret,omitempty"`
	// PerClientKeys maps client_id => HMAC secret bytes for multi-key
	// deployments. Optional.
	PerClientKeys map[string][]byte `protobuf:"bytes,4,rep,name=PerClientKeys,proto3" json:"PerClientKeys,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Strict, if true, rejects any client_id not in PerClientKeys even
	// when SharedSecret is set.
	...
	// Empty list = any signed client.
	AllowedClientIDs []string `protobuf:"bytes,6,rep,name=AllowedClientIDs,proto3" json:"AllowedClientIDs,omitempty"`
	// AllowedSources accepts exact IPs and CIDR ranges (v4 + v6).
	// Empty list = allow-all.
	AllowedSources []string `protobuf:"bytes,7,rep,name=AllowedSources,proto3" json:"AllowedSources,omitempty"`
	// ServerID is included in audit events.
	ServerID string `protobuf:"bytes,8,opt,name=ServerID,proto3" json:"ServerID,omitempty"`
	// Tasks bind labels to handlers at listener-start.
	Intents []*TriggerIntentBinding `protobuf:"bytes,9,rep,name=Intents,proto3" json:"Intents,omitempty"` // wire name kept for compat
	// Tunables (all optional; library applies sane defaults if zero).
	Workers                    uint32 `protobuf:"varint,20,opt,name=Workers,proto3" json:"Workers,omitempty"`
	MaxClockSkewSeconds        uint32 `protobuf:"varint,21,opt,name=MaxClockSkewSeconds,proto3" json:"MaxClockSkewSeconds,omitempty"`
	ReplayTTLSeconds           uint32 `protobuf:"varint,22,opt,name=ReplayTTLSeconds,proto3" json:"ReplayTTLSeconds,omitempty"`
	MaxMessageBytes            uint32 `protobuf:"varint,23,opt,name=MaxMessageBytes,proto3" json:"MaxMessageBytes,omitempty"`
	GlobalRatePerSecond        uint32 `protobuf:"varint,24,opt,name=GlobalRatePerSecond,proto3" json:"GlobalRatePerSecond,omitempty"`
	PerClientRequestsPerMinute uint32 `protobuf:"varint,25,opt,name=PerClientRequestsPerMinute,proto3" json:"PerClientRequestsPerMinute,omitempty"`
	MaxReplayEntries           uint32 `protobuf:"varint,26,opt,name=MaxReplayEntries,proto3" json:"MaxReplayEntries,omitempty"`
	MaxRateLimitEntries        uint32 `protobuf:"varint,27,opt,name=MaxRateLimitEntries,proto3" json:"MaxRateLimitEntries,omitempty"`
	HandlerTimeoutMs           uint32 `protobuf:"varint,28,opt,name=HandlerTimeoutMs,proto3" json:"HandlerTimeoutMs,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}

func (x *TriggerListenerReq) Reset() {
	*x = TriggerListenerReq{}
	mi := &file_clientpb_client_proto_msgTypes[149]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TriggerListenerReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerListenerReq) ProtoMessage() {}

func (x *TriggerListenerReq) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[149]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerListenerReq.ProtoReflect.Descriptor instead.
func (*TriggerListenerReq) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{149}
}

func (x *TriggerListenerReq) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *TriggerListenerReq) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *TriggerListenerReq) GetSharedSecret() []byte {
	if x != nil {
...
func (x *TriggerListenerReq) GetPerClientKeys() map[string][]byte {
	if x != nil {
		return x.PerClientKeys
	}
	return nil
}

func (x *TriggerListenerReq) GetStrict() bool {
	if x != nil {
		return x.Strict
	}
	return false
...
func (x *TriggerListenerReq) GetAllowedClientIDs() []string {
	if x != nil {
		return x.AllowedClientIDs
	}
	return nil
}

func (x *TriggerListenerReq) GetAllowedSources() []string {
	if x != nil {
...
func (x *TriggerListenerReq) GetServerID() string {
	if x != nil {
		return x.ServerID
	}
	return ""
...
func (x *TriggerListenerReq) GetIntents() []*TriggerIntentBinding {
	if x != nil {
		return x.Intents
	}
	return nil
...
func (x *TriggerListenerReq) GetWorkers() uint32 {
	if x != nil {
		return x.Workers
	}
	return 0
...
func (x *TriggerListenerReq) GetMaxClockSkewSeconds() uint32 {
	if x != nil {
		return x.MaxClockSkewSeconds
	}
	return 0
}

func (x *TriggerListenerReq) GetReplayTTLSeconds() uint32 {
	if x != nil {
		return x.ReplayTTLSeconds
	}
	return 0
}

func (x *TriggerListenerReq) GetMaxMessageBytes() uint32 {
	if x != nil {
...
func (x *TriggerListenerReq) GetGlobalRatePerSecond() uint32 {
	if x != nil {
		return x.GlobalRatePerSecond
	}
	return 0
}

func (x *TriggerListenerReq) GetPerClientRequestsPerMinute() uint32 {
	if x != nil {
		return x.PerClientRequestsPerMinute
	}
	return 0
}

func (x *TriggerListenerReq) GetMaxReplayEntries() uint32 {
	if x != nil {
		return x.MaxReplayEntries
	}
	return 0
}

func (x *TriggerListenerReq) GetMaxRateLimitEntries() uint32 {
	if x != nil {
		return x.MaxRateLimitEntries
	}
	return 0
}

func (x *TriggerListenerReq) GetHandlerTimeoutMs() uint32 {
	if x != nil {
		return x.HandlerTimeoutMs
	}
	return 0
}

// TriggerIntentsReq selects a running trigger listener job for the
// task-introspection RPC.
type TriggerIntentsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JobID         uint32                 `protobuf:"varint,1,opt,name=JobID,proto3" json:"JobID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *TriggerIntentsReq) Reset() {
	*x = TriggerIntentsReq{}
...
func (x *TriggerIntentsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerIntentsReq) ProtoMessage() {}

func (x *TriggerIntentsReq) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[150]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerIntentsReq.ProtoReflect.Descriptor instead.
func (*TriggerIntentsReq) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{150}
}

func (x *TriggerIntentsReq) GetJobID() uint32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
// TriggerIntents reports the task bindings registered for a running
// trigger listener. Returned by the TriggerIntents RPC.
type TriggerIntents struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	JobID         uint32                  `protobuf:"varint,1,opt,name=JobID,proto3" json:"JobID,omitempty"`
	Bindings      []*TriggerIntentBinding `protobuf:"bytes,2,rep,name=Bindings,proto3" json:"Bindings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TriggerIntents) Reset() {
	*x = TriggerIntents{}
...
func (x *TriggerIntents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerIntents) ProtoMessage() {}

func (x *TriggerIntents) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[151]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerIntents.ProtoReflect.Descriptor instead.
func (*TriggerIntents) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{151}
}

func (x *TriggerIntents) GetJobID() uint32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *TriggerIntents) GetBindings() []*TriggerIntentBinding {
	if x != nil {
		return x.Bindings
	}
	return nil
...
// TriggerDispatchTaskReq instructs the server to fire a named task
// handler on a running trigger listener, bypassing the UDP wire
// protocol. This lets operators dispatch tasks interactively from the
// sliver console ("trigger send <job-id> <task-name>") without an
// external trigger-client binary.
type TriggerDispatchTaskReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JobID         uint32                 `protobuf:"varint,1,opt,name=JobID,proto3" json:"JobID,omitempty"`
...
func (x *TriggerDispatchTaskReq) Reset() {
	*x = TriggerDispatchTaskReq{}
	mi := &file_clientpb_client_proto_msgTypes[152]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TriggerDispatchTaskReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerDispatchTaskReq) ProtoMessage() {}

func (x *TriggerDispatchTaskReq) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[152]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerDispatchTaskReq.ProtoReflect.Descriptor instead.
func (*TriggerDispatchTaskReq) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{152}
}

func (x *TriggerDispatchTaskReq) GetJobID() uint32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *TriggerDispatchTaskReq) GetTaskName() string {
	if x != nil {
		return x.TaskName
	}
	return ""
...
// TriggerFireReq instructs the server to construct a signed trigger
// packet (HMAC-SHA256, wire-format JSON) and send it as a single UDP
// datagram to the specified target. This is the sliver-native
// replacement for the standalone trigger-client binary — used to wake
// dormant implants or fire implant-side self-destruct without leaving
// the console.
//
// The SharedSecret must match the implant's baked-in triggerwake
// secret (set at generation time via --trigger-wake-secret-env /
// --trigger-wake-secret).
type TriggerFireReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TargetHost    string                 `protobuf:"bytes,1,opt,name=TargetHost,proto3" json:"TargetHost,omitempty"`     // IP or hostname of the implant
	TargetPort    uint32                 `protobuf:"varint,2,opt,name=TargetPort,proto3" json:"TargetPort,omitempty"`    // UDP port the implant's triggerwake is bound to
	Intent        string                 `protobuf:"bytes,3,opt,name=Intent,proto3" json:"Intent,omitempty"`             // intent label: "wake", "self-destruct", "exec", etc.
	SharedSecret  []byte                 `protobuf:"bytes,4,opt,name=SharedSecret,proto3" json:"SharedSecret,omitempty"` // HMAC-SHA256 shared secret
	ClientID      string                 `protobuf:"bytes,5,opt,name=ClientID,proto3" json:"ClientID,omitempty"`         // sender identity for audit trail (default: "sliver-operator")
	Payload       string                 `protobuf:"bytes,6,opt,name=Payload,proto3" json:"Payload,omitempty"`           // command/data for bidirectional intents (e.g. exec)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TriggerFireReq) Reset() {
	*x = TriggerFireReq{}
...
func (x *TriggerFireReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerFireReq) ProtoMessage() {}

func (x *TriggerFireReq) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[153]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerFireReq.ProtoReflect.Descriptor instead.
func (*TriggerFireReq) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{153}
}

func (x *TriggerFireReq) GetTargetHost() string {
	if x != nil {
		return x.TargetHost
	}
	return ""
...
func (x *TriggerFireReq) GetTargetPort() uint32 {
	if x != nil {
		return x.TargetPort
	}
	return 0
...
func (x *TriggerFireReq) GetIntent() string {
	if x != nil {
		return x.Intent
	}
	return ""
...
func (x *TriggerFireReq) GetSharedSecret() []byte {
	if x != nil {
		return x.SharedSecret
	}
	return nil
...
func (x *TriggerFireReq) GetClientID() string {
	if x != nil {
		return x.ClientID
	}
	return ""
...
func (x *TriggerFireReq) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
// TriggerFireResp carries the result of a trigger fire. For fire-and-
// forget intents (wake, self-destruct), only Sent is populated. For
// bidirectional intents (exec), Output and ExitCode carry the implant's
// response.
type TriggerFireResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Sent          bool                   `protobuf:"varint,1,opt,name=Sent,proto3" json:"Sent,omitempty"`         // true if the packet was sent
	Output        string                 `protobuf:"bytes,2,opt,name=Output,proto3" json:"Output,omitempty"`      // implant command output (exec only)
	ExitCode      int32                  `protobuf:"varint,3,opt,name=ExitCode,proto3" json:"ExitCode,omitempty"` // implant command exit code (exec only)
	Error         string                 `protobuf:"bytes,4,opt,name=Error,proto3" json:"Error,omitempty"`        // implant-side or transport error, if any
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TriggerFireResp) Reset() {
	*x = TriggerFireResp{}
...
func (x *TriggerFireResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TriggerFireResp) ProtoMessage() {}

func (x *TriggerFireResp) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[154]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TriggerFireResp.ProtoReflect.Descriptor instead.
func (*TriggerFireResp) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{154}
}

func (x *TriggerFireResp) GetSent() bool {
	if x != nil {
		return x.Sent
	}
	return false
...
func (x *TriggerFireResp) GetOutput() string {
	if x != nil {
		return x.Output
	}
	return ""
...
func (x *TriggerFireResp) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *TriggerFireResp) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_clientpb_client_proto_rawDesc = string([]byte{
	...
	,
	...
	0x64, 0x4c, 0x69, 0x62, 0x12, 0x1c, 0x0a, 0x09, 0x49, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
	...
	0x61, 0x66, 0x66, 0x69, 0x63, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x73, 0x12, 0x1d, 0x0a,
	0x09, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x9a, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x06,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x6c, 0x54, 0x65, 0x73, 0x74, 0x73, 0x22, 0xae, 0x02, 0x0a, 0x15, 0x45, 0x78, 0x74,
	...
	,
	...
	0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x49, 0x6d, 0x70, 0x6c, 0x61, 0x6e,
	0x74, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	0x49, 0x6d, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x44, 0x12, 0x22,
	...
	0x6c, 0x65, 0x22, 0xbe, 0x03, 0x0a, 0x0d, 0x49, 0x6d, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x42, 0x75,
	...
	,
	...
	0x38, 0x01, 0x1a, 0x54, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x44,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x32, 0x0a, 0x07, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x70, 0x69, 0x6c, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x57, 0x69, 0x72, 0x65, 0x47, 0x75, 0x61, 0x72, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x57, 0x69, 0x72, 0x65, 0x47, 0x75, 0x61, 0x72,
	0x64, 0x22, 0x39, 0x0a, 0x0f, 0x4d, 0x54, 0x4c, 0x53, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65,
	...
	0x52, 0x0a, 0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4f, 0x54, 0x50, 0x22, 0xd5, 0x02, 0x0a,
	...
	0x78, 0x0a, 0x08, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x12, 0x22, 0x0a, 0x04, 0x46,
	0x69, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x70, 0x62, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12,
	...
	,
	...
	0x12, 0x2b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa6, 0x01,
	0x0a, 0x11, 0x53, 0x74, 0x61, 0x67, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72,
	0x52, 0x65, 0x71, 0x12, 0x33, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62,
	...
	0x44, 0x61, 0x74, 0x61, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x4e,
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0xa8, 0x01, 0x0a, 0x0c,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xde, 0x01, 0x0a,
	...
	0x01, 0x52, 0x04, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x4f, 0x72, 0x69, 0x67, 0x69,
	0x6e, 0x61, 0x6c, 0x46, 0x69, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x4f,
	0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x53,
	0x68, 0x61, 0x32, 0x35, 0x36, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x53, 0x68, 0x61,
	0x32, 0x35, 0x36, 0x12, 0x18, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xc1, 0x01,
	...
	0x09, 0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x45, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	...
	,
	...
	0x73, 0x69, 0x74, 0x65, 0x52, 0x08, 0x57, 0x65, 0x62, 0x73, 0x69, 0x74, 0x65, 0x73, 0x22, 0xa0,
	0x01, 0x0a, 0x0e, 0x57, 0x47, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x12, 0x22, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x75, 0x62, 0x4b, 0x65,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50,
	0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x2a, 0x0a, 0x10, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50,
	...
	0x79, 0x12, 0x22, 0x0a, 0x0c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x75, 0x62, 0x4b, 0x65,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50,
	0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49,
	0x50, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49,
	0x50, 0x22, 0xba, 0x01, 0x0a, 0x04, 0x4c, 0x6f, 0x6f, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	0x6e, 0x73, 0x65, 0x22, 0xf1, 0x01, 0x0a, 0x12, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x64,
	0x65, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x12, 0x34, 0x0a, 0x07, 0x45, 0x6e,
	0x63, 0x6f, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x63, 0x6c,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x41, 0x72, 0x63, 0x68, 0x69, 0x74, 0x65, 0x63,
	0x74, 0x75, 0x72, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x49, 0x74, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x49, 0x74, 0x65, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x42, 0x61, 0x64, 0x43, 0x68, 0x61, 0x72, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x42, 0x61, 0x64, 0x43, 0x68, 0x61, 0x72, 0x73,
	...
	0x74, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x55, 0x0a, 0x0f, 0x53, 0x68, 0x65, 0x6c, 0x6c,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x3f, 0x0a, 0x11, 0x44, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xbe, 0x01, 0x0a, 0x13, 0x53,
	...
	0x79, 0x52, 0x08, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x73, 0x1a, 0x5e, 0x0a, 0x0d, 0x45,
	...
	0x07, 0x43, 0x6f, 0x6f, 0x6b, 0x69, 0x65, 0x73, 0x22, 0xbc, 0x05, 0x0a, 0x13, 0x48, 0x54, 0x54,
	...
	,
	...
	0x0c, 0x50, 0x61, 0x74, 0x68, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x2a, 0x0a,
	0x10, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x65, 0x6e, 0x67, 0x74,
	0x68, 0x18, 0x12, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x1c, 0x0a, 0x09, 0x4e, 0x6f, 0x6e,
	0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x4e, 0x6f,
	0x6e, 0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x32, 0x0a, 0x0c, 0x48, 0x54, 0x54, 0x50, 0x43,
	...
	0x50, 0x72, 0x6f, 0x62, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0x51, 0x0a, 0x11, 0x48,
	...
	0x52, 0x06, 0x49, 0x73, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x80,
	...
	0x6e, 0x64, 0x52, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0xfd, 0x03, 0x0a, 0x0c,
	0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x57, 0x68, 0x69, 0x74, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xf4,
	0x01, 0x0a, 0x08, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x4a, 0x6f, 0x62, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	...
	,
	...
	,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x4f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x6f, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0c, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a,
	0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x4d, 0x6f, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x0a, 0x04, 0x54, 0x45, 0x58, 0x54, 0x10, 0x02, 0x2a, 0x4a, 0x0a, 0x10, 0x53, 0x68, 0x65,
	...
	0x54, 0x41, 0x5f, 0x47, 0x41, 0x5f, 0x4e, 0x41, 0x49, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x58,
	0x4f, 0x52, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x58, 0x4f, 0x52, 0x5f, 0x44, 0x59, 0x4e, 0x41,
	0x4d, 0x49, 0x43, 0x10, 0x03, 0x2a, 0x35, 0x0a, 0x11, 0x48, 0x54, 0x54, 0x50, 0x43, 0x32, 0x53,
	...
	,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 171)
var file_clientpb_client_proto_goTypes = []any{
	...
	(*WakeBeaconConfig)(nil),               // 162: clientpb.WakeBeaconConfig
	(*StopJobConfig)(nil),                  // 163: clientpb.StopJobConfig
	(*ExecConfig)(nil),                     // 164: clientpb.ExecConfig
	(*ReverseShellConfig)(nil),             // 165: clientpb.ReverseShellConfig
	(*TriggerIntentBinding)(nil),           // 166: clientpb.TriggerIntentBinding
	(*TriggerListenerReq)(nil),             // 167: clientpb.TriggerListenerReq
	(*TriggerIntentsReq)(nil),              // 168: clientpb.TriggerIntentsReq
	(*TriggerIntents)(nil),                 // 169: clientpb.TriggerIntents
	(*TriggerDispatchTaskReq)(nil),         // 170: clientpb.TriggerDispatchTaskReq
	(*TriggerFireReq)(nil),                 // 171: clientpb.TriggerFireReq
	(*TriggerFireResp)(nil),                // 172: clientpb.TriggerFireResp
	nil,                                    // 173: clientpb.TrafficEncoderMap.EncodersEntry
	nil,                                    // 174: clientpb.ExternalImplantConfig.EncodersEntry
	nil,                                    // 175: clientpb.ImplantBuilds.ConfigsEntry
	nil,                                    // 176: clientpb.ImplantBuilds.ResourceIDsEntry
	nil,                                    // 177: clientpb.ImplantBuilds.StagedEntry
	nil,                                    // 178: clientpb.WebsiteAddContent.ContentsEntry
	nil,                                    // 179: clientpb.Website.ContentsEntry
	nil,                                    // 180: clientpb.Host.ExtensionDataEntry
	nil,                                    // 181: clientpb.ShellcodeEncoderArchMap.EncodersEntry
	nil,                                    // 182: clientpb.ShellcodeEncoderArchMap.DescriptionsEntry
	nil,                                    // 183: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                                    // 184: clientpb.CrackSyncStatus.ProgressEntry
	nil,                                    // 185: clientpb.CrackBenchmark.BenchmarksEntry
	nil,                                    // 186: clientpb.Crackstation.BenchmarksEntry
	nil,                                    // 187: clientpb.ExecConfig.EnvEntry
	nil,                                    // 188: clientpb.TriggerListenerReq.PerClientKeysEntry
	(*commonpb.File)(nil),                  // 189: commonpb.File
	(*commonpb.Request)(nil),               // 190: commonpb.Request
	(*commonpb.Response)(nil),              // 191: commonpb.Response
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	189, // 7: clientpb.ImplantConfig.Assets:type_name -> commonpb.File
	...
	189, // 15: clientpb.TrafficEncoder.Wasm:type_name -> commonpb.File
	173, // 16: clientpb.TrafficEncoderMap.Encoders:type_name -> clientpb.TrafficEncoderMap.EncodersEntry
	...
	174, // 22: clientpb.ExternalImplantConfig.encoders:type_name -> clientpb.ExternalImplantConfig.EncodersEntry
	189, // 23: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	175, // 24: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	176, // 25: clientpb.ImplantBuilds.ResourceIDs:type_name -> clientpb.ImplantBuilds.ResourceIDsEntry
	177, // 26: clientpb.ImplantBuilds.staged:type_name -> clientpb.ImplantBuilds.StagedEntry
	...
	167, // 41: clientpb.ListenerJob.TriggerConf:type_name -> clientpb.TriggerListenerReq
	190, // 42: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	191, // 43: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	190, // 44: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	191, // 45: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	20,  // 46: clientpb.Sessions.Sessions:type_name -> clientpb.Session
	28,  // 47: clientpb.GenerateReq.Config:type_name -> clientpb.ImplantConfig
	189, // 48: clientpb.Generate.File:type_name -> commonpb.File
	35,  // 49: clientpb.GenerateSpoofMetadataReq.SpoofMetadata:type_name -> clientpb.SpoofMetadataConfig
	190, // 50: clientpb.MSFReq.Request:type_name -> commonpb.Request
	190, // 51: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	1,   // 52: clientpb.StagerListenerReq.Protocol:type_name -> clientpb.StageProtocol
	28,  // 53: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	190, // 54: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	28,  // 55: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	3,   // 56: clientpb.MigrateReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	190, // 57: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	190, // 58: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	190, // 59: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	20,  // 60: clientpb.PivotGraphEntry.Session:type_name -> clientpb.Session
	87,  // 61: clientpb.PivotGraphEntry.Children:type_name -> clientpb.PivotGraphEntry
	87,  // 62: clientpb.PivotGraph.Children:type_name -> clientpb.PivotGraphEntry
	92,  // 63: clientpb.Client.Operator:type_name -> clientpb.Operator
	20,  // 64: clientpb.Event.Session:type_name -> clientpb.Session
	55,  // 65: clientpb.Event.Job:type_name -> clientpb.Job
	89,  // 66: clientpb.Event.Client:type_name -> clientpb.Client
	92,  // 67: clientpb.Operators.Operators:type_name -> clientpb.Operator
	178, // 68: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	179, // 69: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	96,  // 70: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 71: clientpb.Loot.FileType:type_name -> clientpb.FileType
	189, // 72: clientpb.Loot.File:type_name -> commonpb.File
	99,  // 73: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	101, // 74: clientpb.Host.IOCs:type_name -> clientpb.IOC
	180, // 75: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	103, // 76: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	190, // 77: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	191, // 78: clientpb.DllHijack.Response:type_name -> commonpb.Response
	190, // 79: clientpb.BackdoorReq.Request:type_name -> commonpb.Request
	191, // 80: clientpb.Backdoor.Response:type_name -> commonpb.Response
	3,   // 81: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	190, // 82: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	191, // 83: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	181, // 84: clientpb.ShellcodeEncoderArchMap.Encoders:type_name -> clientpb.ShellcodeEncoderArchMap.EncodersEntry
	182, // 85: clientpb.ShellcodeEncoderArchMap.Descriptions:type_name -> clientpb.ShellcodeEncoderArchMap.DescriptionsEntry
	183, // 86: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	28,  // 87: clientpb.ExternalGenerateReq.Config:type_name -> clientpb.ImplantConfig
	115, // 88: clientpb.Builders.Builders:type_name -> clientpb.Builder
	45,  // 89: clientpb.Builder.Targets:type_name -> clientpb.CompilerTarget
	46,  // 90: clientpb.Builder.CrossCompilers:type_name -> clientpb.CrossCompiler
	119, // 91: clientpb.HTTPC2Configs.configs:type_name -> clientpb.HTTPC2Config
	119, // 92: clientpb.HTTPC2ConfigReq.C2Config:type_name -> clientpb.HTTPC2Config
	120, // 93: clientpb.HTTPC2Config.ServerConfig:type_name -> clientpb.HTTPC2ServerConfig
	121, // 94: clientpb.HTTPC2Config.ImplantConfig:type_name -> clientpb.HTTPC2ImplantConfig
	123, // 95: clientpb.HTTPC2ServerConfig.Headers:type_name -> clientpb.HTTPC2Header
	122, // 96: clientpb.HTTPC2ServerConfig.Cookies:type_name -> clientpb.HTTPC2Cookie
	124, // 97: clientpb.HTTPC2ImplantConfig.ExtraURLParameters:type_name -> clientpb.HTTPC2URLParameter
	123, // 98: clientpb.HTTPC2ImplantConfig.Headers:type_name -> clientpb.HTTPC2Header
	125, // 99: clientpb.HTTPC2ImplantConfig.PathSegments:type_name -> clientpb.HTTPC2PathSegment
	5,   // 100: clientpb.Credential.HashType:type_name -> clientpb.HashType
	126, // 101: clientpb.Credentials.Credentials:type_name -> clientpb.Credential
	133, // 102: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	6,   // 103: clientpb.CrackstationStatus.State:type_name -> clientpb.States
	130, // 104: clientpb.CrackstationStatus.Syncing:type_name -> clientpb.CrackSyncStatus
	184, // 105: clientpb.CrackSyncStatus.Progress:type_name -> clientpb.CrackSyncStatus.ProgressEntry
	185, // 106: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	137, // 107: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	186, // 108: clientpb.Crackstation.Benchmarks:type_name -> clientpb.Crackstation.BenchmarksEntry
	134, // 109: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	136, // 110: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	135, // 111: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	8,   // 112: clientpb.CrackCommand.AttackMode:type_name -> clientpb.CrackAttackMode
	5,   // 113: clientpb.CrackCommand.HashType:type_name -> clientpb.HashType
	10,  // 114: clientpb.CrackCommand.OutfileFormat:type_name -> clientpb.CrackOutfileFormat
	9,   // 115: clientpb.CrackCommand.EncodingFrom:type_name -> clientpb.CrackEncoding
	9,   // 116: clientpb.CrackCommand.EncodingTo:type_name -> clientpb.CrackEncoding
	11,  // 117: clientpb.CrackCommand.WorkloadProfile:type_name -> clientpb.CrackWorkloadProfile
	7,   // 118: clientpb.CrackJob.Status:type_name -> clientpb.CrackJobStatus
	137, // 119: clientpb.CrackJob.Command:type_name -> clientpb.CrackCommand
	138, // 120: clientpb.CrackResponse.Job:type_name -> clientpb.CrackJob
	142, // 121: clientpb.CrackFiles.Files:type_name -> clientpb.CrackFile
	12,  // 122: clientpb.CrackFile.Type:type_name -> clientpb.CrackFileType
	143, // 123: clientpb.CrackFile.Chunks:type_name -> clientpb.CrackFileChunk
	145, // 124: clientpb.AIProviderConfigs.Providers:type_name -> clientpb.AIProviderConfig
	146, // 125: clientpb.AIProviderConfigs.Config:type_name -> clientpb.AIConfigSummary
	150, // 126: clientpb.AIConversations.Conversations:type_name -> clientpb.AIConversation
	152, // 127: clientpb.AIConversation.Messages:type_name -> clientpb.AIConversationMessage
	13,  // 128: clientpb.AIConversation.TurnState:type_name -> clientpb.AIConversationTurnState
	149, // 129: clientpb.AIConversation.ContextWindowUsage:type_name -> clientpb.AIContextWindowUsage
	152, // 130: clientpb.AIConversationMessages.Messages:type_name -> clientpb.AIConversationMessage
	14,  // 131: clientpb.AIConversationMessage.Kind:type_name -> clientpb.AIConversationMessageKind
	15,  // 132: clientpb.AIConversationMessage.Visibility:type_name -> clientpb.AIConversationMessageVisibility
	16,  // 133: clientpb.AIConversationMessage.State:type_name -> clientpb.AIConversationMessageState
	17,  // 134: clientpb.AIConversationEvent.EventType:type_name -> clientpb.AIConversationEventType
	150, // 135: clientpb.AIConversationEvent.Conversation:type_name -> clientpb.AIConversation
	152, // 136: clientpb.AIConversationEvent.Message:type_name -> clientpb.AIConversationMessage
	155, // 137: clientpb.MonitoringProviders.providers:type_name -> clientpb.MonitoringProvider
	158, // 138: clientpb.CertificateInfo.info:type_name -> clientpb.CertificateData
	160, // 139: clientpb.CertificateAuthorityInfo.info:type_name -> clientpb.CertificateAuthorityData
	187, // 140: clientpb.ExecConfig.Env:type_name -> clientpb.ExecConfig.EnvEntry
	162, // 141: clientpb.TriggerIntentBinding.WakeBeacon:type_name -> clientpb.WakeBeaconConfig
	163, // 142: clientpb.TriggerIntentBinding.StopJob:type_name -> clientpb.StopJobConfig
	164, // 143: clientpb.TriggerIntentBinding.Exec:type_name -> clientpb.ExecConfig
	165, // 144: clientpb.TriggerIntentBinding.ReverseShell:type_name -> clientpb.ReverseShellConfig
	188, // 145: clientpb.TriggerListenerReq.PerClientKeys:type_name -> clientpb.TriggerListenerReq.PerClientKeysEntry
	166, // 146: clientpb.TriggerListenerReq.Intents:type_name -> clientpb.TriggerIntentBinding
	166, // 147: clientpb.TriggerIntents.Bindings:type_name -> clientpb.TriggerIntentBinding
	36,  // 148: clientpb.TrafficEncoderMap.EncodersEntry.value:type_name -> clientpb.TrafficEncoder
	28,  // 149: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	156, // 150: clientpb.ImplantBuilds.ResourceIDsEntry.value:type_name -> clientpb.ResourceID
	93,  // 151: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	93,  // 152: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	102, // 153: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 154: clientpb.ShellcodeEncoderArchMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
	111, // 155: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoderArchMap
...
func file_clientpb_client_proto_init() {
	...
	file_clientpb_client_proto_msgTypes[148].OneofWrappers = []any{
		(*TriggerIntentBinding_WakeBeacon)(nil),
		(*TriggerIntentBinding_StopJob)(nil),
		(*TriggerIntentBinding_Exec)(nil),
		(*TriggerIntentBinding_ReverseShell)(nil),
	}
	type x struct{}
