...
var file_sliverpb_sliver_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x79, 0x0a, 0x0a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52,
	...
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x70, 0x62, 0x2e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22,
	0x7e, 0x0a, 0x0f, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52,
	0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x50, 0x61, 0x74, 0x68, 0x12, 0x12, 0x0a, 0x04, 0x41, 0x72, 0x67, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x41, 0x72, 0x67, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x4f, 0x75,
	0x74, 0x70, 0x75, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x4f, 0x75, 0x74, 0x70,
	...
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x70, 0x62, 0x2e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22,
	0x69, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2e, 0x0a, 0x08, 0x52, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x52, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xf3,
...
var file_sliverpb_sliver_proto_depIdxs = []int32{
	130, // 0: sliverpb.Ping.Response:type_name -> commonpb.Response
	131, // 1: sliverpb.Ping.Request:type_name -> commonpb.Request
	131, // 2: sliverpb.KillSessionReq.Request:type_name -> commonpb.Request
	131, // 3: sliverpb.PsReq.Request:type_name -> commonpb.Request
	132, // 4: sliverpb.Ps.Processes:type_name -> commonpb.Process
	130, // 5: sliverpb.Ps.Response:type_name -> commonpb.Response
	131, // 6: sliverpb.TerminateReq.Request:type_name -> commonpb.Request
	130, // 7: sliverpb.Terminate.Response:type_name -> commonpb.Response
	131, // 8: sliverpb.IfconfigReq.Request:type_name -> commonpb.Request
	10,  // 9: sliverpb.Ifconfig.NetInterfaces:type_name -> sliverpb.NetInterface
	130, // 10: sliverpb.Ifconfig.Response:type_name -> commonpb.Response
	131, // 11: sliverpb.LsReq.Request:type_name -> commonpb.Request
	13,  // 12: sliverpb.Ls.Files:type_name -> sliverpb.FileInfo
	130, // 13: sliverpb.Ls.Response:type_name -> commonpb.Response
	131, // 14: sliverpb.CdReq.Request:type_name -> commonpb.Request
	131, // 15: sliverpb.PwdReq.Request:type_name -> commonpb.Request
	130, // 16: sliverpb.Pwd.Response:type_name -> commonpb.Response
	131, // 17: sliverpb.RmReq.Request:type_name -> commonpb.Request
	130, // 18: sliverpb.Rm.Response:type_name -> commonpb.Response
	131, // 19: sliverpb.MkdirReq.Request:type_name -> commonpb.Request
	130, // 20: sliverpb.Mkdir.Response:type_name -> commonpb.Response
	131, // 21: sliverpb.DownloadReq.Request:type_name -> commonpb.Request
	130, // 22: sliverpb.Download.Response:type_name -> commonpb.Response
	131, // 23: sliverpb.UploadReq.Request:type_name -> commonpb.Request
	130, // 24: sliverpb.Upload.Response:type_name -> commonpb.Response
	131, // 25: sliverpb.ProcessDumpReq.Request:type_name -> commonpb.Request
	130, // 26: sliverpb.ProcessDump.Response:type_name -> commonpb.Response
	131, // 27: sliverpb.RunAsReq.Request:type_name -> commonpb.Request
	130, // 28: sliverpb.RunAs.Response:type_name -> commonpb.Response
	131, // 29: sliverpb.ImpersonateReq.Request:type_name -> commonpb.Request
	130, // 30: sliverpb.Impersonate.Response:type_name -> commonpb.Response
	131, // 31: sliverpb.RevToSelfReq.Request:type_name -> commonpb.Request
	130, // 32: sliverpb.RevToSelf.Response:type_name -> commonpb.Response
	131, // 33: sliverpb.InvokeGetSystemReq.Request:type_name -> commonpb.Request
	130, // 34: sliverpb.GetSystem.Response:type_name -> commonpb.Response
	131, // 35: sliverpb.MakeTokenReq.Request:type_name -> commonpb.Request
	130, // 36: sliverpb.MakeToken.Response:type_name -> commonpb.Response
	131, // 37: sliverpb.TaskReq.Request:type_name -> commonpb.Request
	130, // 38: sliverpb.Task.Response:type_name -> commonpb.Response
	131, // 39: sliverpb.ExecuteAssemblyReq.Request:type_name -> commonpb.Request
	131, // 40: sliverpb.InvokeExecuteAssemblyReq.Request:type_name -> commonpb.Request
	130, // 41: sliverpb.ExecuteAssembly.Response:type_name -> commonpb.Response
	131, // 42: sliverpb.InvokeMigrateReq.Request:type_name -> commonpb.Request
	130, // 43: sliverpb.Migrate.Response:type_name -> commonpb.Response
	131, // 44: sliverpb.ExecuteReq.Request:type_name -> commonpb.Request
	131, // 45: sliverpb.ExecuteTokenReq.Request:type_name -> commonpb.Request
	130, // 46: sliverpb.Execute.Response:type_name -> commonpb.Response
	131, // 47: sliverpb.SideloadReq.Request:type_name -> commonpb.Request
	130, // 48: sliverpb.Sideload.Response:type_name -> commonpb.Response
	131, // 49: sliverpb.InvokeSpawnDllReq.Request:type_name -> commonpb.Request
	131, // 50: sliverpb.SpawnDllReq.Request:type_name -> commonpb.Request
	130, // 51: sliverpb.SpawnDll.Response:type_name -> commonpb.Response
	131, // 52: sliverpb.NetstatReq.Request:type_name -> commonpb.Request
	129, // 53: sliverpb.SockTabEntry.LocalAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	129, // 54: sliverpb.SockTabEntry.RemoteAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	132, // 55: sliverpb.SockTabEntry.Process:type_name -> commonpb.Process
	53,  // 56: sliverpb.Netstat.Entries:type_name -> sliverpb.SockTabEntry
	130, // 57: sliverpb.Netstat.Response:type_name -> commonpb.Response
	131, // 58: sliverpb.EnvReq.Request:type_name -> commonpb.Request
	133, // 59: sliverpb.EnvInfo.Variables:type_name -> commonpb.EnvVar
	130, // 60: sliverpb.EnvInfo.Response:type_name -> commonpb.Response
	133, // 61: sliverpb.SetEnvReq.Variable:type_name -> commonpb.EnvVar
	131, // 62: sliverpb.SetEnvReq.Request:type_name -> commonpb.Request
	130, // 63: sliverpb.SetEnv.Response:type_name -> commonpb.Response
	131, // 64: sliverpb.UnsetEnvReq.Request:type_name -> commonpb.Request
	130, // 65: sliverpb.UnsetEnv.Response:type_name -> commonpb.Response
	63,  // 66: sliverpb.DNSPoll.blocks:type_name -> sliverpb.DNSBlockHeader
	131, // 67: sliverpb.ScreenshotReq.Request:type_name -> commonpb.Request
	130, // 68: sliverpb.Screenshot.Response:type_name -> commonpb.Response
	131, // 69: sliverpb.StartServiceReq.Request:type_name -> commonpb.Request
	130, // 70: sliverpb.ServiceInfo.Response:type_name -> commonpb.Response
	69,  // 71: sliverpb.StopServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	131, // 72: sliverpb.StopServiceReq.Request:type_name -> commonpb.Request
	69,  // 73: sliverpb.RemoveServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	131, // 74: sliverpb.RemoveServiceReq.Request:type_name -> commonpb.Request
	131, // 75: sliverpb.BackdoorReq.Request:type_name -> commonpb.Request
	130, // 76: sliverpb.Backdoor.Response:type_name -> commonpb.Response
	131, // 77: sliverpb.RegistryReadReq.Request:type_name -> commonpb.Request
	130, // 78: sliverpb.RegistryRead.Response:type_name -> commonpb.Response
	131, // 79: sliverpb.RegistryWriteReq.Request:type_name -> commonpb.Request
	130, // 80: sliverpb.RegistryWrite.Response:type_name -> commonpb.Response
	131, // 81: sliverpb.RegistryCreateKeyReq.Request:type_name -> commonpb.Request
	130, // 82: sliverpb.RegistryCreateKey.Response:type_name -> commonpb.Response
	131, // 83: sliverpb.RegistrySubKeyListReq.Request:type_name -> commonpb.Request
	130, // 84: sliverpb.RegistrySubKeyList.Response:type_name -> commonpb.Response
	131, // 85: sliverpb.RegistryListValuesReq.Request:type_name -> commonpb.Request
	130, // 86: sliverpb.RegistryValuesList.Response:type_name -> commonpb.Response
	131, // 87: sliverpb.ShellReq.Request:type_name -> commonpb.Request
	130, // 88: sliverpb.Shell.Response:type_name -> commonpb.Response
	131, // 89: sliverpb.PortfwdReq.Request:type_name -> commonpb.Request
	130, // 90: sliverpb.Portfwd.Response:type_name -> commonpb.Response
	131, // 91: sliverpb.NamedPipesReq.Request:type_name -> commonpb.Request
	130, // 92: sliverpb.NamedPipes.Response:type_name -> commonpb.Response
	131, // 93: sliverpb.TCPPivotReq.Request:type_name -> commonpb.Request
	130, // 94: sliverpb.TCPPivot.Response:type_name -> commonpb.Response
	131, // 95: sliverpb.PivotListReq.Request:type_name -> commonpb.Request
	97,  // 96: sliverpb.PivotList.Entries:type_name -> sliverpb.PivotEntry
	130, // 97: sliverpb.PivotList.Response:type_name -> commonpb.Response
	131, // 98: sliverpb.WGPortForwardStartReq.Request:type_name -> commonpb.Request
	108, // 99: sliverpb.WGPortForward.Forwarder:type_name -> sliverpb.WGTCPForwarder
	130, // 100: sliverpb.WGPortForward.Response:type_name -> commonpb.Response
	131, // 101: sliverpb.WGPortForwardStopReq.Request:type_name -> commonpb.Request
	131, // 102: sliverpb.WGSocksStartReq.Request:type_name -> commonpb.Request
	109, // 103: sliverpb.WGSocks.Server:type_name -> sliverpb.WGSocksServer
	130, // 104: sliverpb.WGSocks.Response:type_name -> commonpb.Response
	131, // 105: sliverpb.WGSocksStopReq.Request:type_name -> commonpb.Request
	131, // 106: sliverpb.WGTCPForwardersReq.Request:type_name -> commonpb.Request
	131, // 107: sliverpb.WGSocksServersReq.Request:type_name -> commonpb.Request
	109, // 108: sliverpb.WGSocksServers.Servers:type_name -> sliverpb.WGSocksServer
	130, // 109: sliverpb.WGSocksServers.Response:type_name -> commonpb.Response
	108, // 110: sliverpb.WGTCPForwarders.Forwarders:type_name -> sliverpb.WGTCPForwarder
	130, // 111: sliverpb.WGTCPForwarders.Response:type_name -> commonpb.Response
	131, // 112: sliverpb.ReconnectIntervalReq.Request:type_name -> commonpb.Request
	130, // 113: sliverpb.ReconnectInterval.Response:type_name -> commonpb.Response
	131, // 114: sliverpb.PollIntervalReq.Request:type_name -> commonpb.Request
	130, // 115: sliverpb.PollInterval.Response:type_name -> commonpb.Response
	131, // 116: sliverpb.SSHCommandReq.Request:type_name -> commonpb.Request
	130, // 117: sliverpb.SSHCommand.Response:type_name -> commonpb.Response
	131, // 118: sliverpb.DllHijackReq.Request:type_name -> commonpb.Request
	130, // 119: sliverpb.DllHijack.Response:type_name -> commonpb.Response
