...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x62, 0x49, 0x44, 0x22, 0xcf, 0x02, 0x0a, 0x0f, 0x48, 0x54, 0x54, 0x50, 0x4c, 0x69, 0x73, 0x74,
	...
	0x69, 0x74, 0x74, 0x65, 0x72, 0x22, 0x58, 0x0a, 0x0d, 0x4e, 0x61, 0x6d, 0x65, 0x64, 0x50, 0x69,
	...
	0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xbb, 0x02, 0x0a, 0x04, 0x48, 0x6f, 0x73, 0x74, 0x12,
	...
	0x09, 0x52, 0x06, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x65, 0x1a, 0x59, 0x0a, 0x12, 0x45, 0x78, 0x74,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x58, 0x0a, 0x0c, 0x4f, 0x75, 0x74, 0x70,
	...
	0x43, 0x45, 0x10, 0x03, 0x12, 0x0c, 0x0a, 0x08, 0x45, 0x58, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c,
	...
	,
	...
	0x26, 0x0a, 0x10, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x64, 0x65, 0x45, 0x6e, 0x63, 0x6f,
	0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x48, 0x49, 0x4b, 0x41, 0x54, 0x41, 0x5f, 0x47,
	0x41, 0x5f, 0x4e, 0x41, 0x49, 0x10, 0x00, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*Credential)(nil),            // 71: clientpb.Credential
	...
	nil,                           // 83: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 84: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 85: clientpb.Website.ContentsEntry
	nil,                           // 86: clientpb.Host.ExtensionDataEntry
	nil,                           // 87: clientpb.ShellcodeEncoderMap.EncodersEntry
	(*commonpb.Request)(nil),      // 88: commonpb.Request
	(*commonpb.Response)(nil),     // 89: commonpb.Response
	(*commonpb.File)(nil),         // 90: commonpb.File
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	83, // 5: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	0,  // 6: clientpb.CompilerTarget.Format:type_name -> clientpb.OutputFormat
	16, // 7: clientpb.Compiler.Targets:type_name -> clientpb.CompilerTarget
	17, // 8: clientpb.Compiler.CrossCompilers:type_name -> clientpb.CrossCompiler
	16, // 9: clientpb.Compiler.UnsupportedTargets:type_name -> clientpb.CompilerTarget
	20, // 10: clientpb.Canaries.Canaries:type_name -> clientpb.DNSCanary
	13, // 11: clientpb.ImplantProfile.Config:type_name -> clientpb.ImplantConfig
	23, // 12: clientpb.ImplantProfiles.Profiles:type_name -> clientpb.ImplantProfile
	26, // 13: clientpb.Jobs.Active:type_name -> clientpb.Job
	88, // 14: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	89, // 15: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	88, // 16: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	89, // 17: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	7,  // 18: clientpb.Sessions.Sessions:type_name -> clientpb.Session
	13, // 19: clientpb.GenerateReq.Config:type_name -> clientpb.ImplantConfig
	90, // 20: clientpb.Generate.File:type_name -> commonpb.File
	88, // 21: clientpb.MSFReq.Request:type_name -> commonpb.Request
	88, // 22: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	1,  // 23: clientpb.StagerListenerReq.Protocol:type_name -> clientpb.StageProtocol
	1,  // 24: clientpb.MsfStagerReq.Protocol:type_name -> clientpb.StageProtocol
	90, // 25: clientpb.MsfStager.File:type_name -> commonpb.File
	13, // 26: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	88, // 27: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	13, // 28: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	88, // 29: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	88, // 30: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	88, // 31: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	7,  // 32: clientpb.PivotGraphEntry.Session:type_name -> clientpb.Session
	59, // 33: clientpb.PivotGraphEntry.Children:type_name -> clientpb.PivotGraphEntry
	59, // 34: clientpb.PivotGraph.Children:type_name -> clientpb.PivotGraphEntry
	64, // 35: clientpb.Client.Operator:type_name -> clientpb.Operator
	7,  // 36: clientpb.Event.Session:type_name -> clientpb.Session
	26, // 37: clientpb.Event.Job:type_name -> clientpb.Job
	61, // 38: clientpb.Event.Client:type_name -> clientpb.Client
	64, // 39: clientpb.Operators.Operators:type_name -> clientpb.Operator
	84, // 40: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	85, // 41: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	68, // 42: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,  // 43: clientpb.Loot.Type:type_name -> clientpb.LootType
	3,  // 44: clientpb.Loot.CredentialType:type_name -> clientpb.CredentialType
	71, // 45: clientpb.Loot.Credential:type_name -> clientpb.Credential
	4,  // 46: clientpb.Loot.FileType:type_name -> clientpb.FileType
	90, // 47: clientpb.Loot.File:type_name -> commonpb.File
	72, // 48: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	74, // 49: clientpb.Host.IOCs:type_name -> clientpb.IOC
	86, // 50: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	76, // 51: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	88, // 52: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	89, // 53: clientpb.DllHijack.Response:type_name -> commonpb.Response
	5,  // 54: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	88, // 55: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	89, // 56: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	87, // 57: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	13, // 58: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	65, // 59: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	65, // 60: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	75, // 61: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	5,  // 62: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
