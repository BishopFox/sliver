...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x22, 0x6a, 0x0a, 0x08, 0x43, 0x6f, 0x6d, 0x70, 0x69,
	...
	0x22, 0x93, 0x01, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x74, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x50, 0x6f, 0x6c, 0x6c, 0x49, 0x6e,
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0x3e, 0x0a, 0x0b, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	...
	0x49, 0x50, 0x2a, 0x4a, 0x0a, 0x0c, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x46, 0x6f, 0x72, 0x6d,
	...
	0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x48, 0x54, 0x54, 0x50, 0x53, 0x10, 0x02, 0x42, 0x2f, 0x5a,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*Compiler)(nil),             // 8: clientpb.Compiler
	(*DeleteReq)(nil),            // 9: clientpb.DeleteReq
	(*DNSCanary)(nil),            // 10: clientpb.DNSCanary
	(*Canaries)(nil),             // 11: clientpb.Canaries
	(*UniqueWGIP)(nil),           // 12: clientpb.UniqueWGIP
	(*ImplantProfile)(nil),       // 13: clientpb.ImplantProfile
	(*ImplantProfiles)(nil),      // 14: clientpb.ImplantProfiles
	(*RegenerateReq)(nil),        // 15: clientpb.RegenerateReq
	(*Job)(nil),                  // 16: clientpb.Job
	(*Jobs)(nil),                 // 17: clientpb.Jobs
	(*KillJobReq)(nil),           // 18: clientpb.KillJobReq
	(*KillJob)(nil),              // 19: clientpb.KillJob
	(*MTLSListenerReq)(nil),      // 20: clientpb.MTLSListenerReq
	(*MTLSListener)(nil),         // 21: clientpb.MTLSListener
	(*WGListenerReq)(nil),        // 22: clientpb.WGListenerReq
	(*WGListener)(nil),           // 23: clientpb.WGListener
	(*DNSListenerReq)(nil),       // 24: clientpb.DNSListenerReq
	(*DNSListener)(nil),          // 25: clientpb.DNSListener
	(*HTTPListenerReq)(nil),      // 26: clientpb.HTTPListenerReq
	(*NamedPipesReq)(nil),        // 27: clientpb.NamedPipesReq
	(*NamedPipes)(nil),           // 28: clientpb.NamedPipes
	(*TCPPivotReq)(nil),          // 29: clientpb.TCPPivotReq
	(*TCPPivot)(nil),             // 30: clientpb.TCPPivot
	(*HTTPListener)(nil),         // 31: clientpb.HTTPListener
	(*Sessions)(nil),             // 32: clientpb.Sessions
	(*UpdateSession)(nil),        // 33: clientpb.UpdateSession
	(*GenerateReq)(nil),          // 34: clientpb.GenerateReq
	(*Generate)(nil),             // 35: clientpb.Generate
	(*MSFReq)(nil),               // 36: clientpb.MSFReq
	(*MSFRemoteReq)(nil),         // 37: clientpb.MSFRemoteReq
	(*StagerListenerReq)(nil),    // 38: clientpb.StagerListenerReq
	(*StagerListener)(nil),       // 39: clientpb.StagerListener
	(*ShellcodeRDIReq)(nil),      // 40: clientpb.ShellcodeRDIReq
	(*ShellcodeRDI)(nil),         // 41: clientpb.ShellcodeRDI
	(*MsfStagerReq)(nil),         // 42: clientpb.MsfStagerReq
	(*MsfStager)(nil),            // 43: clientpb.MsfStager
	(*GetSystemReq)(nil),         // 44: clientpb.GetSystemReq
	(*MigrateReq)(nil),           // 45: clientpb.MigrateReq
	(*CreateTunnelReq)(nil),      // 46: clientpb.CreateTunnelReq
	(*CreateTunnel)(nil),         // 47: clientpb.CreateTunnel
	(*CloseTunnelReq)(nil),       // 48: clientpb.CloseTunnelReq
	(*Client)(nil),               // 49: clientpb.Client
	(*Event)(nil),                // 50: clientpb.Event
	(*Operators)(nil),            // 51: clientpb.Operators
	(*Operator)(nil),             // 52: clientpb.Operator
	...
	(*WGClientConfig)(nil),       // 58: clientpb.WGClientConfig
	nil,                          // 59: clientpb.ImplantBuilds.ConfigsEntry
	nil,                          // 60: clientpb.WebsiteAddContent.ContentsEntry
	nil,                          // 61: clientpb.Website.ContentsEntry
	(*commonpb.Request)(nil),     // 62: commonpb.Request
	(*commonpb.Response)(nil),    // 63: commonpb.Response
	(*commonpb.File)(nil),        // 64: commonpb.File
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	59, // 2: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	10, // 5: clientpb.Canaries.Canaries:type_name -> clientpb.DNSCanary
	5,  // 6: clientpb.ImplantProfile.Config:type_name -> clientpb.ImplantConfig
	13, // 7: clientpb.ImplantProfiles.Profiles:type_name -> clientpb.ImplantProfile
	16, // 8: clientpb.Jobs.Active:type_name -> clientpb.Job
	62, // 9: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	63, // 10: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	62, // 11: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	63, // 12: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	3,  // 13: clientpb.Sessions.Sessions:type_name -> clientpb.Session
	5,  // 14: clientpb.GenerateReq.Config:type_name -> clientpb.ImplantConfig
	64, // 15: clientpb.Generate.File:type_name -> commonpb.File
	62, // 16: clientpb.MSFReq.Request:type_name -> commonpb.Request
	62, // 17: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	1,  // 18: clientpb.StagerListenerReq.Protocol:type_name -> clientpb.StageProtocol
	1,  // 19: clientpb.MsfStagerReq.Protocol:type_name -> clientpb.StageProtocol
	64, // 20: clientpb.MsfStager.File:type_name -> commonpb.File
	5,  // 21: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	62, // 22: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	5,  // 23: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	62, // 24: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	62, // 25: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	62, // 26: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	52, // 27: clientpb.Client.Operator:type_name -> clientpb.Operator
	3,  // 28: clientpb.Event.Session:type_name -> clientpb.Session
	16, // 29: clientpb.Event.Job:type_name -> clientpb.Job
	49, // 30: clientpb.Event.Client:type_name -> clientpb.Client
	52, // 31: clientpb.Operators.Operators:type_name -> clientpb.Operator
	60, // 32: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	61, // 33: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	56, // 34: clientpb.Websites.Websites:type_name -> clientpb.Website
	5,  // 35: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	53, // 36: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	53, // 37: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
