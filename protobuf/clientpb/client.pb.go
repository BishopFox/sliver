...
type CrackJob struct {
	...
	Mode CrackAttackMode `protobuf:"varint,1,opt,name=Mode,proto3,enum=clientpb.CrackAttackMode" json:"Mode,omitempty"`
}
...
func (x *CrackJob) GetMode() CrackAttackMode {
	if x != nil {
		return x.Mode
	}
...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x0d, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb0,
	...
	0x68, 0x63, 0x61, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x04, 0x43,
	...
	0x4c, 0x22, 0xa1, 0x02, 0x0a, 0x0f, 0x43, 0x55, 0x44, 0x41, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e,
	...
	0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x39, 0x0a, 0x08, 0x43, 0x72, 0x61, 0x63,
	0x6b, 0x4a, 0x6f, 0x62, 0x12, 0x2d, 0x0a, 0x04, 0x4d, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x19, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x43, 0x72,
	0x61, 0x63, 0x6b, 0x41, 0x74, 0x74, 0x61, 0x63, 0x6b, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x4d,
	0x6f, 0x64, 0x65, 0x22, 0x45, 0x0a, 0x03, 0x49, 0x4f, 0x43, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x68, 0x0a, 0x13, 0x45, 0x78, 0x74,
	...
	0x73, 0x2a, 0x5b, 0x0a, 0x0c, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x61,
	...
	0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x54, 0x45, 0x58, 0x54, 0x10, 0x02, 0x2a, 0xf1, 0x07, 0x0a,
	...
	0x4d, 0x44, 0x35, 0x5f, 0x50, 0x57, 0x10, 0xfe, 0x1c, 0x12, 0x19, 0x0a, 0x13, 0x4b, 0x45, 0x52,
	...
	0x4e, 0x54, 0x10, 0xdc, 0xd3, 0x01, 0x12, 0x07, 0x0a, 0x02, 0x4c, 0x4d, 0x10, 0xb8, 0x17, 0x12,
	0x09, 0x0a, 0x04, 0x4e, 0x54, 0x4c, 0x4d, 0x10, 0xe8, 0x07, 0x12, 0x08, 0x0a, 0x03, 0x44, 0x43,
	...
	0x2a, 0x85, 0x01, 0x0a, 0x0f, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x41, 0x74, 0x74, 0x61, 0x63, 0x6b,
	...
	0x49, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x09, 0x2a, 0x30, 0x0a, 0x10, 0x53, 0x68, 0x65, 0x6c,
...
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*Loot)(nil),                  // 72: clientpb.Loot
	(*AllLoot)(nil),               // 73: clientpb.AllLoot
	(*Credential)(nil),            // 74: clientpb.Credential
	(*HashedCredential)(nil),      // 75: clientpb.HashedCredential
	(*Crackstations)(nil),         // 76: clientpb.Crackstations
	(*Crackstation)(nil),          // 77: clientpb.Crackstation
	(*CUDABackendInfo)(nil),       // 78: clientpb.CUDABackendInfo
	(*OpenCLBackendInfo)(nil),     // 79: clientpb.OpenCLBackendInfo
	(*MetalBackendInfo)(nil),      // 80: clientpb.MetalBackendInfo
	(*CrackJob)(nil),              // 81: clientpb.CrackJob
	(*IOC)(nil),                   // 82: clientpb.IOC
	(*ExtensionData)(nil),         // 83: clientpb.ExtensionData
	(*Host)(nil),                  // 84: clientpb.Host
	(*AllHosts)(nil),              // 85: clientpb.AllHosts
	(*DllHijackReq)(nil),          // 86: clientpb.DllHijackReq
	(*DllHijack)(nil),             // 87: clientpb.DllHijack
	(*ShellcodeEncodeReq)(nil),    // 88: clientpb.ShellcodeEncodeReq
	(*ShellcodeEncode)(nil),       // 89: clientpb.ShellcodeEncode
	(*ShellcodeEncoderMap)(nil),   // 90: clientpb.ShellcodeEncoderMap
	(*ExternalGenerateReq)(nil),   // 91: clientpb.ExternalGenerateReq
	(*Builders)(nil),              // 92: clientpb.Builders
	(*Builder)(nil),               // 93: clientpb.Builder
	nil,                           // 94: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 95: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 96: clientpb.Website.ContentsEntry
	nil,                           // 97: clientpb.Host.ExtensionDataEntry
	nil,                           // 98: clientpb.ShellcodeEncoderMap.EncodersEntry
	(*commonpb.File)(nil),         // 99: commonpb.File
	(*commonpb.Request)(nil),      // 100: commonpb.Request
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	99,  // 5: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	94,  // 6: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	100, // 15: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	101, // 16: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	100, // 17: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	101, // 18: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	99,  // 21: clientpb.Generate.File:type_name -> commonpb.File
	100, // 22: clientpb.MSFReq.Request:type_name -> commonpb.Request
	100, // 23: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	99,  // 26: clientpb.MsfStager.File:type_name -> commonpb.File
	13,  // 27: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	100, // 28: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	100, // 31: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	100, // 32: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	100, // 33: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	95,  // 42: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	96,  // 43: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	69,  // 44: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 45: clientpb.Loot.FileType:type_name -> clientpb.FileType
	99,  // 46: clientpb.Loot.File:type_name -> commonpb.File
	72,  // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	74,  // 48: clientpb.HashedCredential.Credential:type_name -> clientpb.Credential
	3,   // 49: clientpb.HashedCredential.HashType:type_name -> clientpb.HashType
	77,  // 50: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	78,  // 51: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	80,  // 52: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	79,  // 53: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	4,   // 54: clientpb.CrackJob.Mode:type_name -> clientpb.CrackAttackMode
	82,  // 55: clientpb.Host.IOCs:type_name -> clientpb.IOC
	97,  // 56: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	84,  // 57: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	100, // 58: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	101, // 59: clientpb.DllHijack.Response:type_name -> commonpb.Response
	5,   // 60: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	100, // 61: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	101, // 62: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	98,  // 63: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	13,  // 64: clientpb.ExternalGenerateReq.Config:type_name -> clientpb.ImplantConfig
	93,  // 65: clientpb.Builders.Builders:type_name -> clientpb.Builder
	17,  // 66: clientpb.Builder.Targets:type_name -> clientpb.CompilerTarget
	18,  // 67: clientpb.Builder.CrossCompilers:type_name -> clientpb.CrossCompiler
	13,  // 68: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	66,  // 69: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	66,  // 70: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	83,  // 71: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	5,   // 72: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
