...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x22, 0xdc, 0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61,
	...
	0x28, 0x08, 0x52, 0x09, 0x49, 0x73, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x64, 0x12, 0x22, 0x0a,
	0x0c, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x48, 0x6f, 0x73, 0x74, 0x49, 0x44, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0c, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x48, 0x6f, 0x73, 0x74, 0x49,
	0x44, 0x22, 0x45, 0x0a, 0x03, 0x49, 0x4f, 0x43, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61, 0x74, 0x68,
	...
	0x0e, 0x43, 0x72, 0x6f, 0x73, 0x73, 0x43, 0x6f, 0x6d, 0x70, 0x69, 0x6c, 0x65, 0x72, 0x73, 0x2a,
	...
	0x12, 0x08, 0x0a, 0x04, 0x54, 0x45, 0x58, 0x54, 0x10, 0x02, 0x2a, 0xb4, 0x05, 0x0a, 0x08, 0x48,
	...
	0x35, 0x5f, 0x50, 0x57, 0x10, 0xfe, 0x1c, 0x12, 0x07, 0x0a, 0x02, 0x4c, 0x4d, 0x10, 0xb8, 0x17,
	0x12, 0x09, 0x0a, 0x04, 0x4e, 0x54, 0x4c, 0x4d, 0x10, 0xe8, 0x07, 0x12, 0x08, 0x0a, 0x03, 0x44,
	...
	0x37, 0x2a, 0x30, 0x0a, 0x10, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x64, 0x65, 0x45, 0x6e,
	...
	0x49, 0x10, 0x01, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(*IOC)(nil),                   // 74: clientpb.IOC
	(*ExtensionData)(nil),         // 75: clientpb.ExtensionData
	(*Host)(nil),                  // 76: clientpb.Host
	(*AllHosts)(nil),              // 77: clientpb.AllHosts
	(*DllHijackReq)(nil),          // 78: clientpb.DllHijackReq
	(*DllHijack)(nil),             // 79: clientpb.DllHijack
	(*ShellcodeEncodeReq)(nil),    // 80: clientpb.ShellcodeEncodeReq
	(*ShellcodeEncode)(nil),       // 81: clientpb.ShellcodeEncode
	(*ShellcodeEncoderMap)(nil),   // 82: clientpb.ShellcodeEncoderMap
	(*ExternalGenerateReq)(nil),   // 83: clientpb.ExternalGenerateReq
	(*Builders)(nil),              // 84: clientpb.Builders
	(*Builder)(nil),               // 85: clientpb.Builder
	nil,                           // 86: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 87: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 88: clientpb.Website.ContentsEntry
	nil,                           // 89: clientpb.Host.ExtensionDataEntry
	nil,                           // 90: clientpb.ShellcodeEncoderMap.EncodersEntry
	(*commonpb.File)(nil),         // 91: commonpb.File
	(*commonpb.Request)(nil),      // 92: commonpb.Request
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	91, // 5: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	86, // 6: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	92, // 15: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	93, // 16: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	92, // 17: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	93, // 18: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	91, // 21: clientpb.Generate.File:type_name -> commonpb.File
	92, // 22: clientpb.MSFReq.Request:type_name -> commonpb.Request
	92, // 23: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	91, // 26: clientpb.MsfStager.File:type_name -> commonpb.File
	12, // 27: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	92, // 28: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	92, // 31: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	92, // 32: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	92, // 33: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	87, // 42: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	88, // 43: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	68, // 44: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,  // 45: clientpb.Loot.FileType:type_name -> clientpb.FileType
	91, // 46: clientpb.Loot.File:type_name -> commonpb.File
	71, // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	3,  // 48: clientpb.Credential.HashType:type_name -> clientpb.HashType
	74, // 49: clientpb.Host.IOCs:type_name -> clientpb.IOC
	89, // 50: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	76, // 51: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	92, // 52: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	93, // 53: clientpb.DllHijack.Response:type_name -> commonpb.Response
	4,  // 54: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	92, // 55: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	93, // 56: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	90, // 57: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	12, // 58: clientpb.ExternalGenerateReq.Config:type_name -> clientpb.ImplantConfig
	85, // 59: clientpb.Builders.Builders:type_name -> clientpb.Builder
	16, // 60: clientpb.Builder.Targets:type_name -> clientpb.CompilerTarget
	17, // 61: clientpb.Builder.CrossCompilers:type_name -> clientpb.CrossCompiler
	12, // 62: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	65, // 63: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	65, // 64: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	75, // 65: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	4,  // 66: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
