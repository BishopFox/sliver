...
var file_sliverpb_sliver_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x22, 0x6b, 0x0a, 0x10, 0x50, 0x69, 0x76, 0x6f, 0x74, 0x50, 0x65, 0x65, 0x72, 0x46,
	0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x50, 0x65, 0x65, 0x72, 0x49, 0x44,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x50, 0x65, 0x65, 0x72, 0x49, 0x44, 0x12, 0x2d,
...
var file_sliverpb_sliver_proto_goTypes = []interface{}{
	...
	(*PivotServerKeyExchange)(nil),   // 102: sliverpb.PivotServerKeyExchange
	(*PivotPeer)(nil),                // 103: sliverpb.PivotPeer
	(*PivotPeerEnvelope)(nil),        // 104: sliverpb.PivotPeerEnvelope
	(*PivotPing)(nil),                // 105: sliverpb.PivotPing
	(*NetConnPivot)(nil),             // 106: sliverpb.NetConnPivot
	(*PivotPeerFailure)(nil),         // 107: sliverpb.PivotPeerFailure
	(*PivotListenersReq)(nil),        // 108: sliverpb.PivotListenersReq
	(*PivotListeners)(nil),           // 109: sliverpb.PivotListeners
	(*WGPortForwardStartReq)(nil),    // 110: sliverpb.WGPortForwardStartReq
	...
	(*WGSocks)(nil),                  // 114: sliverpb.WGSocks
	(*WGSocksStopReq)(nil),           // 115: sliverpb.WGSocksStopReq
	(*WGTCPForwardersReq)(nil),       // 116: sliverpb.WGTCPForwardersReq
	(*WGSocksServersReq)(nil),        // 117: sliverpb.WGSocksServersReq
	(*WGTCPForwarder)(nil),           // 118: sliverpb.WGTCPForwarder
	(*WGSocksServer)(nil),            // 119: sliverpb.WGSocksServer
	(*WGSocksServers)(nil),           // 120: sliverpb.WGSocksServers
	(*WGTCPForwarders)(nil),          // 121: sliverpb.WGTCPForwarders
	(*ReconnectIntervalReq)(nil),     // 122: sliverpb.ReconnectIntervalReq
	(*ReconnectInterval)(nil),        // 123: sliverpb.ReconnectInterval
	(*PollIntervalReq)(nil),          // 124: sliverpb.PollIntervalReq
	(*PollInterval)(nil),             // 125: sliverpb.PollInterval
	(*SSHCommandReq)(nil),            // 126: sliverpb.SSHCommandReq
	(*SSHCommand)(nil),               // 127: sliverpb.SSHCommand
	(*GetPrivsReq)(nil),              // 128: sliverpb.GetPrivsReq
	(*WindowsPrivilegeEntry)(nil),    // 129: sliverpb.WindowsPrivilegeEntry
	(*GetPrivs)(nil),                 // 130: sliverpb.GetPrivs
	(*RegisterExtensionReq)(nil),     // 131: sliverpb.RegisterExtensionReq
	(*RegisterExtension)(nil),        // 132: sliverpb.RegisterExtension
	(*CallExtensionReq)(nil),         // 133: sliverpb.CallExtensionReq
	(*CallExtension)(nil),            // 134: sliverpb.CallExtension
	(*ListExtensionsReq)(nil),        // 135: sliverpb.ListExtensionsReq
	(*ListExtensions)(nil),           // 136: sliverpb.ListExtensions
	(*SockTabEntry_SockAddr)(nil),    // 137: sliverpb.SockTabEntry.SockAddr
	(*commonpb.Response)(nil),        // 138: commonpb.Response
	(*commonpb.Request)(nil),         // 139: commonpb.Request
	(*commonpb.Process)(nil),         // 140: commonpb.Process
	(*commonpb.EnvVar)(nil),          // 141: commonpb.EnvVar
}
var file_sliverpb_sliver_proto_depIdxs = []int32{
	...
	138, // 2: sliverpb.OpenSession.Response:type_name -> commonpb.Response
	139, // 3: sliverpb.OpenSession.Request:type_name -> commonpb.Request
	138, // 4: sliverpb.CloseSession.Response:type_name -> commonpb.Response
	139, // 5: sliverpb.CloseSession.Request:type_name -> commonpb.Request
	138, // 6: sliverpb.Ping.Response:type_name -> commonpb.Response
	139, // 7: sliverpb.Ping.Request:type_name -> commonpb.Request
	139, // 8: sliverpb.KillReq.Request:type_name -> commonpb.Request
	139, // 9: sliverpb.PsReq.Request:type_name -> commonpb.Request
	140, // 10: sliverpb.Ps.Processes:type_name -> commonpb.Process
	138, // 11: sliverpb.Ps.Response:type_name -> commonpb.Response
	139, // 12: sliverpb.TerminateReq.Request:type_name -> commonpb.Request
	138, // 13: sliverpb.Terminate.Response:type_name -> commonpb.Response
	139, // 14: sliverpb.IfconfigReq.Request:type_name -> commonpb.Request
	16,  // 15: sliverpb.Ifconfig.NetInterfaces:type_name -> sliverpb.NetInterface
	138, // 16: sliverpb.Ifconfig.Response:type_name -> commonpb.Response
	139, // 17: sliverpb.LsReq.Request:type_name -> commonpb.Request
	19,  // 18: sliverpb.Ls.Files:type_name -> sliverpb.FileInfo
	138, // 19: sliverpb.Ls.Response:type_name -> commonpb.Response
	139, // 20: sliverpb.CdReq.Request:type_name -> commonpb.Request
	139, // 21: sliverpb.PwdReq.Request:type_name -> commonpb.Request
	138, // 22: sliverpb.Pwd.Response:type_name -> commonpb.Response
	139, // 23: sliverpb.RmReq.Request:type_name -> commonpb.Request
	138, // 24: sliverpb.Rm.Response:type_name -> commonpb.Response
	139, // 25: sliverpb.MkdirReq.Request:type_name -> commonpb.Request
	138, // 26: sliverpb.Mkdir.Response:type_name -> commonpb.Response
	139, // 27: sliverpb.DownloadReq.Request:type_name -> commonpb.Request
	138, // 28: sliverpb.Download.Response:type_name -> commonpb.Response
	139, // 29: sliverpb.UploadReq.Request:type_name -> commonpb.Request
	138, // 30: sliverpb.Upload.Response:type_name -> commonpb.Response
	139, // 31: sliverpb.ProcessDumpReq.Request:type_name -> commonpb.Request
	138, // 32: sliverpb.ProcessDump.Response:type_name -> commonpb.Response
	139, // 33: sliverpb.RunAsReq.Request:type_name -> commonpb.Request
	138, // 34: sliverpb.RunAs.Response:type_name -> commonpb.Response
	139, // 35: sliverpb.ImpersonateReq.Request:type_name -> commonpb.Request
	138, // 36: sliverpb.Impersonate.Response:type_name -> commonpb.Response
	139, // 37: sliverpb.RevToSelfReq.Request:type_name -> commonpb.Request
	138, // 38: sliverpb.RevToSelf.Response:type_name -> commonpb.Response
	139, // 39: sliverpb.InvokeGetSystemReq.Request:type_name -> commonpb.Request
	138, // 40: sliverpb.GetSystem.Response:type_name -> commonpb.Response
	139, // 41: sliverpb.MakeTokenReq.Request:type_name -> commonpb.Request
	138, // 42: sliverpb.MakeToken.Response:type_name -> commonpb.Response
	139, // 43: sliverpb.TaskReq.Request:type_name -> commonpb.Request
	138, // 44: sliverpb.Task.Response:type_name -> commonpb.Response
	139, // 45: sliverpb.ExecuteAssemblyReq.Request:type_name -> commonpb.Request
	139, // 46: sliverpb.InvokeExecuteAssemblyReq.Request:type_name -> commonpb.Request
	138, // 47: sliverpb.ExecuteAssembly.Response:type_name -> commonpb.Response
	139, // 48: sliverpb.InvokeMigrateReq.Request:type_name -> commonpb.Request
	138, // 49: sliverpb.Migrate.Response:type_name -> commonpb.Response
	139, // 50: sliverpb.ExecuteReq.Request:type_name -> commonpb.Request
	139, // 51: sliverpb.ExecuteTokenReq.Request:type_name -> commonpb.Request
	138, // 52: sliverpb.Execute.Response:type_name -> commonpb.Response
	139, // 53: sliverpb.SideloadReq.Request:type_name -> commonpb.Request
	138, // 54: sliverpb.Sideload.Response:type_name -> commonpb.Response
	139, // 55: sliverpb.InvokeSpawnDllReq.Request:type_name -> commonpb.Request
	139, // 56: sliverpb.SpawnDllReq.Request:type_name -> commonpb.Request
	138, // 57: sliverpb.SpawnDll.Response:type_name -> commonpb.Response
	139, // 58: sliverpb.NetstatReq.Request:type_name -> commonpb.Request
	137, // 59: sliverpb.SockTabEntry.LocalAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	137, // 60: sliverpb.SockTabEntry.RemoteAddr:type_name -> sliverpb.SockTabEntry.SockAddr
	140, // 61: sliverpb.SockTabEntry.Process:type_name -> commonpb.Process
	59,  // 62: sliverpb.Netstat.Entries:type_name -> sliverpb.SockTabEntry
	138, // 63: sliverpb.Netstat.Response:type_name -> commonpb.Response
	139, // 64: sliverpb.EnvReq.Request:type_name -> commonpb.Request
	141, // 65: sliverpb.EnvInfo.Variables:type_name -> commonpb.EnvVar
	138, // 66: sliverpb.EnvInfo.Response:type_name -> commonpb.Response
	141, // 67: sliverpb.SetEnvReq.Variable:type_name -> commonpb.EnvVar
	139, // 68: sliverpb.SetEnvReq.Request:type_name -> commonpb.Request
	138, // 69: sliverpb.SetEnv.Response:type_name -> commonpb.Response
	139, // 70: sliverpb.UnsetEnvReq.Request:type_name -> commonpb.Request
	138, // 71: sliverpb.UnsetEnv.Response:type_name -> commonpb.Response
	69,  // 72: sliverpb.DNSPoll.blocks:type_name -> sliverpb.DNSBlockHeader
	139, // 73: sliverpb.ScreenshotReq.Request:type_name -> commonpb.Request
	138, // 74: sliverpb.Screenshot.Response:type_name -> commonpb.Response
	139, // 75: sliverpb.StartServiceReq.Request:type_name -> commonpb.Request
	138, // 76: sliverpb.ServiceInfo.Response:type_name -> commonpb.Response
	75,  // 77: sliverpb.StopServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	139, // 78: sliverpb.StopServiceReq.Request:type_name -> commonpb.Request
	75,  // 79: sliverpb.RemoveServiceReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	139, // 80: sliverpb.RemoveServiceReq.Request:type_name -> commonpb.Request
	139, // 81: sliverpb.BackdoorReq.Request:type_name -> commonpb.Request
	138, // 82: sliverpb.Backdoor.Response:type_name -> commonpb.Response
	139, // 83: sliverpb.RegistryReadReq.Request:type_name -> commonpb.Request
	138, // 84: sliverpb.RegistryRead.Response:type_name -> commonpb.Response
	139, // 85: sliverpb.RegistryWriteReq.Request:type_name -> commonpb.Request
	138, // 86: sliverpb.RegistryWrite.Response:type_name -> commonpb.Response
	139, // 87: sliverpb.RegistryCreateKeyReq.Request:type_name -> commonpb.Request
	138, // 88: sliverpb.RegistryCreateKey.Response:type_name -> commonpb.Response
	139, // 89: sliverpb.RegistrySubKeyListReq.Request:type_name -> commonpb.Request
	138, // 90: sliverpb.RegistrySubKeyList.Response:type_name -> commonpb.Response
	139, // 91: sliverpb.RegistryListValuesReq.Request:type_name -> commonpb.Request
	138, // 92: sliverpb.RegistryValuesList.Response:type_name -> commonpb.Response
	139, // 93: sliverpb.ShellReq.Request:type_name -> commonpb.Request
	138, // 94: sliverpb.Shell.Response:type_name -> commonpb.Response
	139, // 95: sliverpb.PortfwdReq.Request:type_name -> commonpb.Request
	138, // 96: sliverpb.Portfwd.Response:type_name -> commonpb.Response
	139, // 97: sliverpb.SocksData.Request:type_name -> commonpb.Request
	0,   // 98: sliverpb.PivotStartListenerReq.Type:type_name -> sliverpb.PivotType
	139, // 99: sliverpb.PivotStartListenerReq.Request:type_name -> commonpb.Request
	139, // 100: sliverpb.PivotStopListenerReq.Request:type_name -> commonpb.Request
	0,   // 101: sliverpb.PivotListener.Type:type_name -> sliverpb.PivotType
	106, // 102: sliverpb.PivotListener.Pivots:type_name -> sliverpb.NetConnPivot
	138, // 103: sliverpb.PivotListener.Response:type_name -> commonpb.Response
	103, // 104: sliverpb.PivotPeerEnvelope.Peers:type_name -> sliverpb.PivotPeer
	1,   // 105: sliverpb.PivotPeerFailure.Type:type_name -> sliverpb.PeerFailureType
	139, // 106: sliverpb.PivotListenersReq.Request:type_name -> commonpb.Request
	100, // 107: sliverpb.PivotListeners.Listeners:type_name -> sliverpb.PivotListener
	138, // 108: sliverpb.PivotListeners.Response:type_name -> commonpb.Response
	139, // 109: sliverpb.WGPortForwardStartReq.Request:type_name -> commonpb.Request
	118, // 110: sliverpb.WGPortForward.Forwarder:type_name -> sliverpb.WGTCPForwarder
	138, // 111: sliverpb.WGPortForward.Response:type_name -> commonpb.Response
	139, // 112: sliverpb.WGPortForwardStopReq.Request:type_name -> commonpb.Request
	139, // 113: sliverpb.WGSocksStartReq.Request:type_name -> commonpb.Request
	119, // 114: sliverpb.WGSocks.Server:type_name -> sliverpb.WGSocksServer
	138, // 115: sliverpb.WGSocks.Response:type_name -> commonpb.Response
	139, // 116: sliverpb.WGSocksStopReq.Request:type_name -> commonpb.Request
	139, // 117: sliverpb.WGTCPForwardersReq.Request:type_name -> commonpb.Request
	139, // 118: sliverpb.WGSocksServersReq.Request:type_name -> commonpb.Request
	119, // 119: sliverpb.WGSocksServers.Servers:type_name -> sliverpb.WGSocksServer
	138, // 120: sliverpb.WGSocksServers.Response:type_name -> commonpb.Response
	118, // 121: sliverpb.WGTCPForwarders.Forwarders:type_name -> sliverpb.WGTCPForwarder
	138, // 122: sliverpb.WGTCPForwarders.Response:type_name -> commonpb.Response
	139, // 123: sliverpb.ReconnectIntervalReq.Request:type_name -> commonpb.Request
	138, // 124: sliverpb.ReconnectInterval.Response:type_name -> commonpb.Response
	139, // 125: sliverpb.PollIntervalReq.Request:type_name -> commonpb.Request
	138, // 126: sliverpb.PollInterval.Response:type_name -> commonpb.Response
	139, // 127: sliverpb.SSHCommandReq.Request:type_name -> commonpb.Request
	138, // 128: sliverpb.SSHCommand.Response:type_name -> commonpb.Response
	139, // 129: sliverpb.GetPrivsReq.Request:type_name -> commonpb.Request
	129, // 130: sliverpb.GetPrivs.PrivInfo:type_name -> sliverpb.WindowsPrivilegeEntry
	138, // 131: sliverpb.GetPrivs.Response:type_name -> commonpb.Response
	139, // 132: sliverpb.RegisterExtensionReq.Request:type_name -> commonpb.Request
	138, // 133: sliverpb.RegisterExtension.Response:type_name -> commonpb.Response
	139, // 134: sliverpb.CallExtensionReq.Request:type_name -> commonpb.Request
	138, // 135: sliverpb.CallExtension.Response:type_name -> commonpb.Response
	139, // 136: sliverpb.ListExtensionsReq.Request:type_name -> commonpb.Request
	138, // 137: sliverpb.ListExtensions.Response:type_name -> commonpb.Response
