...
var file_sliverpb_sliver_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x0a, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x22, 0x21, 0x0a,
	...
	0x22, 0x41, 0x0a, 0x09, 0x50, 0x69, 0x76, 0x6f, 0x74, 0x50, 0x65, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x73, 0x73, 0x22, 0x22, 0x0a, 0x10, 0x50, 0x69, 0x76, 0x6f, 0x74, 0x50, 0x65, 0x65, 0x72,
	0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x44, 0x22, 0x40, 0x0a, 0x11, 0x50, 0x69, 0x76, 0x6f, 0x74,
	...
	0x0a, 0x09, 0x4e, 0x61, 0x6d, 0x65, 0x64, 0x50, 0x69, 0x70, 0x65, 0x10, 0x02, 0x42, 0x2f, 0x5a,
...
var file_sliverpb_sliver_proto_goTypes = []interface{}{
	...
	(*PivotPing)(nil),                // 102: sliverpb.PivotPing
	(*PivotPeer)(nil),                // 103: sliverpb.PivotPeer
	(*PivotPeerFailure)(nil),         // 104: sliverpb.PivotPeerFailure
	(*PivotListenersReq)(nil),        // 105: sliverpb.PivotListenersReq
	(*PivotListeners)(nil),           // 106: sliverpb.PivotListeners
...
var file_sliverpb_sliver_proto_depIdxs = []int32{
	...
	136, // 99: sliverpb.PivotStartListenerReq.Request:type_name -> commonpb.Request
	136, // 100: sliverpb.PivotStopListenerReq.Request:type_name -> commonpb.Request
	0,   // 101: sliverpb.PivotListener.Type:type_name -> sliverpb.PivotType
	103, // 102: sliverpb.PivotListener.Pivots:type_name -> sliverpb.PivotPeer
	135, // 103: sliverpb.PivotListener.Response:type_name -> commonpb.Response
	136, // 104: sliverpb.PivotListenersReq.Request:type_name -> commonpb.Request
	99,  // 105: sliverpb.PivotListeners.Listeners:type_name -> sliverpb.PivotListener
	135, // 106: sliverpb.PivotListeners.Response:type_name -> commonpb.Response
	136, // 107: sliverpb.WGPortForwardStartReq.Request:type_name -> commonpb.Request
	115, // 108: sliverpb.WGPortForward.Forwarder:type_name -> sliverpb.WGTCPForwarder
	135, // 109: sliverpb.WGPortForward.Response:type_name -> commonpb.Response
	136, // 110: sliverpb.WGPortForwardStopReq.Request:type_name -> commonpb.Request
	136, // 111: sliverpb.WGSocksStartReq.Request:type_name -> commonpb.Request
	116, // 112: sliverpb.WGSocks.Server:type_name -> sliverpb.WGSocksServer
	135, // 113: sliverpb.WGSocks.Response:type_name -> commonpb.Response
	136, // 114: sliverpb.WGSocksStopReq.Request:type_name -> commonpb.Request
	136, // 115: sliverpb.WGTCPForwardersReq.Request:type_name -> commonpb.Request
	136, // 116: sliverpb.WGSocksServersReq.Request:type_name -> commonpb.Request
	116, // 117: sliverpb.WGSocksServers.Servers:type_name -> sliverpb.WGSocksServer
	135, // 118: sliverpb.WGSocksServers.Response:type_name -> commonpb.Response
	115, // 119: sliverpb.WGTCPForwarders.Forwarders:type_name -> sliverpb.WGTCPForwarder
	135, // 120: sliverpb.WGTCPForwarders.Response:type_name -> commonpb.Response
	136, // 121: sliverpb.ReconnectIntervalReq.Request:type_name -> commonpb.Request
	135, // 122: sliverpb.ReconnectInterval.Response:type_name -> commonpb.Response
	136, // 123: sliverpb.PollIntervalReq.Request:type_name -> commonpb.Request
	135, // 124: sliverpb.PollInterval.Response:type_name -> commonpb.Response
	136, // 125: sliverpb.SSHCommandReq.Request:type_name -> commonpb.Request
	135, // 126: sliverpb.SSHCommand.Response:type_name -> commonpb.Response
	136, // 127: sliverpb.GetPrivsReq.Request:type_name -> commonpb.Request
	126, // 128: sliverpb.GetPrivs.PrivInfo:type_name -> sliverpb.WindowsPrivilegeEntry
	135, // 129: sliverpb.GetPrivs.Response:type_name -> commonpb.Response
	136, // 130: sliverpb.RegisterExtensionReq.Request:type_name -> commonpb.Request
	135, // 131: sliverpb.RegisterExtension.Response:type_name -> commonpb.Response
	136, // 132: sliverpb.CallExtensionReq.Request:type_name -> commonpb.Request
	135, // 133: sliverpb.CallExtension.Response:type_name -> commonpb.Response
	136, // 134: sliverpb.ListExtensionsReq.Request:type_name -> commonpb.Request
	135, // 135: sliverpb.ListExtensions.Response:type_name -> commonpb.Response
