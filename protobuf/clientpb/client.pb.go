...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xdd, 0x01, 0x0a, 0x09, 0x43, 0x72, 0x61, 0x63,
	...
	0x28, 0x03, 0x52, 0x09, 0x53, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1e, 0x0a,
	0x0a, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0a, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	...
	0x2a, 0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x57, 0x41,
	0x49, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x52, 0x41, 0x43, 0x4b,
	0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x4e, 0x49, 0x54, 0x49, 0x41, 0x4c,
	0x49, 0x5a, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x2a, 0x94, 0x01, 0x0a, 0x0f, 0x43, 0x72, 0x61, 0x63,
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	5,   // 64: clientpb.CrackstationStatus.State:type_name -> clientpb.States
	95,  // 65: clientpb.CrackstationStatus.Cracking:type_name -> clientpb.CrackStatus
	96,  // 66: clientpb.CrackstationStatus.Syncing:type_name -> clientpb.CrackSyncStatus
	113, // 67: clientpb.CrackSyncStatus.Progress:type_name -> clientpb.CrackSyncStatus.ProgressEntry
	114, // 68: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	103, // 69: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	115, // 70: clientpb.Crackstation.Benchmarks:type_name -> clientpb.Crackstation.BenchmarksEntry
	100, // 71: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	102, // 72: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	101, // 73: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	6,   // 74: clientpb.CrackCommand.AttackMode:type_name -> clientpb.CrackAttackMode
	4,   // 75: clientpb.CrackCommand.HashType:type_name -> clientpb.HashType
	8,   // 76: clientpb.CrackCommand.OutfileFormat:type_name -> clientpb.CrackOutfileFormat
	7,   // 77: clientpb.CrackCommand.EncodingFrom:type_name -> clientpb.CrackEncoding
	7,   // 78: clientpb.CrackCommand.EncodingTo:type_name -> clientpb.CrackEncoding
	9,   // 79: clientpb.CrackCommand.WorkloadProfile:type_name -> clientpb.CrackWorkloadProfile
	106, // 80: clientpb.CrackFiles.Files:type_name -> clientpb.CrackFile
	10,  // 81: clientpb.CrackFile.Type:type_name -> clientpb.CrackFileType
	107, // 82: clientpb.CrackFile.Chunks:type_name -> clientpb.CrackFileChunk
	18,  // 83: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	71,  // 84: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	71,  // 85: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	80,  // 86: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 87: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
