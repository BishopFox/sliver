...
type MTLSListener struct {
	Options struct {
		...
		LPort      int    `long:"lport" short:"p" description:"listener TCP listen port" default:"8888"`
...
type WireGuardListener struct {
	Options struct {
		LPort      int  `long:"lport" short:"p" description:"UDP listen port" default:"53"`
		NPort      int  `long:"nport" short:"n" description:"Virtual tun interface listen port" default:"8888"`
		KeyPort    int  `long:"key-port" short:"x" description:"Virtual tun interface key exchange port" default:"1337"`
		Persistent bool `long:"persistent" short:"P" description:"make listener persistent across server restarts"`
...
func (w *WireGuardListener) Execute(args []string) (err error) {
	...
	lport := uint16(w.Options.LPort)
	nport := uint16(w.Options.NPort)
...
type HTTPSListener struct {
	Options struct {
		...
		LPort       int    `long:"lport" short:"p" description:"listener TCP listen port" default:"443"`
...
type HTTPListener struct {
	Options struct {
		...
		LPort      int    `long:"lport" short:"p" description:"listener TCP listen port" default:"80"`
