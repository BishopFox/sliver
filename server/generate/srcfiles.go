...
var (
	srcFiles = []string{
		...
		"3rdparty/djherbis/nio/nio.go",
		"3rdparty/djherbis/nio/nio_test.go",
		"3rdparty/djherbis/nio/sync.go",

		"3rdparty/djherbis/buffer/limio/limit.go",
		"3rdparty/djherbis/buffer/limio/limit_test.go",

		"3rdparty/djherbis/buffer/wrapio/limitwrap.go",
		"3rdparty/djherbis/buffer/wrapio/wrap.go",
		"3rdparty/djherbis/buffer/wrapio/wrapio_test.go",

		"3rdparty/djherbis/buffer/buffer.go",
		"3rdparty/djherbis/buffer/buffer_test.go",
		"3rdparty/djherbis/buffer/discard.go",
		"3rdparty/djherbis/buffer/file.go",
		"3rdparty/djherbis/buffer/list.go",
		"3rdparty/djherbis/buffer/list_at.go",
		"3rdparty/djherbis/buffer/mem.go",
		"3rdparty/djherbis/buffer/multi.go",
		"3rdparty/djherbis/buffer/partition.go",
		"3rdparty/djherbis/buffer/partition_at.go",
		"3rdparty/djherbis/buffer/pool.go",
		"3rdparty/djherbis/buffer/pool_at.go",
		"3rdparty/djherbis/buffer/ring.go",
		"3rdparty/djherbis/buffer/spill.go",
