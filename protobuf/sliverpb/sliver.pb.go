...
var file_sliverpb_sliver_proto_depIdxs = []int32{
	...
	194, // 101: sliverpb.RegistryRead.Response:type_name -> commonpb.Response
	195, // 102: sliverpb.RegistryWriteReq.Request:type_name -> commonpb.Request
	194, // 103: sliverpb.RegistryWrite.Response:type_name -> commonpb.Response
	195, // 104: sliverpb.RegistryCreateKeyReq.Request:type_name -> commonpb.Request
	194, // 105: sliverpb.RegistryCreateKey.Response:type_name -> commonpb.Response
	195, // 106: sliverpb.RegistryDeleteKeyReq.Request:type_name -> commonpb.Request
	194, // 107: sliverpb.RegistryDeleteKey.Response:type_name -> commonpb.Response
	195, // 108: sliverpb.RegistrySubKeyListReq.Request:type_name -> commonpb.Request
	194, // 109: sliverpb.RegistrySubKeyList.Response:type_name -> commonpb.Response
	195, // 110: sliverpb.RegistryListValuesReq.Request:type_name -> commonpb.Request
	194, // 111: sliverpb.RegistryValuesList.Response:type_name -> commonpb.Response
	195, // 112: sliverpb.RegistryReadHiveReq.Request:type_name -> commonpb.Request
	194, // 113: sliverpb.RegistryReadHive.Response:type_name -> commonpb.Response
	163, // 114: sliverpb.TunnelData.rportfwd:type_name -> sliverpb.RPortfwd
	195, // 115: sliverpb.ShellReq.Request:type_name -> commonpb.Request
	194, // 116: sliverpb.Shell.Response:type_name -> commonpb.Response
	195, // 117: sliverpb.ShellResizeReq.Request:type_name -> commonpb.Request
	195, // 118: sliverpb.PortfwdReq.Request:type_name -> commonpb.Request
	194, // 119: sliverpb.Portfwd.Response:type_name -> commonpb.Response
	195, // 120: sliverpb.SocksData.Request:type_name -> commonpb.Request
	2,   // 121: sliverpb.PivotStartListenerReq.Type:type_name -> sliverpb.PivotType
	195, // 122: sliverpb.PivotStartListenerReq.Request:type_name -> commonpb.Request
	195, // 123: sliverpb.PivotStopListenerReq.Request:type_name -> commonpb.Request
	2,   // 124: sliverpb.PivotListener.Type:type_name -> sliverpb.PivotType
	127, // 125: sliverpb.PivotListener.Pivots:type_name -> sliverpb.NetConnPivot
	194, // 126: sliverpb.PivotListener.Response:type_name -> commonpb.Response
	124, // 127: sliverpb.PivotPeerEnvelope.Peers:type_name -> sliverpb.PivotPeer
	3,   // 128: sliverpb.PivotPeerFailure.Type:type_name -> sliverpb.PeerFailureType
	195, // 129: sliverpb.PivotListenersReq.Request:type_name -> commonpb.Request
	121, // 130: sliverpb.PivotListeners.Listeners:type_name -> sliverpb.PivotListener
	194, // 131: sliverpb.PivotListeners.Response:type_name -> commonpb.Response
	195, // 132: sliverpb.WGPortForwardStartReq.Request:type_name -> commonpb.Request
	139, // 133: sliverpb.WGPortForward.Forwarder:type_name -> sliverpb.WGTCPForwarder
	194, // 134: sliverpb.WGPortForward.Response:type_name -> commonpb.Response
	195, // 135: sliverpb.WGPortForwardStopReq.Request:type_name -> commonpb.Request
	195, // 136: sliverpb.WGSocksStartReq.Request:type_name -> commonpb.Request
	140, // 137: sliverpb.WGSocks.Server:type_name -> sliverpb.WGSocksServer
	194, // 138: sliverpb.WGSocks.Response:type_name -> commonpb.Response
	195, // 139: sliverpb.WGSocksStopReq.Request:type_name -> commonpb.Request
	195, // 140: sliverpb.WGTCPForwardersReq.Request:type_name -> commonpb.Request
	195, // 141: sliverpb.WGSocksServersReq.Request:type_name -> commonpb.Request
	140, // 142: sliverpb.WGSocksServers.Servers:type_name -> sliverpb.WGSocksServer
	194, // 143: sliverpb.WGSocksServers.Response:type_name -> commonpb.Response
	139, // 144: sliverpb.WGTCPForwarders.Forwarders:type_name -> sliverpb.WGTCPForwarder
	194, // 145: sliverpb.WGTCPForwarders.Response:type_name -> commonpb.Response
	195, // 146: sliverpb.ReconfigureReq.Request:type_name -> commonpb.Request
	194, // 147: sliverpb.Reconfigure.Response:type_name -> commonpb.Response
	195, // 148: sliverpb.PollIntervalReq.Request:type_name -> commonpb.Request
	194, // 149: sliverpb.PollInterval.Response:type_name -> commonpb.Response
	195, // 150: sliverpb.SSHCommandReq.Request:type_name -> commonpb.Request
	194, // 151: sliverpb.SSHCommand.Response:type_name -> commonpb.Response
	195, // 152: sliverpb.GetPrivsReq.Request:type_name -> commonpb.Request
	150, // 153: sliverpb.GetPrivs.PrivInfo:type_name -> sliverpb.WindowsPrivilegeEntry
	194, // 154: sliverpb.GetPrivs.Response:type_name -> commonpb.Response
	195, // 155: sliverpb.RegisterExtensionReq.Request:type_name -> commonpb.Request
	194, // 156: sliverpb.RegisterExtension.Response:type_name -> commonpb.Response
	195, // 157: sliverpb.CallExtensionReq.Request:type_name -> commonpb.Request
	189, // 158: sliverpb.CallExtension.BOFOutputs:type_name -> sliverpb.BOFOutput
	194, // 159: sliverpb.CallExtension.Response:type_name -> commonpb.Response
	195, // 160: sliverpb.ListExtensionsReq.Request:type_name -> commonpb.Request
	194, // 161: sliverpb.ListExtensions.Response:type_name -> commonpb.Response
	195, // 162: sliverpb.RportFwdStopListenerReq.Request:type_name -> commonpb.Request
	195, // 163: sliverpb.RportFwdStartListenerReq.Request:type_name -> commonpb.Request
	194, // 164: sliverpb.RportFwdListener.Response:type_name -> commonpb.Response
	160, // 165: sliverpb.RportFwdListeners.Listeners:type_name -> sliverpb.RportFwdListener
	194, // 166: sliverpb.RportFwdListeners.Response:type_name -> commonpb.Response
	195, // 167: sliverpb.RportFwdListenersReq.Request:type_name -> commonpb.Request
	194, // 168: sliverpb.RPortfwd.Response:type_name -> commonpb.Response
	195, // 169: sliverpb.RPortfwdReq.Request:type_name -> commonpb.Request
	195, // 170: sliverpb.ChmodReq.Request:type_name -> commonpb.Request
	194, // 171: sliverpb.Chmod.Response:type_name -> commonpb.Response
	195, // 172: sliverpb.ChownReq.Request:type_name -> commonpb.Request
	194, // 173: sliverpb.Chown.Response:type_name -> commonpb.Response
	195, // 174: sliverpb.ChtimesReq.Request:type_name -> commonpb.Request
	194, // 175: sliverpb.Chtimes.Response:type_name -> commonpb.Response
	195, // 176: sliverpb.MemfilesListReq.Request:type_name -> commonpb.Request
	195, // 177: sliverpb.MemfilesAddReq.Request:type_name -> commonpb.Request
	194, // 178: sliverpb.MemfilesAdd.Response:type_name -> commonpb.Response
	195, // 179: sliverpb.MemfilesRmReq.Request:type_name -> commonpb.Request
	194, // 180: sliverpb.MemfilesRm.Response:type_name -> commonpb.Response
	195, // 181: sliverpb.RegisterWasmExtensionReq.Request:type_name -> commonpb.Request
	194, // 182: sliverpb.RegisterWasmExtension.Response:type_name -> commonpb.Response
	195, // 183: sliverpb.DeregisterWasmExtensionReq.Request:type_name -> commonpb.Request
	195, // 184: sliverpb.ListWasmExtensionsReq.Request:type_name -> commonpb.Request
	194, // 185: sliverpb.ListWasmExtensions.Response:type_name -> commonpb.Response
	193, // 186: sliverpb.ExecWasmExtensionReq.MemFS:type_name -> sliverpb.ExecWasmExtensionReq.MemFSEntry
	195, // 187: sliverpb.ExecWasmExtensionReq.Request:type_name -> commonpb.Request
	194, // 188: sliverpb.ExecWasmExtension.Response:type_name -> commonpb.Response
	195, // 189: sliverpb.ServicesReq.Request:type_name -> commonpb.Request
	93,  // 190: sliverpb.ServiceDetailReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	195, // 191: sliverpb.ServiceDetailReq.Request:type_name -> commonpb.Request
	185, // 192: sliverpb.Services.Details:type_name -> sliverpb.ServiceDetails
	194, // 193: sliverpb.Services.Response:type_name -> commonpb.Response
	185, // 194: sliverpb.ServiceDetail.Detail:type_name -> sliverpb.ServiceDetails
	194, // 195: sliverpb.ServiceDetail.Response:type_name -> commonpb.Response
	93,  // 196: sliverpb.StartServiceByNameReq.ServiceInfo:type_name -> sliverpb.ServiceInfoReq
	195, // 197: sliverpb.StartServiceByNameReq.Request:type_name -> commonpb.Request
	41,  // 198: sliverpb.Grep.ResultsEntry.value:type_name -> sliverpb.GrepResultsForFile
