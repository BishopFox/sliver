...
const (
	CrackTaskKind_CRACK_TASK_UNSPECIFIED CrackTaskKind = 0
...
var (
	CrackTaskKind_name = map[int32]string{
		0: "CRACK_TASK_UNSPECIFIED",
		1: "CRACK_TASK_CRACK",
...
func (x CrackTaskKind) Enum() *CrackTaskKind {
	p := new(CrackTaskKind)
	*p = x
	return p
}

func (x CrackTaskKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CrackTaskKind) Descriptor() protoreflect.EnumDescriptor {
	return file_clientpb_client_proto_enumTypes[8].Descriptor()
}

func (CrackTaskKind) Type() protoreflect.EnumType {
	return &file_clientpb_client_proto_enumTypes[8]
}

func (x CrackTaskKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CrackTaskKind.Descriptor instead.
func (CrackTaskKind) EnumDescriptor() ([]byte, []int) {
...
const (
	CrackTaskState_CRACK_TASK_QUEUED    CrackTaskState = 0
	CrackTaskState_CRACK_TASK_LEASED    CrackTaskState = 1
	CrackTaskState_CRACK_TASK_RUNNING   CrackTaskState = 2
	CrackTaskState_CRACK_TASK_COMPLETED CrackTaskState = 3
	CrackTaskState_CRACK_TASK_FAILED    CrackTaskState = 4
	CrackTaskState_CRACK_TASK_CANCELLED CrackTaskState = 5
)

// Enum value maps for CrackTaskState.
var (
	CrackTaskState_name = map[int32]string{
		0: "CRACK_TASK_QUEUED",
		1: "CRACK_TASK_LEASED",
		2: "CRACK_TASK_RUNNING",
		3: "CRACK_TASK_COMPLETED",
		4: "CRACK_TASK_FAILED",
		5: "CRACK_TASK_CANCELLED",
	}
	CrackTaskState_value = map[string]int32{
		"CRACK_TASK_QUEUED":    0,
		"CRACK_TASK_LEASED":    1,
		"CRACK_TASK_RUNNING":   2,
		"CRACK_TASK_COMPLETED": 3,
		"CRACK_TASK_FAILED":    4,
		"CRACK_TASK_CANCELLED": 5,
	}
)

func (x CrackTaskState) Enum() *CrackTaskState {
	p := new(CrackTaskState)
	*p = x
	return p
}

func (x CrackTaskState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CrackTaskState) Descriptor() protoreflect.EnumDescriptor {
	return file_clientpb_client_proto_enumTypes[9].Descriptor()
}

func (CrackTaskState) Type() protoreflect.EnumType {
	return &file_clientpb_client_proto_enumTypes[9]
}

func (x CrackTaskState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CrackTaskState.Descriptor instead.
func (CrackTaskState) EnumDescriptor() ([]byte, []int) {
...
func (AIConversationMessageState) Descriptor() protoreflect.EnumDescriptor {
	return file_clientpb_client_proto_enumTypes[18].Descriptor()
}

func (AIConversationMessageState) Type() protoreflect.EnumType {
	return &file_clientpb_client_proto_enumTypes[18]
}
...
func (AIConversationEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_clientpb_client_proto_enumTypes[19].Descriptor()
}

func (AIConversationEventType) Type() protoreflect.EnumType {
	return &file_clientpb_client_proto_enumTypes[19]
}
...
func (x *CrackBenchmark) GetSchemaVersion() uint32 {
	if x != nil {
...
func (x *CrackBenchmark) GetHashcatVersion() string {
	if x != nil {
...
type CrackTask struct {
	...
	StdoutTruncated  bool                   `protobuf:"varint,12,opt,name=StdoutTruncated,proto3" json:"StdoutTruncated,omitempty"`
	StderrTruncated  bool                   `protobuf:"varint,13,opt,name=StderrTruncated,proto3" json:"StderrTruncated,omitempty"`
	StdoutTotalBytes uint64                 `protobuf:"varint,14,opt,name=StdoutTotalBytes,proto3" json:"StdoutTotalBytes,omitempty"`
	StderrTotalBytes uint64                 `protobuf:"varint,15,opt,name=StderrTotalBytes,proto3" json:"StderrTotalBytes,omitempty"`
	CrackJobID       string                 `protobuf:"bytes,16,opt,name=CrackJobID,proto3" json:"CrackJobID,omitempty"`
	Kind             CrackTaskKind          `protobuf:"varint,17,opt,name=Kind,proto3,enum=clientpb.CrackTaskKind" json:"Kind,omitempty"`
	State            CrackTaskState         `protobuf:"varint,18,opt,name=State,proto3,enum=clientpb.CrackTaskState" json:"State,omitempty"`
	Attempt          uint32                 `protobuf:"varint,19,opt,name=Attempt,proto3" json:"Attempt,omitempty"`
	LeaseToken       string                 `protobuf:"bytes,20,opt,name=LeaseToken,proto3" json:"LeaseToken,omitempty"`
	LeaseExpiresAt   int64                  `protobuf:"varint,21,opt,name=LeaseExpiresAt,proto3" json:"LeaseExpiresAt,omitempty"`
	UpdatedAt        int64                  `protobuf:"varint,22,opt,name=UpdatedAt,proto3" json:"UpdatedAt,omitempty"`
	LastHeartbeatAt  int64                  `protobuf:"varint,23,opt,name=LastHeartbeatAt,proto3" json:"LastHeartbeatAt,omitempty"`
	Keyspace         string                 `protobuf:"bytes,24,opt,name=Keyspace,proto3" json:"Keyspace,omitempty"`
	LatestStatusJSON []byte                 `protobuf:"bytes,25,opt,name=LatestStatusJSON,proto3" json:"LatestStatusJSON,omitempty"`
	RecoveredJSON    []byte                 `protobuf:"bytes,26,opt,name=RecoveredJSON,proto3" json:"RecoveredJSON,omitempty"`
	ShardSkip        uint64                 `protobuf:"varint,27,opt,name=ShardSkip,proto3" json:"ShardSkip,omitempty"`
	ShardLimit       uint64                 `protobuf:"varint,28,opt,name=ShardLimit,proto3" json:"ShardLimit,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CrackTask) GetStdout() []byte {
	if x != nil {
		return x.Stdout
	}
	return nil
...
func (x *CrackTask) GetStderr() []byte {
	if x != nil {
		return x.Stderr
	}
	return nil
...
func (x *CrackTask) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *CrackTask) GetStdoutTruncated() bool {
	if x != nil {
...
func (x *CrackTask) GetStderrTruncated() bool {
	if x != nil {
...
func (x *CrackTask) GetStdoutTotalBytes() uint64 {
	if x != nil {
...
func (x *CrackTask) GetStderrTotalBytes() uint64 {
	if x != nil {
...
func (x *CrackTask) GetCrackJobID() string {
	if x != nil {
		return x.CrackJobID
	}
	return ""
...
func (x *CrackTask) GetKind() CrackTaskKind {
	if x != nil {
		return x.Kind
	}
...
func (x *CrackTask) GetState() CrackTaskState {
	if x != nil {
		return x.State
	}
...
func (x *CrackTask) GetAttempt() uint32 {
	if x != nil {
		return x.Attempt
	}
	return 0
...
func (x *CrackTask) GetLeaseToken() string {
	if x != nil {
		return x.LeaseToken
	}
	return ""
...
func (x *CrackTask) GetLeaseExpiresAt() int64 {
	if x != nil {
...
func (x *CrackTask) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *CrackTask) GetLastHeartbeatAt() int64 {
	if x != nil {
...
func (x *CrackTask) GetKeyspace() string {
	if x != nil {
		return x.Keyspace
	}
	return ""
...
func (x *CrackTask) GetLatestStatusJSON() []byte {
	if x != nil {
		return x.LatestStatusJSON
	}
	return nil
}

func (x *CrackTask) GetRecoveredJSON() []byte {
	if x != nil {
		return x.RecoveredJSON
	}
	return nil
}

func (x *CrackTask) GetShardSkip() uint64 {
	if x != nil {
		return x.ShardSkip
	}
	return 0
...
func (x *CrackTask) GetShardLimit() uint64 {
	if x != nil {
		return x.ShardLimit
	}
	return 0
...
type Crackstation struct {
	...
	Status         *CrackstationStatus    `protobuf:"bytes,10,opt,name=Status,proto3" json:"Status,omitempty"`
...
func (x *Crackstation) GetStatus() *CrackstationStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
type CUDABackendInfo struct {
	...
	BackendDeviceID     uint32                 `protobuf:"varint,11,opt,name=BackendDeviceID,proto3" json:"BackendDeviceID,omitempty"`
	BackendDeviceAlias  *uint32                `protobuf:"varint,12,opt,name=BackendDeviceAlias,proto3,oneof" json:"BackendDeviceAlias,omitempty"`
	PreferredThreadSize *uint32                `protobuf:"varint,13,opt,name=PreferredThreadSize,proto3,oneof" json:"PreferredThreadSize,omitempty"`
	MemoryUnified       *bool                  `protobuf:"varint,14,opt,name=MemoryUnified,proto3,oneof" json:"MemoryUnified,omitempty"`
	LocalMemory         string                 `protobuf:"bytes,15,opt,name=LocalMemory,proto3" json:"LocalMemory,omitempty"`
	CacheSize           string                 `protobuf:"bytes,16,opt,name=CacheSize,proto3" json:"CacheSize,omitempty"`
	PCIAddress          string                 `protobuf:"bytes,17,opt,name=PCIAddress,proto3" json:"PCIAddress,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CUDABackendInfo) GetBackendDeviceID() uint32 {
	if x != nil {
		return x.BackendDeviceID
	}
	return 0
}

func (x *CUDABackendInfo) GetBackendDeviceAlias() uint32 {
	if x != nil && x.BackendDeviceAlias != nil {
		return *x.BackendDeviceAlias
	}
	return 0
}

func (x *CUDABackendInfo) GetPreferredThreadSize() uint32 {
	if x != nil && x.PreferredThreadSize != nil {
		return *x.PreferredThreadSize
	}
	return 0
}

func (x *CUDABackendInfo) GetMemoryUnified() bool {
	if x != nil && x.MemoryUnified != nil {
		return *x.MemoryUnified
	}
	return false
}

func (x *CUDABackendInfo) GetLocalMemory() string {
	if x != nil {
...
func (x *CUDABackendInfo) GetCacheSize() string {
	if x != nil {
		return x.CacheSize
	}
	return ""
...
func (x *CUDABackendInfo) GetPCIAddress() string {
	if x != nil {
		return x.PCIAddress
	}
	return ""
...
type OpenCLBackendInfo struct {
	...
	BackendDeviceID     uint32                 `protobuf:"varint,12,opt,name=BackendDeviceID,proto3" json:"BackendDeviceID,omitempty"`
	BackendDeviceAlias  *uint32                `protobuf:"varint,13,opt,name=BackendDeviceAlias,proto3,oneof" json:"BackendDeviceAlias,omitempty"`
	PreferredThreadSize *uint32                `protobuf:"varint,14,opt,name=PreferredThreadSize,proto3,oneof" json:"PreferredThreadSize,omitempty"`
	MemoryUnified       *bool                  `protobuf:"varint,15,opt,name=MemoryUnified,proto3,oneof" json:"MemoryUnified,omitempty"`
	LocalMemory         string                 `protobuf:"bytes,16,opt,name=LocalMemory,proto3" json:"LocalMemory,omitempty"`
	MemoryAllocPerBlock string                 `protobuf:"bytes,17,opt,name=MemoryAllocPerBlock,proto3" json:"MemoryAllocPerBlock,omitempty"`
	PCIAddress          string                 `protobuf:"bytes,18,opt,name=PCIAddress,proto3" json:"PCIAddress,omitempty"`
	PlatformID          uint32                 `protobuf:"varint,19,opt,name=PlatformID,proto3" json:"PlatformID,omitempty"`
	PlatformVendor      string                 `protobuf:"bytes,20,opt,name=PlatformVendor,proto3" json:"PlatformVendor,omitempty"`
	PlatformName        string                 `protobuf:"bytes,21,opt,name=PlatformName,proto3" json:"PlatformName,omitempty"`
	PlatformVersion     string                 `protobuf:"bytes,22,opt,name=PlatformVersion,proto3" json:"PlatformVersion,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *OpenCLBackendInfo) GetBackendDeviceID() uint32 {
	if x != nil {
		return x.BackendDeviceID
	}
	return 0
...
func (x *OpenCLBackendInfo) GetBackendDeviceAlias() uint32 {
	if x != nil && x.BackendDeviceAlias != nil {
		return *x.BackendDeviceAlias
	}
	return 0
...
func (x *OpenCLBackendInfo) GetPreferredThreadSize() uint32 {
	if x != nil && x.PreferredThreadSize != nil {
		return *x.PreferredThreadSize
	}
	return 0
...
func (x *OpenCLBackendInfo) GetMemoryUnified() bool {
	if x != nil && x.MemoryUnified != nil {
		return *x.MemoryUnified
	}
	return false
...
func (x *OpenCLBackendInfo) GetLocalMemory() string {
	if x != nil {
		return x.LocalMemory
	}
	return ""
...
func (x *OpenCLBackendInfo) GetMemoryAllocPerBlock() string {
	if x != nil {
		return x.MemoryAllocPerBlock
	}
	return ""
}

func (x *OpenCLBackendInfo) GetPCIAddress() string {
	if x != nil {
		return x.PCIAddress
	}
	return ""
...
func (x *OpenCLBackendInfo) GetPlatformID() uint32 {
	if x != nil {
		return x.PlatformID
	}
	return 0
...
func (x *OpenCLBackendInfo) GetPlatformVendor() string {
	if x != nil {
		return x.PlatformVendor
	}
	return ""
}

func (x *OpenCLBackendInfo) GetPlatformName() string {
	if x != nil {
...
func (x *OpenCLBackendInfo) GetPlatformVersion() string {
	if x != nil {
...
type MetalBackendInfo struct {
	...
	CacheSize           string                 `protobuf:"bytes,16,opt,name=CacheSize,proto3" json:"CacheSize,omitempty"`
	MemoryAllocPerBlock string                 `protobuf:"bytes,17,opt,name=MemoryAllocPerBlock,proto3" json:"MemoryAllocPerBlock,omitempty"`
	PhysicalLocation    string                 `protobuf:"bytes,18,opt,name=PhysicalLocation,proto3" json:"PhysicalLocation,omitempty"`
	RegistryID          *uint32                `protobuf:"varint,19,opt,name=RegistryID,proto3,oneof" json:"RegistryID,omitempty"`
	MaxTXRate           string                 `protobuf:"bytes,20,opt,name=MaxTXRate,proto3" json:"MaxTXRate,omitempty"`
	GPUHeadless         *bool                  `protobuf:"varint,21,opt,name=GPUHeadless,proto3,oneof" json:"GPUHeadless,omitempty"`
	GPULowPower         *bool                  `protobuf:"varint,22,opt,name=GPULowPower,proto3,oneof" json:"GPULowPower,omitempty"`
	GPURemovable        *bool                  `protobuf:"varint,23,opt,name=GPURemovable,proto3,oneof" json:"GPURemovable,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *MetalBackendInfo) GetBackendDeviceID() uint32 {
	if x != nil {
		return x.BackendDeviceID
	}
	return 0
...
func (x *MetalBackendInfo) GetBackendDeviceAlias() uint32 {
	if x != nil && x.BackendDeviceAlias != nil {
		return *x.BackendDeviceAlias
	}
	return 0
...
func (x *MetalBackendInfo) GetPreferredThreadSize() uint32 {
	if x != nil && x.PreferredThreadSize != nil {
		return *x.PreferredThreadSize
	}
	return 0
...
func (x *MetalBackendInfo) GetMemoryUnified() bool {
	if x != nil && x.MemoryUnified != nil {
		return *x.MemoryUnified
	}
	return false
...
func (x *MetalBackendInfo) GetLocalMemory() string {
	if x != nil {
		return x.LocalMemory
	}
	return ""
...
func (x *MetalBackendInfo) GetCacheSize() string {
	if x != nil {
		return x.CacheSize
	}
	return ""
...
func (x *MetalBackendInfo) GetMemoryAllocPerBlock() string {
	if x != nil {
		return x.MemoryAllocPerBlock
	}
	return ""
...
func (x *MetalBackendInfo) GetPhysicalLocation() string {
	if x != nil {
...
func (x *MetalBackendInfo) GetRegistryID() uint32 {
...
func (x *MetalBackendInfo) GetMaxTXRate() string {
	if x != nil {
		return x.MaxTXRate
	}
	return ""
...
func (x *MetalBackendInfo) GetGPUHeadless() bool {
	if x != nil && x.GPUHeadless != nil {
		return *x.GPUHeadless
	}
	return false
}

func (x *MetalBackendInfo) GetGPULowPower() bool {
	if x != nil && x.GPULowPower != nil {
		return *x.GPULowPower
	}
	return false
}

func (x *MetalBackendInfo) GetGPURemovable() bool {
	if x != nil && x.GPURemovable != nil {
		return *x.GPURemovable
	}
	return false
}
...
type HIPBackendInfo struct {
	...
	MemoryTotal         string                 `protobuf:"bytes,8,opt,name=MemoryTotal,proto3" json:"MemoryTotal,omitempty"`
	MemoryFree          string                 `protobuf:"bytes,9,opt,name=MemoryFree,proto3" json:"MemoryFree,omitempty"`
	HIPVersion          string                 `protobuf:"bytes,10,opt,name=HIPVersion,proto3" json:"HIPVersion,omitempty"`
	BackendDeviceID     uint32                 `protobuf:"varint,11,opt,name=BackendDeviceID,proto3" json:"BackendDeviceID,omitempty"`
	BackendDeviceAlias  *uint32                `protobuf:"varint,12,opt,name=BackendDeviceAlias,proto3,oneof" json:"BackendDeviceAlias,omitempty"`
	PreferredThreadSize *uint32                `protobuf:"varint,13,opt,name=PreferredThreadSize,proto3,oneof" json:"PreferredThreadSize,omitempty"`
	MemoryUnified       *bool                  `protobuf:"varint,14,opt,name=MemoryUnified,proto3,oneof" json:"MemoryUnified,omitempty"`
...
func (x *HIPBackendInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HIPBackendInfo) ProtoMessage() {}

func (x *HIPBackendInfo) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[119]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HIPBackendInfo.ProtoReflect.Descriptor instead.
func (*HIPBackendInfo) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{119}
}

func (x *HIPBackendInfo) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *HIPBackendInfo) GetVendorID() int32 {
	if x != nil {
		return x.VendorID
	}
	return 0
...
func (x *HIPBackendInfo) GetVendor() string {
	if x != nil {
		return x.Vendor
	}
	return ""
...
func (x *HIPBackendInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *HIPBackendInfo) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *HIPBackendInfo) GetProcessors() int32 {
	if x != nil {
		return x.Processors
	}
	return 0
...
func (x *HIPBackendInfo) GetClock() int32 {
	if x != nil {
		return x.Clock
	}
	return 0
...
func (x *HIPBackendInfo) GetMemoryTotal() string {
	if x != nil {
		return x.MemoryTotal
	}
	return ""
...
func (x *HIPBackendInfo) GetMemoryFree() string {
	if x != nil {
		return x.MemoryFree
	}
	return ""
...
func (x *HIPBackendInfo) GetHIPVersion() string {
	if x != nil {
		return x.HIPVersion
	}
	return ""
...
func (x *HIPBackendInfo) GetBackendDeviceID() uint32 {
	if x != nil {
		return x.BackendDeviceID
	}
	return 0
...
func (x *HIPBackendInfo) GetBackendDeviceAlias() uint32 {
	if x != nil && x.BackendDeviceAlias != nil {
		return *x.BackendDeviceAlias
	}
	return 0
...
func (x *HIPBackendInfo) GetPreferredThreadSize() uint32 {
	if x != nil && x.PreferredThreadSize != nil {
		return *x.PreferredThreadSize
	}
	return 0
...
func (x *HIPBackendInfo) GetMemoryUnified() bool {
	if x != nil && x.MemoryUnified != nil {
		return *x.MemoryUnified
	}
	return false
...
func (x *HIPBackendInfo) GetLocalMemory() string {
	if x != nil {
		return x.LocalMemory
	}
	return ""
...
func (x *HIPBackendInfo) GetCacheSize() string {
	if x != nil {
		return x.CacheSize
	}
	return ""
...
func (x *HIPBackendInfo) GetPCIAddress() string {
	if x != nil {
		return x.PCIAddress
	}
	return ""
...
// Path-valued CrackCommand fields are interpreted on the trusted
// crackstation host, not on the client or server. Absolute paths can access
// files outside Hashcat's workspace and therefore require trusted operators.
type CrackCommand struct {
	...
	// Deprecated: historical resume behavior. RestorePosition is the canonical
	// v7 resume field; RestoreShowCommand is the v7 display-and-stop operation.
	//
	// Deprecated: Marked as deprecated in clientpb/client.proto.
	...
	Outfile                string               `protobuf:"bytes,28,opt,name=Outfile,proto3" json:"Outfile,omitempty"`
	...
	DebugFile              string               `protobuf:"bytes,45,opt,name=DebugFile,proto3" json:"DebugFile,omitempty"`
	InductionDir           string               `protobuf:"bytes,46,opt,name=InductionDir,proto3" json:"InductionDir,omitempty"`
	OutfileCheckDir        string               `protobuf:"bytes,47,opt,name=OutfileCheckDir,proto3" json:"OutfileCheckDir,omitempty"`
	...
	TruecryptKeyfiles      string               `protobuf:"bytes,52,opt,name=TruecryptKeyfiles,proto3" json:"TruecryptKeyfiles,omitempty"`
	VeracryptKeyfiles      string               `protobuf:"bytes,53,opt,name=VeracryptKeyfiles,proto3" json:"VeracryptKeyfiles,omitempty"`
	VeracryptPimStart      *uint32              `protobuf:"varint,54,opt,name=VeracryptPimStart,proto3,oneof" json:"VeracryptPimStart,omitempty"`
	VeracryptPimStop       *uint32              `protobuf:"varint,55,opt,name=VeracryptPimStop,proto3,oneof" json:"VeracryptPimStop,omitempty"`
	...
	RuleLeft             string               `protobuf:"bytes,88,opt,name=RuleLeft,proto3" json:"RuleLeft,omitempty"`
	RuleRight            string               `protobuf:"bytes,89,opt,name=RuleRight,proto3" json:"RuleRight,omitempty"`
	...
	// Deprecated: Identify is a legacy positional operand, not Hashcat's
	// --identify switch. Use IdentifyMode or PositionalArguments.
	...
	PipelineStats             bool     `protobuf:"varint,114,opt,name=PipelineStats,proto3" json:"PipelineStats,omitempty"`
	TaskTimeBreakdown         bool     `protobuf:"varint,115,opt,name=TaskTimeBreakdown,proto3" json:"TaskTimeBreakdown,omitempty"`
	MetalCompilerRuntime      uint32   `protobuf:"varint,116,opt,name=MetalCompilerRuntime,proto3" json:"MetalCompilerRuntime,omitempty"`
	RestorePosition           bool     `protobuf:"varint,117,opt,name=RestorePosition,proto3" json:"RestorePosition,omitempty"` // Resume from the stored restore position.
	OutfileJSON               bool     `protobuf:"varint,118,opt,name=OutfileJSON,proto3" json:"OutfileJSON,omitempty"`
	DynamicX                  bool     `protobuf:"varint,119,opt,name=DynamicX,proto3" json:"DynamicX,omitempty"`
	SeekDBPath                string   `protobuf:"bytes,120,opt,name=SeekDBPath,proto3" json:"SeekDBPath,omitempty"`
	BenchmarkMin              uint32   `protobuf:"varint,121,opt,name=BenchmarkMin,proto3" json:"BenchmarkMin,omitempty"`
	BenchmarkMax              *uint32  `protobuf:"varint,122,opt,name=BenchmarkMax,proto3,oneof" json:"BenchmarkMax,omitempty"`
	BridgeParameter1          string   `protobuf:"bytes,123,opt,name=BridgeParameter1,proto3" json:"BridgeParameter1,omitempty"`
	BridgeParameter2          string   `protobuf:"bytes,124,opt,name=BridgeParameter2,proto3" json:"BridgeParameter2,omitempty"`
	BridgeParameter3          string   `protobuf:"bytes,125,opt,name=BridgeParameter3,proto3" json:"BridgeParameter3,omitempty"`
	BridgeParameter4          string   `protobuf:"bytes,126,opt,name=BridgeParameter4,proto3" json:"BridgeParameter4,omitempty"`
	BackendDevicesVirtMulti   uint32   `protobuf:"varint,127,opt,name=BackendDevicesVirtMulti,proto3" json:"BackendDevicesVirtMulti,omitempty"`
	BackendDevicesVirtHost    uint32   `protobuf:"varint,128,opt,name=BackendDevicesVirtHost,proto3" json:"BackendDevicesVirtHost,omitempty"`
	TotalCandidates           bool     `protobuf:"varint,129,opt,name=TotalCandidates,proto3" json:"TotalCandidates,omitempty"`
	Lookup                    string   `protobuf:"bytes,130,opt,name=Lookup,proto3" json:"Lookup,omitempty"`
	CustomCharset5            string   `protobuf:"bytes,131,opt,name=CustomCharset5,proto3" json:"CustomCharset5,omitempty"`
	CustomCharset6            string   `protobuf:"bytes,132,opt,name=CustomCharset6,proto3" json:"CustomCharset6,omitempty"`
	CustomCharset7            string   `protobuf:"bytes,133,opt,name=CustomCharset7,proto3" json:"CustomCharset7,omitempty"`
	CustomCharset8            string   `protobuf:"bytes,134,opt,name=CustomCharset8,proto3" json:"CustomCharset8,omitempty"`
	IncrementInverse          bool     `protobuf:"varint,135,opt,name=IncrementInverse,proto3" json:"IncrementInverse,omitempty"`
	BypassDelay               *uint32  `protobuf:"varint,136,opt,name=BypassDelay,proto3,oneof" json:"BypassDelay,omitempty"`
	BypassThreshold           *uint32  `protobuf:"varint,137,opt,name=BypassThreshold,proto3,oneof" json:"BypassThreshold,omitempty"`
	BrainFeed                 bool     `protobuf:"varint,138,opt,name=BrainFeed,proto3" json:"BrainFeed,omitempty"`
	ColorCracked              bool     `protobuf:"varint,139,opt,name=ColorCracked,proto3" json:"ColorCracked,omitempty"`
	HashCopy                  bool     `protobuf:"varint,140,opt,name=HashCopy,proto3" json:"HashCopy,omitempty"`
	EncryptWithPubkey         string   `protobuf:"bytes,141,opt,name=EncryptWithPubkey,proto3" json:"EncryptWithPubkey,omitempty"`
	IdentifyMode              bool     `protobuf:"varint,142,opt,name=IdentifyMode,proto3" json:"IdentifyMode,omitempty"`
	PositionalArguments       []string `protobuf:"bytes,143,rep,name=PositionalArguments,proto3" json:"PositionalArguments,omitempty"`
	EncodingFromName          string   `protobuf:"bytes,144,opt,name=EncodingFromName,proto3" json:"EncodingFromName,omitempty"`
	EncodingToName            string   `protobuf:"bytes,145,opt,name=EncodingToName,proto3" json:"EncodingToName,omitempty"`
	HashInfoLevel             uint32   `protobuf:"varint,146,opt,name=HashInfoLevel,proto3" json:"HashInfoLevel,omitempty"`
	BackendInfoLevel          uint32   `protobuf:"varint,147,opt,name=BackendInfoLevel,proto3" json:"BackendInfoLevel,omitempty"`
	HccapxMessagePairV7       *uint32  `protobuf:"varint,148,opt,name=HccapxMessagePairV7,proto3,oneof" json:"HccapxMessagePairV7,omitempty"`
	NonceErrorCorrectionsV7   *uint32  `protobuf:"varint,149,opt,name=NonceErrorCorrectionsV7,proto3,oneof" json:"NonceErrorCorrectionsV7,omitempty"`
	ScryptTMTOV7              *uint32  `protobuf:"varint,150,opt,name=ScryptTMTOV7,proto3,oneof" json:"ScryptTMTOV7,omitempty"`
	GenerateRulesSeedV7       *uint32  `protobuf:"varint,151,opt,name=GenerateRulesSeedV7,proto3,oneof" json:"GenerateRulesSeedV7,omitempty"`
	BrainClientFeaturesV7     uint32   `protobuf:"varint,152,opt,name=BrainClientFeaturesV7,proto3" json:"BrainClientFeaturesV7,omitempty"`
	BrainSessionV7            *uint32  `protobuf:"varint,153,opt,name=BrainSessionV7,proto3,oneof" json:"BrainSessionV7,omitempty"`
	BrainSessionWhitelistV7   []uint32 `protobuf:"varint,154,rep,packed,name=BrainSessionWhitelistV7,proto3" json:"BrainSessionWhitelistV7,omitempty"`
	Stdin                     []byte   `protobuf:"bytes,155,opt,name=Stdin,proto3" json:"Stdin,omitempty"`
	AdviceDisable             bool     `protobuf:"varint,156,opt,name=AdviceDisable,proto3" json:"AdviceDisable,omitempty"`
	HashMode                  *uint32  `protobuf:"varint,157,opt,name=HashMode,proto3,oneof" json:"HashMode,omitempty"`                       // Canonical Hashcat mode; takes precedence over HashType.
	RestoreShowCommand        bool     `protobuf:"varint,158,opt,name=RestoreShowCommand,proto3" json:"RestoreShowCommand,omitempty"`         // Display the stored command and stop.
	BrainServerTimerV7        *uint32  `protobuf:"varint,159,opt,name=BrainServerTimerV7,proto3,oneof" json:"BrainServerTimerV7,omitempty"`   // Explicit zero disables intermediate dumps.
	StatusTimerV7             *uint32  `protobuf:"varint,160,opt,name=StatusTimerV7,proto3,oneof" json:"StatusTimerV7,omitempty"`             // Presence preserves Hashcat's meaningful zero value.
	StdinTimeoutAbortV7       *uint32  `protobuf:"varint,161,opt,name=StdinTimeoutAbortV7,proto3,oneof" json:"StdinTimeoutAbortV7,omitempty"` // Explicit zero disables the stdin timeout.
	OutfileCheckTimerV7       *uint32  `protobuf:"varint,162,opt,name=OutfileCheckTimerV7,proto3,oneof" json:"OutfileCheckTimerV7,omitempty"` // Explicit zero disables outfile checking.
	BitmapMinV7               *uint32  `protobuf:"varint,163,opt,name=BitmapMinV7,proto3,oneof" json:"BitmapMinV7,omitempty"`
	BitmapMaxV7               *uint32  `protobuf:"varint,164,opt,name=BitmapMaxV7,proto3,oneof" json:"BitmapMaxV7,omitempty"`
	HwmonTempAbortV7          *uint32  `protobuf:"varint,165,opt,name=HwmonTempAbortV7,proto3,oneof" json:"HwmonTempAbortV7,omitempty"` // Explicit zero disables temperature abort.
	RulesFilesV7              [][]byte `protobuf:"bytes,166,rep,name=RulesFilesV7,proto3" json:"RulesFilesV7,omitempty"`                // Hashcat accepts more than one --rules-file.
	BrainPasswordV7           *string  `protobuf:"bytes,167,opt,name=BrainPasswordV7,proto3,oneof" json:"BrainPasswordV7,omitempty"`    // Presence preserves an explicitly empty password.
	GenerateRulesFuncMinV7    *uint32  `protobuf:"varint,168,opt,name=GenerateRulesFuncMinV7,proto3,oneof" json:"GenerateRulesFuncMinV7,omitempty"`
	GenerateRulesFuncMaxV7    *uint32  `protobuf:"varint,169,opt,name=GenerateRulesFuncMaxV7,proto3,oneof" json:"GenerateRulesFuncMaxV7,omitempty"`
...
func (x *CrackCommand) GetOutfile() string {
	if x != nil {
		return x.Outfile
	}
	return ""
...
func (x *CrackCommand) GetDebugFile() string {
	if x != nil {
		return x.DebugFile
	}
	return ""
...
func (x *CrackCommand) GetInductionDir() string {
	if x != nil {
		return x.InductionDir
	}
	return ""
}

func (x *CrackCommand) GetOutfileCheckDir() string {
	if x != nil {
		return x.OutfileCheckDir
	}
	return ""
}
...
func (x *CrackCommand) GetTruecryptKeyfiles() string {
	if x != nil {
		return x.TruecryptKeyfiles
	}
	return ""
}

func (x *CrackCommand) GetVeracryptKeyfiles() string {
	if x != nil {
		return x.VeracryptKeyfiles
	}
	return ""
}

func (x *CrackCommand) GetVeracryptPimStart() uint32 {
	if x != nil && x.VeracryptPimStart != nil {
		return *x.VeracryptPimStart
	}
	return 0
}

func (x *CrackCommand) GetVeracryptPimStop() uint32 {
	if x != nil && x.VeracryptPimStop != nil {
		return *x.VeracryptPimStop
	}
	return 0
}
...
func (x *CrackCommand) GetRuleLeft() string {
	if x != nil {
		return x.RuleLeft
	}
	return ""
...
func (x *CrackCommand) GetRuleRight() string {
	if x != nil {
		return x.RuleRight
	}
	return ""
...
func (x *CrackCommand) GetPipelineStats() bool {
	if x != nil {
		return x.PipelineStats
	}
	return false
}

func (x *CrackCommand) GetTaskTimeBreakdown() bool {
	if x != nil {
		return x.TaskTimeBreakdown
	}
	return false
}

func (x *CrackCommand) GetMetalCompilerRuntime() uint32 {
	if x != nil {
		return x.MetalCompilerRuntime
	}
	return 0
}

func (x *CrackCommand) GetRestorePosition() bool {
	if x != nil {
		return x.RestorePosition
	}
	return false
}

func (x *CrackCommand) GetOutfileJSON() bool {
	if x != nil {
		return x.OutfileJSON
	}
	return false
}

func (x *CrackCommand) GetDynamicX() bool {
	if x != nil {
		return x.DynamicX
	}
	return false
...
func (x *CrackCommand) GetSeekDBPath() string {
	if x != nil {
		return x.SeekDBPath
	}
	return ""
...
func (x *CrackCommand) GetBenchmarkMin() uint32 {
	if x != nil {
		return x.BenchmarkMin
	}
	return 0
}

func (x *CrackCommand) GetBenchmarkMax() uint32 {
	if x != nil && x.BenchmarkMax != nil {
		return *x.BenchmarkMax
	}
	return 0
}

func (x *CrackCommand) GetBridgeParameter1() string {
	if x != nil {
		return x.BridgeParameter1
	}
	return ""
}

func (x *CrackCommand) GetBridgeParameter2() string {
	if x != nil {
		return x.BridgeParameter2
	}
	return ""
}

func (x *CrackCommand) GetBridgeParameter3() string {
	if x != nil {
		return x.BridgeParameter3
	}
	return ""
}

func (x *CrackCommand) GetBridgeParameter4() string {
	if x != nil {
		return x.BridgeParameter4
	}
	return ""
}

func (x *CrackCommand) GetBackendDevicesVirtMulti() uint32 {
	if x != nil {
		return x.BackendDevicesVirtMulti
	}
	return 0
}

func (x *CrackCommand) GetBackendDevicesVirtHost() uint32 {
	if x != nil {
		return x.BackendDevicesVirtHost
	}
	return 0
}

func (x *CrackCommand) GetTotalCandidates() bool {
	if x != nil {
...
func (x *CrackCommand) GetLookup() string {
	if x != nil {
		return x.Lookup
	}
	return ""
...
func (x *CrackCommand) GetCustomCharset5() string {
	if x != nil {
		return x.CustomCharset5
	}
	return ""
}

func (x *CrackCommand) GetCustomCharset6() string {
	if x != nil {
		return x.CustomCharset6
	}
	return ""
}

func (x *CrackCommand) GetCustomCharset7() string {
	if x != nil {
		return x.CustomCharset7
	}
	return ""
}

func (x *CrackCommand) GetCustomCharset8() string {
	if x != nil {
		return x.CustomCharset8
	}
	return ""
}

func (x *CrackCommand) GetIncrementInverse() bool {
	if x != nil {
		return x.IncrementInverse
	}
	return false
}

func (x *CrackCommand) GetBypassDelay() uint32 {
	if x != nil && x.BypassDelay != nil {
		return *x.BypassDelay
	}
	return 0
}

func (x *CrackCommand) GetBypassThreshold() uint32 {
	if x != nil && x.BypassThreshold != nil {
		return *x.BypassThreshold
	}
	return 0
}

func (x *CrackCommand) GetBrainFeed() bool {
	if x != nil {
		return x.BrainFeed
	}
	return false
...
func (x *CrackCommand) GetColorCracked() bool {
	if x != nil {
		return x.ColorCracked
	}
	return false
}

func (x *CrackCommand) GetHashCopy() bool {
	if x != nil {
		return x.HashCopy
	}
	return false
...
func (x *CrackCommand) GetEncryptWithPubkey() string {
	if x != nil {
		return x.EncryptWithPubkey
	}
	return ""
}

func (x *CrackCommand) GetIdentifyMode() bool {
	if x != nil {
		return x.IdentifyMode
	}
	return false
}

func (x *CrackCommand) GetPositionalArguments() []string {
	if x != nil {
		return x.PositionalArguments
	}
	return nil
}

func (x *CrackCommand) GetEncodingFromName() string {
	if x != nil {
		return x.EncodingFromName
	}
	return ""
}

func (x *CrackCommand) GetEncodingToName() string {
	if x != nil {
		return x.EncodingToName
	}
	return ""
}

func (x *CrackCommand) GetHashInfoLevel() uint32 {
	if x != nil {
		return x.HashInfoLevel
	}
	return 0
}

func (x *CrackCommand) GetBackendInfoLevel() uint32 {
	if x != nil {
		return x.BackendInfoLevel
	}
	return 0
}

func (x *CrackCommand) GetHccapxMessagePairV7() uint32 {
	if x != nil && x.HccapxMessagePairV7 != nil {
		return *x.HccapxMessagePairV7
	}
	return 0
}

func (x *CrackCommand) GetNonceErrorCorrectionsV7() uint32 {
	if x != nil && x.NonceErrorCorrectionsV7 != nil {
		return *x.NonceErrorCorrectionsV7
	}
	return 0
}

func (x *CrackCommand) GetScryptTMTOV7() uint32 {
	if x != nil && x.ScryptTMTOV7 != nil {
		return *x.ScryptTMTOV7
	}
	return 0
}

func (x *CrackCommand) GetGenerateRulesSeedV7() uint32 {
	if x != nil && x.GenerateRulesSeedV7 != nil {
		return *x.GenerateRulesSeedV7
	}
	return 0
}

func (x *CrackCommand) GetBrainClientFeaturesV7() uint32 {
	if x != nil {
		return x.BrainClientFeaturesV7
	}
	return 0
}

func (x *CrackCommand) GetBrainSessionV7() uint32 {
	if x != nil && x.BrainSessionV7 != nil {
		return *x.BrainSessionV7
	}
	return 0
}

func (x *CrackCommand) GetBrainSessionWhitelistV7() []uint32 {
	if x != nil {
		return x.BrainSessionWhitelistV7
	}
	return nil
}

func (x *CrackCommand) GetStdin() []byte {
	if x != nil {
		return x.Stdin
	}
	return nil
...
func (x *CrackCommand) GetAdviceDisable() bool {
	if x != nil {
		return x.AdviceDisable
	}
	return false
}

func (x *CrackCommand) GetHashMode() uint32 {
...
func (x *CrackCommand) GetRestoreShowCommand() bool {
	if x != nil {
		return x.RestoreShowCommand
	}
	return false
}

func (x *CrackCommand) GetBrainServerTimerV7() uint32 {
	if x != nil && x.BrainServerTimerV7 != nil {
		return *x.BrainServerTimerV7
	}
	return 0
}

func (x *CrackCommand) GetStatusTimerV7() uint32 {
	if x != nil && x.StatusTimerV7 != nil {
		return *x.StatusTimerV7
	}
	return 0
}

func (x *CrackCommand) GetStdinTimeoutAbortV7() uint32 {
	if x != nil && x.StdinTimeoutAbortV7 != nil {
		return *x.StdinTimeoutAbortV7
	}
	return 0
}

func (x *CrackCommand) GetOutfileCheckTimerV7() uint32 {
	if x != nil && x.OutfileCheckTimerV7 != nil {
		return *x.OutfileCheckTimerV7
	}
	return 0
}

func (x *CrackCommand) GetBitmapMinV7() uint32 {
	if x != nil && x.BitmapMinV7 != nil {
		return *x.BitmapMinV7
	}
	return 0
}

func (x *CrackCommand) GetBitmapMaxV7() uint32 {
	if x != nil && x.BitmapMaxV7 != nil {
		return *x.BitmapMaxV7
	}
	return 0
}

func (x *CrackCommand) GetHwmonTempAbortV7() uint32 {
	if x != nil && x.HwmonTempAbortV7 != nil {
		return *x.HwmonTempAbortV7
	}
	return 0
}

func (x *CrackCommand) GetRulesFilesV7() [][]byte {
	if x != nil {
		return x.RulesFilesV7
	}
	return nil
}

func (x *CrackCommand) GetBrainPasswordV7() string {
	if x != nil && x.BrainPasswordV7 != nil {
		return *x.BrainPasswordV7
	}
	return ""
}

func (x *CrackCommand) GetGenerateRulesFuncMinV7() uint32 {
	if x != nil && x.GenerateRulesFuncMinV7 != nil {
		return *x.GenerateRulesFuncMinV7
	}
	return 0
}

func (x *CrackCommand) GetGenerateRulesFuncMaxV7() uint32 {
	if x != nil && x.GenerateRulesFuncMaxV7 != nil {
		return *x.GenerateRulesFuncMaxV7
	}
	return 0
}

func (x *CrackCommand) GetCredentialIDs() []string {
	if x != nil {
...
func (x *CrackCommand) GetCredentialCollection() string {
	if x != nil {
		return x.CredentialCollection
	}
	return ""
}

func (x *CrackCommand) GetIncludeCrackedCredentials() bool {
	if x != nil {
		return x.IncludeCrackedCredentials
	}
	return false
}
...
type CrackJob struct {
	...
	Tasks         []*CrackTask           `protobuf:"bytes,9,rep,name=Tasks,proto3" json:"Tasks,omitempty"`
	Keyspace      string                 `protobuf:"bytes,10,opt,name=Keyspace,proto3" json:"Keyspace,omitempty"`
	Results       []*CrackResult         `protobuf:"bytes,11,rep,name=Results,proto3" json:"Results,omitempty"`
	UpdatedAt     int64                  `protobuf:"varint,12,opt,name=UpdatedAt,proto3" json:"UpdatedAt,omitempty"`
	ResultCount   uint64                 `protobuf:"varint,13,opt,name=ResultCount,proto3" json:"ResultCount,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CrackJob) GetTasks() []*CrackTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
func (x *CrackJob) GetKeyspace() string {
	if x != nil {
		return x.Keyspace
	}
	return ""
...
func (x *CrackJob) GetResults() []*CrackResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *CrackJob) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
func (x *CrackJob) GetResultCount() uint64 {
	if x != nil {
...
type CrackJobs struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Jobs          []*CrackJob            `protobuf:"bytes,1,rep,name=Jobs,proto3" json:"Jobs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CrackJobs) Reset() {
	*x = CrackJobs{}
...
func (x *CrackJobs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrackJobs) ProtoMessage() {}

func (x *CrackJobs) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[122]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrackJobs.ProtoReflect.Descriptor instead.
func (*CrackJobs) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{122}
}

func (x *CrackJobs) GetJobs() []*CrackJob {
	if x != nil {
		return x.Jobs
	}
	return nil
...
type CrackResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ID            string                 `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`
	CrackJobID    string                 `protobuf:"bytes,2,opt,name=CrackJobID,proto3" json:"CrackJobID,omitempty"`
	CrackTaskID   string                 `protobuf:"bytes,3,opt,name=CrackTaskID,proto3" json:"CrackTaskID,omitempty"`
...
func (x *CrackResult) GetCrackJobID() string {
	if x != nil {
		return x.CrackJobID
	}
	return ""
...
func (x *CrackResult) GetCrackTaskID() string {
	if x != nil {
		return x.CrackTaskID
	}
	return ""
}

func (x *CrackResult) GetCredentialID() string {
	if x != nil {
...
func (x *CrackResult) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *CrackResult) GetPlaintext() []byte {
	if x != nil {
		return x.Plaintext
	}
	return nil
...
func (x *CrackResult) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
type CrackFile struct {
	...
	CompressedSize   int64                  `protobuf:"varint,11,opt,name=CompressedSize,proto3" json:"CompressedSize,omitempty"`
...
func (x *CrackFile) GetCompressedSize() int64 {
	if x != nil {
...
const file_clientpb_client_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x01\"\x97\x02\n" +
	...
	"Benchmarks\x12$\n" +
	"\rSchemaVersion\x18\x04 \x01(\rR\rSchemaVersion\x12&\n" +
	"\x0eHashcatVersion\x18\x05 \x01(\tR\x0eHashcatVersion\x1a=\n" +
	"\x0fBenchmarksEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value:\x028\x01\"\xa4\a\n" +
	"\tCrackTask\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x1a\n" +
	...
	"\x03Err\x18\a \x01(\tR\x03Err\x12\x16\n" +
	"\x06Stdout\x18\b \x01(\fR\x06Stdout\x120\n" +
	"\aCommand\x18\t \x01(\v2\x16.clientpb.CrackCommandR\aCommand\x12\x16\n" +
	"\x06Stderr\x18\n" +
	" \x01(\fR\x06Stderr\x12\x1a\n" +
	"\bExitCode\x18\v \x01(\x05R\bExitCode\x12(\n" +
	"\x0fStdoutTruncated\x18\f \x01(\bR\x0fStdoutTruncated\x12(\n" +
	"\x0fStderrTruncated\x18\r \x01(\bR\x0fStderrTruncated\x12*\n" +
	"\x10StdoutTotalBytes\x18\x0e \x01(\x04R\x10StdoutTotalBytes\x12*\n" +
	"\x10StderrTotalBytes\x18\x0f \x01(\x04R\x10StderrTotalBytes\x12\x1e\n" +
	"\n" +
	"CrackJobID\x18\x10 \x01(\tR\n" +
	"CrackJobID\x12+\n" +
	"\x04Kind\x18\x11 \x01(\x0e2\x17.clientpb.CrackTaskKindR\x04Kind\x12.\n" +
	"\x05State\x18\x12 \x01(\x0e2\x18.clientpb.CrackTaskStateR\x05State\x12\x18\n" +
	"\aAttempt\x18\x13 \x01(\rR\aAttempt\x12\x1e\n" +
	"\n" +
	"LeaseToken\x18\x14 \x01(\tR\n" +
	"LeaseToken\x12&\n" +
	"\x0eLeaseExpiresAt\x18\x15 \x01(\x03R\x0eLeaseExpiresAt\x12\x1c\n" +
	"\tUpdatedAt\x18\x16 \x01(\x03R\tUpdatedAt\x12(\n" +
	"\x0fLastHeartbeatAt\x18\x17 \x01(\x03R\x0fLastHeartbeatAt\x12\x1a\n" +
	"\bKeyspace\x18\x18 \x01(\tR\bKeyspace\x12*\n" +
	"\x10LatestStatusJSON\x18\x19 \x01(\fR\x10LatestStatusJSON\x12$\n" +
	"\rRecoveredJSON\x18\x1a \x01(\fR\rRecoveredJSON\x12\x1c\n" +
	...
	"Benchmarks\x124\n" +
	"\x06Status\x18\n" +
	" \x01(\v2\x1c.clientpb.CrackstationStatusR\x06Status\x12-\n" +
	...
	"MemoryFree\x12 \n" +
	"\vCUDAVersion\x18\n" +
	" \x01(\tR\vCUDAVersion\x12(\n" +
	"\x0fBackendDeviceID\x18\v \x01(\rR\x0fBackendDeviceID\x123\n" +
	"\x12BackendDeviceAlias\x18\f \x01(\rH\x00R\x12BackendDeviceAlias\x88\x01\x01\x125\n" +
	"\x13PreferredThreadSize\x18\r \x01(\rH\x01R\x13PreferredThreadSize\x88\x01\x01\x12)\n" +
	"\rMemoryUnified\x18\x0e \x01(\bH\x02R\rMemoryUnified\x88\x01\x01\x12 \n" +
	"\vLocalMemory\x18\x0f \x01(\tR\vLocalMemory\x12\x1c\n" +
	"\tCacheSize\x18\x10 \x01(\tR\tCacheSize\x12\x1e\n" +
	"\n" +
	"PCIAddress\x18\x11 \x01(\tR\n" +
	"PCIAddressB\x15\n" +
	"\x13_BackendDeviceAliasB\x16\n" +
	"\x14_PreferredThreadSizeB\x10\n" +
	"\x0e_MemoryUnified\"\xe5\x06\n" +
	...
	"\x13OpenCLDriverVersion\x18\v \x01(\tR\x13OpenCLDriverVersion\x12(\n" +
	"\x0fBackendDeviceID\x18\f \x01(\rR\x0fBackendDeviceID\x123\n" +
	"\x12BackendDeviceAlias\x18\r \x01(\rH\x00R\x12BackendDeviceAlias\x88\x01\x01\x125\n" +
	"\x13PreferredThreadSize\x18\x0e \x01(\rH\x01R\x13PreferredThreadSize\x88\x01\x01\x12)\n" +
	"\rMemoryUnified\x18\x0f \x01(\bH\x02R\rMemoryUnified\x88\x01\x01\x12 \n" +
	"\vLocalMemory\x18\x10 \x01(\tR\vLocalMemory\x120\n" +
	"\x13MemoryAllocPerBlock\x18\x11 \x01(\tR\x13MemoryAllocPerBlock\x12\x1e\n" +
	"\n" +
	"PCIAddress\x18\x12 \x01(\tR\n" +
	"PCIAddress\x12\x1e\n" +
	"\n" +
	"PlatformID\x18\x13 \x01(\rR\n" +
	"PlatformID\x12&\n" +
	"\x0ePlatformVendor\x18\x14 \x01(\tR\x0ePlatformVendor\x12\"\n" +
	"\fPlatformName\x18\x15 \x01(\tR\fPlatformName\x12(\n" +
	"\x0fPlatformVersion\x18\x16 \x01(\tR\x0fPlatformVersionB\x15\n" +
	"\x13_BackendDeviceAliasB\x16\n" +
	"\x14_PreferredThreadSizeB\x10\n" +
	"\x0e_MemoryUnified\"\xbe\a\n" +
	...
	"MemoryFree\x12\"\n" +
	"\fMetalVersion\x18\n" +
	" \x01(\tR\fMetalVersion\x12(\n" +
	"\x0fBackendDeviceID\x18\v \x01(\rR\x0fBackendDeviceID\x123\n" +
	"\x12BackendDeviceAlias\x18\f \x01(\rH\x00R\x12BackendDeviceAlias\x88\x01\x01\x125\n" +
	"\x13PreferredThreadSize\x18\r \x01(\rH\x01R\x13PreferredThreadSize\x88\x01\x01\x12)\n" +
	"\rMemoryUnified\x18\x0e \x01(\bH\x02R\rMemoryUnified\x88\x01\x01\x12 \n" +
	"\vLocalMemory\x18\x0f \x01(\tR\vLocalMemory\x12\x1c\n" +
	"\tCacheSize\x18\x10 \x01(\tR\tCacheSize\x120\n" +
	"\x13MemoryAllocPerBlock\x18\x11 \x01(\tR\x13MemoryAllocPerBlock\x12*\n" +
	"\x10PhysicalLocation\x18\x12 \x01(\tR\x10PhysicalLocation\x12#\n" +
	"\n" +
	"RegistryID\x18\x13 \x01(\rH\x03R\n" +
	"RegistryID\x88\x01\x01\x12\x1c\n" +
	"\tMaxTXRate\x18\x14 \x01(\tR\tMaxTXRate\x12%\n" +
	"\vGPUHeadless\x18\x15 \x01(\bH\x04R\vGPUHeadless\x88\x01\x01\x12%\n" +
	"\vGPULowPower\x18\x16 \x01(\bH\x05R\vGPULowPower\x88\x01\x01\x12'\n" +
	"\fGPURemovable\x18\x17 \x01(\bH\x06R\fGPURemovable\x88\x01\x01B\x15\n" +
	"\x13_BackendDeviceAliasB\x16\n" +
	"\x14_PreferredThreadSizeB\x10\n" +
	"\x0e_MemoryUnifiedB\r\n" +
	"\v_RegistryIDB\x0e\n" +
	"\f_GPUHeadlessB\x0e\n" +
	"\f_GPULowPowerB\x0f\n" +
	"\r_GPURemovable\"\x80\x05\n" +
	"\x0eHIPBackendInfo\x12\x12\n" +
	"\x04Type\x18\x01 \x01(\tR\x04Type\x12\x1a\n" +
	"\bVendorID\x18\x02 \x01(\x05R\bVendorID\x12\x16\n" +
	"\x06Vendor\x18\x03 \x01(\tR\x06Vendor\x12\x12\n" +
	"\x04Name\x18\x04 \x01(\tR\x04Name\x12\x18\n" +
	...
	"\aSession\x18\x18 \x01(\tR\aSession\x12\x1c\n" +
	"\aRestore\x18\x19 \x01(\bB\x02\x18\x01R\aRestore\x12&\n" +
	"\x0eRestoreDisable\x18\x1a \x01(\bR\x0eRestoreDisable\x12 \n" +
	"\vRestoreFile\x18\x1b \x01(\fR\vRestoreFile\x12\x18\n" +
	"\aOutfile\x18\x1c \x01(\tR\aOutfile\x12B\n" +
	...
	"EncodingTo\x12\x1c\n" +
	"\tDebugMode\x18, \x01(\rR\tDebugMode\x12\x1c\n" +
	"\tDebugFile\x18- \x01(\tR\tDebugFile\x12\"\n" +
	"\fInductionDir\x18. \x01(\tR\fInductionDir\x12(\n" +
	"\x0fOutfileCheckDir\x18/ \x01(\tR\x0fOutfileCheckDir\x12&\n" +
	...
	"\x15KeyboardLayoutMapping\x183 \x01(\fR\x15KeyboardLayoutMapping\x12,\n" +
	"\x11TruecryptKeyfiles\x184 \x01(\tR\x11TruecryptKeyfiles\x12,\n" +
	"\x11VeracryptKeyfiles\x185 \x01(\tR\x11VeracryptKeyfiles\x121\n" +
	"\x11VeracryptPimStart\x186 \x01(\rH\x00R\x11VeracryptPimStart\x88\x01\x01\x12/\n" +
	"\x10VeracryptPimStop\x187 \x01(\rH\x01R\x10VeracryptPimStop\x88\x01\x01\x12\x1c\n" +
	...
	"\vSegmentSize\x18< \x01(\rB\x02\x18\x01R\vSegmentSize\x12\x1c\n" +
	...
	"\x15MultiplyAccelDisabled\x18K \x01(\bR\x15MultiplyAccelDisabled\x12L\n" +
	"\x0fWorkloadProfile\x18L \x01(\x0e2\x1e.clientpb.CrackWorkloadProfileB\x02\x18\x01R\x0fWorkloadProfile\x12 \n" +
	...
	"\bKeyspace\x18W \x01(\bR\bKeyspace\x12\x1a\n" +
	"\bRuleLeft\x18X \x01(\tR\bRuleLeft\x12\x1c\n" +
	"\tRuleRight\x18Y \x01(\tR\tRuleRight\x12\x1c\n" +
	...
	"\x15BrainSessionWhitelist\x18q \x01(\tR\x15BrainSessionWhitelist\x12$\n" +
	"\rPipelineStats\x18r \x01(\bR\rPipelineStats\x12,\n" +
	"\x11TaskTimeBreakdown\x18s \x01(\bR\x11TaskTimeBreakdown\x122\n" +
	"\x14MetalCompilerRuntime\x18t \x01(\rR\x14MetalCompilerRuntime\x12(\n" +
	"\x0fRestorePosition\x18u \x01(\bR\x0fRestorePosition\x12 \n" +
	"\vOutfileJSON\x18v \x01(\bR\vOutfileJSON\x12\x1a\n" +
	"\bDynamicX\x18w \x01(\bR\bDynamicX\x12\x1e\n" +
	"\n" +
	"SeekDBPath\x18x \x01(\tR\n" +
	"SeekDBPath\x12\"\n" +
	"\fBenchmarkMin\x18y \x01(\rR\fBenchmarkMin\x12'\n" +
	"\fBenchmarkMax\x18z \x01(\rH\x02R\fBenchmarkMax\x88\x01\x01\x12*\n" +
	"\x10BridgeParameter1\x18{ \x01(\tR\x10BridgeParameter1\x12*\n" +
	"\x10BridgeParameter2\x18| \x01(\tR\x10BridgeParameter2\x12*\n" +
	"\x10BridgeParameter3\x18} \x01(\tR\x10BridgeParameter3\x12*\n" +
	"\x10BridgeParameter4\x18~ \x01(\tR\x10BridgeParameter4\x128\n" +
	"\x17BackendDevicesVirtMulti\x18\x7f \x01(\rR\x17BackendDevicesVirtMulti\x127\n" +
	"\x16BackendDevicesVirtHost\x18\x80\x01 \x01(\rR\x16BackendDevicesVirtHost\x12)\n" +
	"\x0fTotalCandidates\x18\x81\x01 \x01(\bR\x0fTotalCandidates\x12\x17\n" +
	"\x06Lookup\x18\x82\x01 \x01(\tR\x06Lookup\x12'\n" +
	"\x0eCustomCharset5\x18\x83\x01 \x01(\tR\x0eCustomCharset5\x12'\n" +
	"\x0eCustomCharset6\x18\x84\x01 \x01(\tR\x0eCustomCharset6\x12'\n" +
	"\x0eCustomCharset7\x18\x85\x01 \x01(\tR\x0eCustomCharset7\x12'\n" +
	"\x0eCustomCharset8\x18\x86\x01 \x01(\tR\x0eCustomCharset8\x12+\n" +
	"\x10IncrementInverse\x18\x87\x01 \x01(\bR\x10IncrementInverse\x12&\n" +
	"\vBypassDelay\x18\x88\x01 \x01(\rH\x03R\vBypassDelay\x88\x01\x01\x12.\n" +
	"\x0fBypassThreshold\x18\x89\x01 \x01(\rH\x04R\x0fBypassThreshold\x88\x01\x01\x12\x1d\n" +
	"\tBrainFeed\x18\x8a\x01 \x01(\bR\tBrainFeed\x12#\n" +
	"\fColorCracked\x18\x8b\x01 \x01(\bR\fColorCracked\x12\x1b\n" +
	"\bHashCopy\x18\x8c\x01 \x01(\bR\bHashCopy\x12-\n" +
	"\x11EncryptWithPubkey\x18\x8d\x01 \x01(\tR\x11EncryptWithPubkey\x12#\n" +
	"\fIdentifyMode\x18\x8e\x01 \x01(\bR\fIdentifyMode\x121\n" +
	"\x13PositionalArguments\x18\x8f\x01 \x03(\tR\x13PositionalArguments\x12+\n" +
	"\x10EncodingFromName\x18\x90\x01 \x01(\tR\x10EncodingFromName\x12'\n" +
	"\x0eEncodingToName\x18\x91\x01 \x01(\tR\x0eEncodingToName\x12%\n" +
	"\rHashInfoLevel\x18\x92\x01 \x01(\rR\rHashInfoLevel\x12+\n" +
	"\x10BackendInfoLevel\x18\x93\x01 \x01(\rR\x10BackendInfoLevel\x126\n" +
	"\x13HccapxMessagePairV7\x18\x94\x01 \x01(\rH\x05R\x13HccapxMessagePairV7\x88\x01\x01\x12>\n" +
	"\x17NonceErrorCorrectionsV7\x18\x95\x01 \x01(\rH\x06R\x17NonceErrorCorrectionsV7\x88\x01\x01\x12(\n" +
	"\fScryptTMTOV7\x18\x96\x01 \x01(\rH\aR\fScryptTMTOV7\x88\x01\x01\x126\n" +
	"\x13GenerateRulesSeedV7\x18\x97\x01 \x01(\rH\bR\x13GenerateRulesSeedV7\x88\x01\x01\x125\n" +
	"\x15BrainClientFeaturesV7\x18\x98\x01 \x01(\rR\x15BrainClientFeaturesV7\x12,\n" +
	"\x0eBrainSessionV7\x18\x99\x01 \x01(\rH\tR\x0eBrainSessionV7\x88\x01\x01\x129\n" +
	"\x17BrainSessionWhitelistV7\x18\x9a\x01 \x03(\rR\x17BrainSessionWhitelistV7\x12\x15\n" +
	"\x05Stdin\x18\x9b\x01 \x01(\fR\x05Stdin\x12%\n" +
	"\rAdviceDisable\x18\x9c\x01 \x01(\bR\rAdviceDisable\x12 \n" +
	"\bHashMode\x18\x9d\x01 \x01(\rH\n" +
	"R\bHashMode\x88\x01\x01\x12/\n" +
	"\x12RestoreShowCommand\x18\x9e\x01 \x01(\bR\x12RestoreShowCommand\x124\n" +
	"\x12BrainServerTimerV7\x18\x9f\x01 \x01(\rH\vR\x12BrainServerTimerV7\x88\x01\x01\x12*\n" +
	"\rStatusTimerV7\x18\xa0\x01 \x01(\rH\fR\rStatusTimerV7\x88\x01\x01\x126\n" +
	"\x13StdinTimeoutAbortV7\x18\xa1\x01 \x01(\rH\rR\x13StdinTimeoutAbortV7\x88\x01\x01\x126\n" +
	"\x13OutfileCheckTimerV7\x18\xa2\x01 \x01(\rH\x0eR\x13OutfileCheckTimerV7\x88\x01\x01\x12&\n" +
	"\vBitmapMinV7\x18\xa3\x01 \x01(\rH\x0fR\vBitmapMinV7\x88\x01\x01\x12&\n" +
	"\vBitmapMaxV7\x18\xa4\x01 \x01(\rH\x10R\vBitmapMaxV7\x88\x01\x01\x120\n" +
	"\x10HwmonTempAbortV7\x18\xa5\x01 \x01(\rH\x11R\x10HwmonTempAbortV7\x88\x01\x01\x12#\n" +
	"\fRulesFilesV7\x18\xa6\x01 \x03(\fR\fRulesFilesV7\x12.\n" +
	"\x0fBrainPasswordV7\x18\xa7\x01 \x01(\tH\x12R\x0fBrainPasswordV7\x88\x01\x01\x12<\n" +
	"\x16GenerateRulesFuncMinV7\x18\xa8\x01 \x01(\rH\x13R\x16GenerateRulesFuncMinV7\x88\x01\x01\x12<\n" +
	...
	"\r_BenchmarkMaxB\x0e\n" +
	"\f_BypassDelayB\x12\n" +
	"\x10_BypassThresholdB\x16\n" +
	"\x14_HccapxMessagePairV7B\x1a\n" +
	"\x18_NonceErrorCorrectionsV7B\x0f\n" +
	"\r_ScryptTMTOV7B\x16\n" +
	"\x14_GenerateRulesSeedV7B\x11\n" +
	"\x0f_BrainSessionV7B\v\n" +
	"\t_HashModeB\x15\n" +
	"\x13_BrainServerTimerV7B\x10\n" +
	"\x0e_StatusTimerV7B\x16\n" +
	"\x14_StdinTimeoutAbortV7B\x16\n" +
	"\x14_OutfileCheckTimerV7B\x0e\n" +
	"\f_BitmapMinV7B\x0e\n" +
	"\f_BitmapMaxV7B\x13\n" +
	"\x11_HwmonTempAbortV7B\x12\n" +
	"\x10_BrainPasswordV7B\x19\n" +
	"\x17_GenerateRulesFuncMinV7B\x19\n" +
	"\x17_GenerateRulesFuncMaxV7\"\xac\x03\n" +
	"\bCrackJob\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x1c\n" +
	...
	"\fResultFileID\x18\b \x01(\tR\fResultFileID\x12)\n" +
	"\x05Tasks\x18\t \x03(\v2\x13.clientpb.CrackTaskR\x05Tasks\x12\x1a\n" +
	"\bKeyspace\x18\n" +
	" \x01(\tR\bKeyspace\x12/\n" +
	"\aResults\x18\v \x03(\v2\x15.clientpb.CrackResultR\aResults\x12\x1c\n" +
	...
	"\n" +
	"CrackJobID\x18\x02 \x01(\tR\n" +
	"CrackJobID\x12 \n" +
	"\vCrackTaskID\x18\x03 \x01(\tR\vCrackTaskID\x12\"\n" +
	...
	"\fMaxDiskUsage\x18\x03 \x01(\x03R\fMaxDiskUsage\"\xa3\x03\n" +
	"\tCrackFile\x12\x0e\n" +
	"\x02ID\x18\x01 \x01(\tR\x02ID\x12\x1c\n" +
	...
	"\x0eCompressedSize\x18\v \x01(\x03R\x0eCompressedSize\x120\n" +
	...
	"\x12CRACK_TASK_RUNNING\x10\x02\x12\x18\n" +
	"\x14CRACK_TASK_COMPLETED\x10\x03\x12\x15\n" +
	"\x11CRACK_TASK_FAILED\x10\x04\x12\x18\n" +
	"\x14CRACK_TASK_CANCELLED\x10\x05*\xb7\x01\n" +
	"\x0fCrackAttackMode\x12\f\n" +
	"\bSTRAIGHT\x10\x00\x12\x0f\n" +
	"\vCOMBINATION\x10\x01\x12\x0e\n" +
	"\n" +
	"BRUTEFORCE\x10\x03\x12\b\n" +
	"\x04PCFG\x10\x04\x12\x18\n" +
	"\x14HYBRID_WORDLIST_MASK\x10\x06\x12\x18\n" +
	"\x14HYBRID_MASK_WORDLIST\x10\a\x12\v\n" +
	"\aGENERIC\x10\b\x12\x0f\n" +
...
var file_clientpb_client_proto_goTypes = []any{
	...
	(CrackTaskKind)(0),                     // 8: clientpb.CrackTaskKind
	(CrackTaskState)(0),                    // 9: clientpb.CrackTaskState
	(CrackAttackMode)(0),                   // 10: clientpb.CrackAttackMode
	(CrackEncoding)(0),                     // 11: clientpb.CrackEncoding
	(CrackOutfileFormat)(0),                // 12: clientpb.CrackOutfileFormat
	(CrackWorkloadProfile)(0),              // 13: clientpb.CrackWorkloadProfile
	(CrackFileType)(0),                     // 14: clientpb.CrackFileType
	(AIConversationTurnState)(0),           // 15: clientpb.AIConversationTurnState
	(AIConversationMessageKind)(0),         // 16: clientpb.AIConversationMessageKind
...
var file_clientpb_client_proto_depIdxs = []int32{
	...
	11,  // 118: clientpb.CrackCommand.EncodingFrom:type_name -> clientpb.CrackEncoding
...
func file_clientpb_client_proto_init() {
	...
	file_clientpb_client_proto_msgTypes[116].OneofWrappers = []any{}
	file_clientpb_client_proto_msgTypes[117].OneofWrappers = []any{}
