...
// CompleteMsfVenomPayloads - Returns the list of all MSFVenom payloads.
func CompleteMsfVenomPayloads() (comps []*readline.CompletionGroup) {
...
// CompleteMsfFormats - Returns the list of all MSFVenom TRANSFORM formats.
func CompleteMsfFormats() (completions []*readline.CompletionGroup) {
	comp := &readline.CompletionGroup{
		Name:         "native target platforms",
		Suggestions:  msfTransformFormats,
		Descriptions: map[string]string{},
...
// CompleteMsfEncoders - Returns the list of Sliver supported MSFVenom encoders.
func CompleteMsfEncoders() (completions []*readline.CompletionGroup) {
	comp := &readline.CompletionGroup{
		Name:         "msfvenom encoders",
		Suggestions:  msfEncoders,
		Descriptions: map[string]string{},
		DisplayType:  readline.TabDisplayGrid,
		MaxLength:    20,
	}
...
// CompleteMsfArchs - Returns the list of Sliver supported MSFVenom architectures
func CompleteMsfArchs() (completions []*readline.CompletionGroup) {
	comp := &readline.CompletionGroup{
		Name:         "msfvenom archs",
		Suggestions:  msfArchs,
		Descriptions: map[string]string{},
		DisplayType:  readline.TabDisplayGrid,
		MaxLength:    20,
	}
...
// CompleteMsfProtocols - Returns the list of meterpreter stager protocols.
func CompleteMsfProtocols() (completions []*readline.CompletionGroup) {
	comp := &readline.CompletionGroup{
		Name:         "stager protocols",
		Suggestions:  msfStagerProtocols,
		Descriptions: map[string]string{},
		DisplayType:  readline.TabDisplayGrid,
		MaxLength:    20,
	}
...
var (
	...
	msfArchs = []string{"amd64", "x86"}

	msfOS = []string{"windows", "linux"}
	...
	msfvenomPayloads = map[string]string{
