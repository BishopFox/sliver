...
func newReverseForwarderUDP(info *commpb.Handler, client *Comm, implant *Comm) *reverseForwarderUDP {
	reverseUDP := &reverseForwarderUDP{
		info:    info,
		client:  client,
		implant: implant,
	}
...
func (f *reverseForwarderUDP) comms() (client, implant *Comm) {
...
func (f *reverseForwarderUDP) start() (err error) {
...
func (f *reverseForwarderUDP) handle(info *commpb.Conn, ch ssh.NewChannel) (err error) {
...
func (f *reverseForwarderUDP) close() (err error) {
...
func (f *reverseForwarderUDP) notifyClose() (err error) {
