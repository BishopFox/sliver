...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x02, 0x2a, 0x26, 0x0a, 0x10, 0x53, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x64, 0x65,
	0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x48, 0x49, 0x4b, 0x41,
	0x54, 0x41, 0x5f, 0x47, 0x41, 0x5f, 0x4e, 0x41, 0x49, 0x10, 0x00, 0x42, 0x2f, 0x5a, 0x2d, 0x67,
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	nil,                          // 81: clientpb.ImplantBuilds.ConfigsEntry
	nil,                          // 82: clientpb.WebsiteAddContent.ContentsEntry
	nil,                          // 83: clientpb.Website.ContentsEntry
	nil,                          // 84: clientpb.Host.ExtensionDataEntry
	(*commonpb.Request)(nil),     // 85: commonpb.Request
	(*commonpb.Response)(nil),    // 86: commonpb.Response
	(*commonpb.File)(nil),        // 87: commonpb.File
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	81, // 4: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	...
	85, // 13: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	86, // 14: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	85, // 15: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	86, // 16: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	87, // 19: clientpb.Generate.File:type_name -> commonpb.File
	85, // 20: clientpb.MSFReq.Request:type_name -> commonpb.Request
	85, // 21: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	87, // 24: clientpb.MsfStager.File:type_name -> commonpb.File
	13, // 25: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	85, // 26: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	13, // 27: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	85, // 28: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	85, // 29: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	85, // 30: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	82, // 39: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	83, // 40: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	...
	87, // 46: clientpb.Loot.File:type_name -> commonpb.File
	71, // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	73, // 48: clientpb.Host.IOCs:type_name -> clientpb.IOC
	84, // 49: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	75, // 50: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	85, // 51: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	86, // 52: clientpb.DllHijack.Response:type_name -> commonpb.Response
	5,  // 53: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	85, // 54: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	86, // 55: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	13, // 56: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	64, // 57: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	64, // 58: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	74, // 59: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
