...
func (s *regexFcd) calculateFC(nt nodeType, node *regexNode, CurIndex int) {
	...
	case ntGrapheme:
		s.pushFC(regexFc{cc: *AnyClass(), nullable: false, caseInsensitive: false})
		break
...
func getPrefix(tree *RegexTree) *Prefix {
	...
	for {
		...
		case ntBol, ntEol, ntBoundary, ntECMABoundary, ntGraphemeBoundary, ntBeginning,
			ntStart, ntEndZ, ntEnd, ntEmpty, ntRequire, ntPrevent:
