...
const (
	Statuses_WAITING      Statuses = 0
	Statuses_CRACKING     Statuses = 1
	Statuses_INITIALIZING Statuses = 2
)
...
type CrackstationStatus struct {
	...
	Name     string   `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`
	HostUUID string   `protobuf:"bytes,2,opt,name=HostUUID,proto3" json:"HostUUID,omitempty"`
	Status   Statuses `protobuf:"varint,3,opt,name=Status,proto3,enum=clientpb.Statuses" json:"Status,omitempty"`
}
...
func (x *CrackstationStatus) GetStatus() Statuses {
	if x != nil {
		return x.Status
	}
	return Statuses_WAITING
}

type CrackstationBenchmark struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Name       string          `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`
	HostUUID   string          `protobuf:"bytes,2,opt,name=HostUUID,proto3" json:"HostUUID,omitempty"`
	Benchmarks map[int32]int64 `protobuf:"bytes,3,rep,name=Benchmarks,proto3" json:"Benchmarks,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (x *CrackstationBenchmark) Reset() {
	*x = CrackstationBenchmark{}
	if protoimpl.UnsafeEnabled {
...
func (x *CrackstationBenchmark) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CrackstationBenchmark) ProtoMessage() {}

func (x *CrackstationBenchmark) ProtoReflect() protoreflect.Message {
	mi := &file_clientpb_client_proto_msgTypes[84]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CrackstationBenchmark.ProtoReflect.Descriptor instead.
func (*CrackstationBenchmark) Descriptor() ([]byte, []int) {
	return file_clientpb_client_proto_rawDescGZIP(), []int{84}
}

func (x *CrackstationBenchmark) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CrackstationBenchmark) GetHostUUID() string {
	if x != nil {
		return x.HostUUID
	}
	return ""
...
func (x *CrackstationBenchmark) GetBenchmarks() map[int32]int64 {
	if x != nil {
		return x.Benchmarks
	}
	return nil
...
var file_clientpb_client_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x72, 0x73, 0x22, 0x80, 0x02, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	...
	0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x70, 0x0a,
	...
	0x55, 0x49, 0x44, 0x12, 0x2a, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22,
	0xd7, 0x01, 0x0a, 0x15, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x08, 0x48, 0x6f, 0x73, 0x74, 0x55, 0x55, 0x49, 0x44, 0x12, 0x4f, 0x0a, 0x0a, 0x42, 0x65, 0x6e,
	0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x65, 0x6e, 0x63, 0x68, 0x6d, 0x61, 0x72, 0x6b, 0x2e, 0x42,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe6, 0x02, 0x0a, 0x0c, 0x43, 0x72,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x04,
	...
	0x43, 0x4c, 0x22, 0xa1, 0x02, 0x0a, 0x0f, 0x43, 0x55, 0x44, 0x41, 0x42, 0x61, 0x63, 0x6b, 0x65,
	...
	0x61, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xf6, 0x1f, 0x0a, 0x09, 0x43, 0x72,
	0x61, 0x63, 0x6b, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x39, 0x0a, 0x0a, 0x41, 0x74, 0x74, 0x61, 0x63,
	...
	,
	...
	0x50, 0x54, 0x5f, 0x55, 0x4e, 0x49, 0x58, 0x10, 0x88, 0x0e, 0x2a, 0x37, 0x0a, 0x08, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x57, 0x41, 0x49, 0x54, 0x49, 0x4e,
	0x47, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x52, 0x41, 0x43, 0x4b, 0x49, 0x4e, 0x47, 0x10,
	0x01, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x4e, 0x49, 0x54, 0x49, 0x41, 0x4c, 0x49, 0x5a, 0x49, 0x4e,
	0x47, 0x10, 0x02, 0x2a, 0x94, 0x01, 0x0a, 0x0f, 0x43, 0x72, 0x61, 0x63, 0x6b, 0x41, 0x74, 0x74,
	...
	0x48, 0x54, 0x4d, 0x41, 0x52, 0x45, 0x10, 0x04, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68,
...
var file_clientpb_client_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 96)
var file_clientpb_client_proto_goTypes = []interface{}{
	...
	(Statuses)(0),                 // 5: clientpb.Statuses
	...
	(*Version)(nil),               // 10: clientpb.Version
	(*Session)(nil),               // 11: clientpb.Session
	(*Beacon)(nil),                // 12: clientpb.Beacon
	(*Beacons)(nil),               // 13: clientpb.Beacons
	(*BeaconTask)(nil),            // 14: clientpb.BeaconTask
	(*BeaconTasks)(nil),           // 15: clientpb.BeaconTasks
	(*ImplantC2)(nil),             // 16: clientpb.ImplantC2
	(*ImplantConfig)(nil),         // 17: clientpb.ImplantConfig
	(*ExternalImplantConfig)(nil), // 18: clientpb.ExternalImplantConfig
	(*ExternalImplantBinary)(nil), // 19: clientpb.ExternalImplantBinary
	(*ImplantBuilds)(nil),         // 20: clientpb.ImplantBuilds
	(*CompilerTarget)(nil),        // 21: clientpb.CompilerTarget
	(*CrossCompiler)(nil),         // 22: clientpb.CrossCompiler
	(*Compiler)(nil),              // 23: clientpb.Compiler
	(*DeleteReq)(nil),             // 24: clientpb.DeleteReq
	(*DNSCanary)(nil),             // 25: clientpb.DNSCanary
	(*Canaries)(nil),              // 26: clientpb.Canaries
	(*UniqueWGIP)(nil),            // 27: clientpb.UniqueWGIP
	(*ImplantProfile)(nil),        // 28: clientpb.ImplantProfile
	(*ImplantProfiles)(nil),       // 29: clientpb.ImplantProfiles
	(*RegenerateReq)(nil),         // 30: clientpb.RegenerateReq
	(*Job)(nil),                   // 31: clientpb.Job
	(*Jobs)(nil),                  // 32: clientpb.Jobs
	(*KillJobReq)(nil),            // 33: clientpb.KillJobReq
	(*KillJob)(nil),               // 34: clientpb.KillJob
	(*MTLSListenerReq)(nil),       // 35: clientpb.MTLSListenerReq
	(*MTLSListener)(nil),          // 36: clientpb.MTLSListener
	(*WGListenerReq)(nil),         // 37: clientpb.WGListenerReq
	(*WGListener)(nil),            // 38: clientpb.WGListener
	(*DNSListenerReq)(nil),        // 39: clientpb.DNSListenerReq
	(*DNSListener)(nil),           // 40: clientpb.DNSListener
	(*HTTPListenerReq)(nil),       // 41: clientpb.HTTPListenerReq
	(*NamedPipesReq)(nil),         // 42: clientpb.NamedPipesReq
	(*NamedPipes)(nil),            // 43: clientpb.NamedPipes
	(*TCPPivotReq)(nil),           // 44: clientpb.TCPPivotReq
	(*TCPPivot)(nil),              // 45: clientpb.TCPPivot
	(*HTTPListener)(nil),          // 46: clientpb.HTTPListener
	(*Sessions)(nil),              // 47: clientpb.Sessions
	(*RenameReq)(nil),             // 48: clientpb.RenameReq
	(*GenerateReq)(nil),           // 49: clientpb.GenerateReq
	(*Generate)(nil),              // 50: clientpb.Generate
	(*MSFReq)(nil),                // 51: clientpb.MSFReq
	(*MSFRemoteReq)(nil),          // 52: clientpb.MSFRemoteReq
	(*StagerListenerReq)(nil),     // 53: clientpb.StagerListenerReq
	(*StagerListener)(nil),        // 54: clientpb.StagerListener
	(*ShellcodeRDIReq)(nil),       // 55: clientpb.ShellcodeRDIReq
	(*ShellcodeRDI)(nil),          // 56: clientpb.ShellcodeRDI
	(*MsfStagerReq)(nil),          // 57: clientpb.MsfStagerReq
	(*MsfStager)(nil),             // 58: clientpb.MsfStager
	(*GetSystemReq)(nil),          // 59: clientpb.GetSystemReq
	(*MigrateReq)(nil),            // 60: clientpb.MigrateReq
	(*CreateTunnelReq)(nil),       // 61: clientpb.CreateTunnelReq
	(*CreateTunnel)(nil),          // 62: clientpb.CreateTunnel
	(*CloseTunnelReq)(nil),        // 63: clientpb.CloseTunnelReq
	(*PivotGraphEntry)(nil),       // 64: clientpb.PivotGraphEntry
	(*PivotGraph)(nil),            // 65: clientpb.PivotGraph
	(*Client)(nil),                // 66: clientpb.Client
	(*Event)(nil),                 // 67: clientpb.Event
	(*Operators)(nil),             // 68: clientpb.Operators
	(*Operator)(nil),              // 69: clientpb.Operator
	(*WebContent)(nil),            // 70: clientpb.WebContent
	(*WebsiteAddContent)(nil),     // 71: clientpb.WebsiteAddContent
	(*WebsiteRemoveContent)(nil),  // 72: clientpb.WebsiteRemoveContent
	(*Website)(nil),               // 73: clientpb.Website
	(*Websites)(nil),              // 74: clientpb.Websites
	(*WGClientConfig)(nil),        // 75: clientpb.WGClientConfig
	(*Loot)(nil),                  // 76: clientpb.Loot
	(*AllLoot)(nil),               // 77: clientpb.AllLoot
	(*IOC)(nil),                   // 78: clientpb.IOC
	(*ExtensionData)(nil),         // 79: clientpb.ExtensionData
	(*Host)(nil),                  // 80: clientpb.Host
	(*AllHosts)(nil),              // 81: clientpb.AllHosts
	(*DllHijackReq)(nil),          // 82: clientpb.DllHijackReq
	(*DllHijack)(nil),             // 83: clientpb.DllHijack
	(*ShellcodeEncodeReq)(nil),    // 84: clientpb.ShellcodeEncodeReq
	(*ShellcodeEncode)(nil),       // 85: clientpb.ShellcodeEncode
	(*ShellcodeEncoderMap)(nil),   // 86: clientpb.ShellcodeEncoderMap
	(*ExternalGenerateReq)(nil),   // 87: clientpb.ExternalGenerateReq
	(*Builders)(nil),              // 88: clientpb.Builders
	(*Builder)(nil),               // 89: clientpb.Builder
	(*Credential)(nil),            // 90: clientpb.Credential
	(*Credentials)(nil),           // 91: clientpb.Credentials
	(*Crackstations)(nil),         // 92: clientpb.Crackstations
	(*CrackstationStatus)(nil),    // 93: clientpb.CrackstationStatus
	(*CrackstationBenchmark)(nil), // 94: clientpb.CrackstationBenchmark
	(*Crackstation)(nil),          // 95: clientpb.Crackstation
	(*CUDABackendInfo)(nil),       // 96: clientpb.CUDABackendInfo
	(*OpenCLBackendInfo)(nil),     // 97: clientpb.OpenCLBackendInfo
	(*MetalBackendInfo)(nil),      // 98: clientpb.MetalBackendInfo
	(*CrackTask)(nil),             // 99: clientpb.CrackTask
	nil,                           // 100: clientpb.ImplantBuilds.ConfigsEntry
	nil,                           // 101: clientpb.WebsiteAddContent.ContentsEntry
	nil,                           // 102: clientpb.Website.ContentsEntry
	nil,                           // 103: clientpb.Host.ExtensionDataEntry
	nil,                           // 104: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                           // 105: clientpb.CrackstationBenchmark.BenchmarksEntry
...
var file_clientpb_client_proto_depIdxs = []int32{
	12,  // 0: clientpb.Beacons.Beacons:type_name -> clientpb.Beacon
	14,  // 1: clientpb.BeaconTasks.Tasks:type_name -> clientpb.BeaconTask
	16,  // 2: clientpb.ImplantConfig.C2:type_name -> clientpb.ImplantC2
	0,   // 3: clientpb.ImplantConfig.Format:type_name -> clientpb.OutputFormat
	17,  // 4: clientpb.ExternalImplantConfig.Config:type_name -> clientpb.ImplantConfig
	106, // 5: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	100, // 6: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	0,   // 7: clientpb.CompilerTarget.Format:type_name -> clientpb.OutputFormat
	21,  // 8: clientpb.Compiler.Targets:type_name -> clientpb.CompilerTarget
	22,  // 9: clientpb.Compiler.CrossCompilers:type_name -> clientpb.CrossCompiler
	21,  // 10: clientpb.Compiler.UnsupportedTargets:type_name -> clientpb.CompilerTarget
	25,  // 11: clientpb.Canaries.Canaries:type_name -> clientpb.DNSCanary
	17,  // 12: clientpb.ImplantProfile.Config:type_name -> clientpb.ImplantConfig
	28,  // 13: clientpb.ImplantProfiles.Profiles:type_name -> clientpb.ImplantProfile
	31,  // 14: clientpb.Jobs.Active:type_name -> clientpb.Job
	107, // 15: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	108, // 16: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	107, // 17: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	108, // 18: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	11,  // 19: clientpb.Sessions.Sessions:type_name -> clientpb.Session
	17,  // 20: clientpb.GenerateReq.Config:type_name -> clientpb.ImplantConfig
	106, // 21: clientpb.Generate.File:type_name -> commonpb.File
	107, // 22: clientpb.MSFReq.Request:type_name -> commonpb.Request
	107, // 23: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	106, // 26: clientpb.MsfStager.File:type_name -> commonpb.File
	17,  // 27: clientpb.GetSystemReq.Config:type_name -> clientpb.ImplantConfig
	107, // 28: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	17,  // 29: clientpb.MigrateReq.Config:type_name -> clientpb.ImplantConfig
	3,   // 30: clientpb.MigrateReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	107, // 31: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	107, // 32: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	107, // 33: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	11,  // 34: clientpb.PivotGraphEntry.Session:type_name -> clientpb.Session
	64,  // 35: clientpb.PivotGraphEntry.Children:type_name -> clientpb.PivotGraphEntry
	64,  // 36: clientpb.PivotGraph.Children:type_name -> clientpb.PivotGraphEntry
	69,  // 37: clientpb.Client.Operator:type_name -> clientpb.Operator
	11,  // 38: clientpb.Event.Session:type_name -> clientpb.Session
	31,  // 39: clientpb.Event.Job:type_name -> clientpb.Job
	66,  // 40: clientpb.Event.Client:type_name -> clientpb.Client
	69,  // 41: clientpb.Operators.Operators:type_name -> clientpb.Operator
	101, // 42: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	102, // 43: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	73,  // 44: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 45: clientpb.Loot.FileType:type_name -> clientpb.FileType
	106, // 46: clientpb.Loot.File:type_name -> commonpb.File
	76,  // 47: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	78,  // 48: clientpb.Host.IOCs:type_name -> clientpb.IOC
	103, // 49: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	80,  // 50: clientpb.AllHosts.Hosts:type_name -> clientpb.Host
	107, // 51: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	108, // 52: clientpb.DllHijack.Response:type_name -> commonpb.Response
	3,   // 53: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	107, // 54: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	108, // 55: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	104, // 56: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	17,  // 57: clientpb.ExternalGenerateReq.Config:type_name -> clientpb.ImplantConfig
	89,  // 58: clientpb.Builders.Builders:type_name -> clientpb.Builder
	21,  // 59: clientpb.Builder.Targets:type_name -> clientpb.CompilerTarget
	22,  // 60: clientpb.Builder.CrossCompilers:type_name -> clientpb.CrossCompiler
	4,   // 61: clientpb.Credential.HashType:type_name -> clientpb.HashType
	90,  // 62: clientpb.Credentials.Credentials:type_name -> clientpb.Credential
	95,  // 63: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	5,   // 64: clientpb.CrackstationStatus.Status:type_name -> clientpb.Statuses
	105, // 65: clientpb.CrackstationBenchmark.Benchmarks:type_name -> clientpb.CrackstationBenchmark.BenchmarksEntry
	96,  // 66: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	98,  // 67: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	97,  // 68: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	6,   // 69: clientpb.CrackTask.AttackMode:type_name -> clientpb.CrackAttackMode
	4,   // 70: clientpb.CrackTask.HashType:type_name -> clientpb.HashType
	8,   // 71: clientpb.CrackTask.OutfileFormat:type_name -> clientpb.CrackOutfileFormat
	7,   // 72: clientpb.CrackTask.EncodingFrom:type_name -> clientpb.CrackEncoding
	7,   // 73: clientpb.CrackTask.EncodingTo:type_name -> clientpb.CrackEncoding
	9,   // 74: clientpb.CrackTask.WorkloadProfile:type_name -> clientpb.CrackWorkloadProfile
	17,  // 75: clientpb.ImplantBuilds.ConfigsEntry.value:type_name -> clientpb.ImplantConfig
	70,  // 76: clientpb.WebsiteAddContent.ContentsEntry.value:type_name -> clientpb.WebContent
	70,  // 77: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
	79,  // 78: clientpb.Host.ExtensionDataEntry.value:type_name -> clientpb.ExtensionData
	3,   // 79: clientpb.ShellcodeEncoderMap.EncodersEntry.value:type_name -> clientpb.ShellcodeEncoder
...
func file_clientpb_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_clientpb_client_proto_msgTypes[84].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CrackstationBenchmark); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
