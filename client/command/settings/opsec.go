...
// SettingsAutoAdultCmd - The 客户端设置 command.
...
// 任何危险 (OPSEC__PH0__) functions. 均应呼叫 IsUserAnAdult - This
...
// IsUserAnAdultWithPrompt 在 continuing. 之前提示自定义消息
...
// GetAutoAdult - Get 当前汽车成人 setting.
