...
var file_rpcpb_services_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x92, 0x37, 0x0a, 0x09, 0x53, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43,
...
var file_rpcpb_services_proto_goTypes = []interface{}{
	...
	(*sliverpb.ExecuteWindowsReq)(nil),     // 48: sliverpb.ExecuteWindowsReq
...
var file_rpcpb_services_proto_depIdxs = []int32{
	...
	48,  // 75: rpcpb.SliverRPC.ExecuteWindows:input_type -> sliverpb.ExecuteWindowsReq
	...
	135, // 196: rpcpb.SliverRPC.ExecuteWindows:output_type -> sliverpb.Execute
