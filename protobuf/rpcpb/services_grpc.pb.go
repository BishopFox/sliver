...
const (
	...
	SliverRPC_ExportImplant_FullMethodName                    = "/rpcpb.SliverRPC/ExportImplant"
	SliverRPC_ImportImplant_FullMethodName                    = "/rpcpb.SliverRPC/ImportImplant"
...
type SliverRPCClient interface {
	...
	// *** Implant Migration ***
	ExportImplant(ctx context.Context, in *clientpb.ExportImplantReq, opts ...grpc.CallOption) (*clientpb.ExportImplantBundle, error)
	ImportImplant(ctx context.Context, in *clientpb.ExportImplantBundle, opts ...grpc.CallOption) (*commonpb.Empty, error)
	// *** HTTP C2 Profiles ***
...
func (c *sliverRPCClient) ExportImplant(ctx context.Context, in *clientpb.ExportImplantReq, opts ...grpc.CallOption) (*clientpb.ExportImplantBundle, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(clientpb.ExportImplantBundle)
	err := c.cc.Invoke(ctx, SliverRPC_ExportImplant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sliverRPCClient) ImportImplant(ctx context.Context, in *clientpb.ExportImplantBundle, opts ...grpc.CallOption) (*commonpb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(commonpb.Empty)
	err := c.cc.Invoke(ctx, SliverRPC_ImportImplant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SliverRPCServer interface {
	...
	// *** Implant Migration ***
	ExportImplant(context.Context, *clientpb.ExportImplantReq) (*clientpb.ExportImplantBundle, error)
	ImportImplant(context.Context, *clientpb.ExportImplantBundle) (*commonpb.Empty, error)
	// *** HTTP C2 Profiles ***
...
func (UnimplementedSliverRPCServer) ExportImplant(context.Context, *clientpb.ExportImplantReq) (*clientpb.ExportImplantBundle, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportImplant not implemented")
}
func (UnimplementedSliverRPCServer) ImportImplant(context.Context, *clientpb.ExportImplantBundle) (*commonpb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ImportImplant not implemented")
}
...
func _SliverRPC_ExportImplant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.ExportImplantReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).ExportImplant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_ExportImplant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).ExportImplant(ctx, req.(*clientpb.ExportImplantReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _SliverRPC_ImportImplant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(clientpb.ExportImplantBundle)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SliverRPCServer).ImportImplant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SliverRPC_ImportImplant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).ImportImplant(ctx, req.(*clientpb.ExportImplantBundle))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SliverRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExportImplant",
			Handler:    _SliverRPC_ExportImplant_Handler,
		},
		{
			MethodName: "ImportImplant",
			Handler:    _SliverRPC_ImportImplant_Handler,
		},
		{
